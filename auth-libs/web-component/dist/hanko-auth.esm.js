 ...
 */
const nn = globalThis, jn = nn.ShadowRoot && (nn.ShadyCSS === void 0 || nn.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Hn = Symbol(), ao = /* @__PURE__ */ new WeakMap();
let ti = class {
  constructor(t, e, o) {
    if (this._$cssResult$ = !0, o !== Hn) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
...
}, ro = jn ? (n) => n : (n) => n instanceof CSSStyleSheet ? ((t) => {
  let e = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ri, defineProperty: zi, getOwnPropertyDescriptor: qi, getOwnPropertyNames: ji, getOwnPropertySymbols: Hi, getPrototypeOf: Fi } = Object, tt = globalThis, so = tt.trustedTypes, Wi = so ? so.emptyScript : "", Pn = tt.reactiveElementPolyfillSupport, Mt = (n, t) => n, mn = { toAttribute(n, t) {
  switch (t) {
    case Boolean:
      n = n ? Wi : null;
      break;
  ...
  return e;
} }, Fn = (n, t) => !Ri(n, t), co = { attribute: !0, type: String, converter: mn, reflect: !1, useDefault: !1, hasChanged: Fn };
...
let pt = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, e, o) {
    const { get: i, set: r } = qi(this.prototype, t) ?? { get() {
      return this[e];
    }, set(s) {
      this[e] = s;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(Mt("properties"))) {
      const e = this.properties, o = [...ji(e), ...Hi(e)];
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const i of o) e.unshift(ro(i));
  ...
  requestUpdate(t, e, o, i = !1, r) {
    ...
    if (t !== void 0) {
      ...
      if (i === !1 && (r = this[t]), o ?? (o = d.getPropertyOptions(t)), !((o.hasChanged ?? Fn)(r, e) || o.useDefault && o.reflect && r === ((s = this._$Ej) == null ? void 0 : s.get(t)) && !this.hasAttribute(d._$Eu(t, o)))) return;
      this.C(t, e, o);
    }
...
pt.elementStyles = [], pt.shadowRootOptions = { mode: "open" }, pt[Mt("elementProperties")] = /* @__PURE__ */ new Map(), pt[Mt("finalized")] = /* @__PURE__ */ new Map(), Pn == null || Pn({ ReactiveElement: pt }), (tt.reactiveElementVersions ?? (tt.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Rt = globalThis, lo = (n) => n, fn = Rt.trustedTypes, uo = fn ? fn.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, ni = "$lit$", et = `lit$${Math.random().toFixed(9).slice(2)}$`, oi = "?" + et, Ki = `<${oi}>`, dt = document, qt = () => dt.createComment(""), jt = (n) => n === null || typeof n != "object" && typeof n != "function", Wn = Array.isArray, Vi = (n) => Wn(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", En = `[ 	
\f\r]`, St = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ho = /-->/g, po = />/g, st = RegExp(`>|${En}(?:([^\\s"'>=/]+)(${En}*=${En}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), mo = /'/g, fo = /"/g, ii = /^(?:script|style|textarea|title)$/i, Bi = (n) => (t, ...e) => ({ _$litType$: n, strings: t, values: e }), ve = Bi(1), gt = Symbol.for("lit-noChange"), Ae = Symbol.for("lit-nothing"), go = /* @__PURE__ */ new WeakMap(), ct = dt.createTreeWalker(dt, 129);
function ai(n, t) {
...
const Zi = (n, t) => {
  ...
  for (let d = 0; d < e; d++) {
    const u = n[d];
    let c, l, m = -1, v = 0;
    for (; v < u.length && (s.lastIndex = v, l = s.exec(u), l !== null); ) v = s.lastIndex, s === St ? l[1] === "!--" ? s = ho : l[1] !== void 0 ? s = po : l[2] !== void 0 ? (ii.test(l[2]) && (i = RegExp("</" + l[2], "g")), s = st) : l[3] !== void 0 && (s = st) : s === st ? l[0] === ">" ? (s = i ?? St, m = -1) : l[1] === void 0 ? m = -2 : (m = s.lastIndex - l[2].length, c = l[1], s = l[3] === void 0 ? st : l[3] === '"' ? fo : mo) : s === fo || s === mo ? s = st : s === ho || s === po ? s = St : (s = st, i = void 0);
    const g = s === st && n[d + 1].startsWith("/>") ? " " : "";
    r += s === St ? u + Ki : m >= 0 ? (o.push(c), u.slice(0, m) + ni + u.slice(m) + et + g) : u + et + (m === -2 ? d : g);
  }
  return [ai(n, r + (n[e] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), o];
};
let Nn = class ri {
  constructor({ strings: t, _$litType$: e }, o) {
    ...
    this.parts = [];
    let r = 0, s = 0;
    const d = t.length - 1, u = this.parts, [c, l] = Zi(t, e);
    if (this.el = ri.createElement(c, o), ct.currentNode = this.el.content, e === 2 || e === 3) {
      const m = this.el.content.firstChild;
      m.replaceWith(...m.childNodes);
    }
    for (; (i = ct.nextNode()) !== null && u.length < d; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const m of i.getAttributeNames()) if (m.endsWith(ni)) {
          const v = l[s++], g = i.getAttribute(m).split(et), S = /([.?@])?(.*)/.exec(v);
          u.push({ type: 1, index: r, name: S[2], strings: g, ctor: S[1] === "." ? Yi : S[1] === "?" ? Qi : S[1] === "@" ? Gi : _n }), i.removeAttribute(m);
        ...
        if (ii.test(i.tagName)) {
          ...
          if (v > 0) {
            ...
            for (let g = 0; g < v; g++) i.append(m[g], qt()), ct.nextNode(), u.push({ type: 2, index: ++r });
            i.append(m[v], qt());
          }
        }
      } else if (i.nodeType === 8) if (i.data === oi) u.push({ type: 2, index: r });
      else {
        let m = -1;
...
let Ji = class {
  ...
  u(t) {
    ...
    for (; u !== void 0; ) {
      if (s === u.index) {
        let c;
        u.type === 2 ? c = new Kn(r, r.nextSibling, this, t) : u.type === 1 ? c = new u.ctor(r, u.name, u.strings, this, t) : u.type === 6 && (c = new Xi(r, this, t)), this._$AV.push(c), u = o[++d];
      }
  ...
  _$AI(t, e = this) {
    t = vt(this, t, e), jt(t) ? t === Ae || t == null || t === "" ? (this._$AH !== Ae && this._$AR(), this._$AH = Ae) : t !== this._$AH && t !== gt && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Vi(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== Ae && jt(this._$AH) ? this._$AA.nextSibling.data = t : this.T(dt.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var r;
    const { values: e, _$litType$: o } = t, i = typeof o == "number" ? this._$AC(t) : (o.el === void 0 && (o.el = Nn.createElement(ai(o.h, o.h[0]), this.options)), o);
    if (((r = this._$AH) == null ? void 0 : r._$AD) === i) this._$AH.p(e);
    else {
      const s = new Ji(i, this), d = s.u(this.options);
      s.p(e), this.T(d), this._$AH = s;
    }
  }
  _$AC(t) {
    let e = go.get(t.strings);
    return e === void 0 && go.set(t.strings, e = new Nn(t)), e;
  }
  k(t) {
    Wn(this._$AH) || (this._$AH = [], this._$AR());
    const e = this._$AH;
    let o, i = 0;
    for (const r of t) i === e.length ? e.push(o = new si(this.O(qt()), this.O(qt()), this, this.options)) : o = e[i], o._$AI(r), i++;
    i < e.length && (this._$AR(o && o._$AB.nextSibling, i), e.length = i);
  }
  _$AR(t = this._$AA.nextSibling, e) {
    var o;
    for ((o = this._$AP) == null ? void 0 : o.call(this, !1, !0, e); t !== this._$AB; ) {
      const i = lo(t).nextSibling;
      lo(t).remove(), t = i;
    }
  }
  setConnected(t) {
  ...
  _$AI(t, e = this, o, i) {
    ...
    let s = !1;
    if (r === void 0) t = vt(this, t, e, 0), s = !jt(t) || t !== this._$AH && t !== gt, s && (this._$AH = t);
    else {
      const d = t;
      let u, c;
      for (t = r[0], u = 0; u < r.length - 1; u++) c = vt(this, d[o + u], e, u), c === gt && (c = this._$AH[u]), s || (s = !jt(c) || c !== this._$AH[u]), c === Ae ? t = Ae : t !== Ae && (t += (c ?? "") + r[u + 1]), this._$AH[u] = c;
    }
    s && !i && this.j(t);
  }
  j(t) {
...
const In = Rt.litHtmlPolyfillSupport;
In == null || In(Nn, Kn), (Rt.litHtmlVersions ?? (Rt.litHtmlVersions = [])).push("3.3.2");
const ea = (n, t, e) => {
  const o = (e == null ? void 0 : e.renderBefore) ?? t;
  let i = o._$litPart$;
  if (i === void 0) {
    const r = (e == null ? void 0 : e.renderBefore) ?? null;
    o._$litPart$ = i = new Kn(t.insertBefore(qt(), r), r, void 0, e ?? {});
  }
  return i._$AI(n), i;
};
/**
...
let zt = class extends pt {
  ...
  update(t) {
    const e = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = ea(e, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var t;
...
var ei;
zt._$litElement$ = !0, zt.finalized = !0, (ei = lt.litElementHydrateSupport) == null || ei.call(lt, { LitElement: zt });
const On = lt.litElementPolyfillSupport;
On == null || On({ LitElement: zt });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const na = { attribute: !0, type: String, converter: mn, reflect: !1, hasChanged: Fn }, oa = (n = na, t, e) => {
...
function Pe(n) {
  return (t, e) => typeof e == "object" ? oa(n, t, e) : ((o, i, r) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ia = (n) => (...t) => ({ _$litDirective$: n, values: t });
let aa = class {
  constructor(t) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ra = {}, sa = (n, t = ra) => n._$AH = t;
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ca = ia(class extends aa {
  constructor() {
  ...
  update(n, [t, e]) {
    return t !== this.key && (sa(n), this.key = t), e;
  }
});
...
var la = { 7(n, t, e) {
  (function(o, i, r) {
    ...
    var c = Object.defineProperty, l = Object.getOwnPropertySymbols, m = Object.prototype.hasOwnProperty, v = Object.prototype.propertyIsEnumerable, g = (w, E, I) => E in w ? c(w, E, { enumerable: !0, configurable: !0, writable: !0, value: I }) : w[E] = I, S = (w, E, I) => new Promise((M, z) => {
      var F = (N) => {
        try {
          X(I.next(N));
        } catch (fe) {
    ...
    function D(w, E) {
      ...
      const [I, M] = r.useState(w.lang), [z, F] = r.useState(x), [V, X] = r.useState(!1), N = r.useCallback((_e) => S(null, null, function* () {
        if (!z[_e]) {
          X(!1);
          try {
  ...
  e.r(t), e.d(t, { Component: () => X, Fragment: () => V, cloneElement: () => Re, createContext: () => Cn, createElement: () => M, createRef: () => F, h: () => M, hydrate: () => bt, isValidElement: () => s, options: () => i, render: () => at, toChildArray: () => Ne });
  var o, i, r, s, d, u, c, l, m, v, g, S, x, C = {}, D = [], W = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, w = Array.isArray;
  function E(p, h) {
  ...
  function M(p, h, _) {
    var P, $, y, L = {};
    for (y in h) y == "key" ? P = h[y] : y == "ref" ? $ = h[y] : L[y] = h[y];
  ...
  function z(p, h, _, P, $) {
    var y = { type: p, props: h, key: _, ref: P, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: $ ?? ++r, __i: -1, __u: 0 };
    return $ == null && i.vnode != null && i.vnode(y), y;
  }
  function F() {
    return { current: null };
  }
  ...
  function ue() {
    for (var p, h, _, P, $, y, L, H = 1; d.length; ) d.length > H && d.sort(l), p = d.shift(), H = d.length, p.__d && (_ = void 0, P = void 0, $ = (P = (h = p).__v).__e, y = [], L = [], h.__P && ((_ = E({}, P)).__v = P.__v + 1, i.vnode && i.vnode(_), U(h.__P, _, P, h.__n, h.__P.namespaceURI, 32 & P.__u ? [$] : null, y, $ ?? N(P), !!(32 & P.__u), L), _.__v = P.__v, _.__.__k[_.__i] = _, j(y, _, L), P.__e = P.__ = null, _.__e != $ && fe(_)));
    ue.__r = 0;
  }
  function le(p, h, _, P, $, y, L, H, he, R, ie) {
    var k, be, B, Oe, He, Te, ge, pe = P && P.__k || D, Xe = h.length;
    for (he = re(_, h, pe, he, Xe), k = 0; k < Xe; k++) (B = _.__k[k]) != null && (be = B.__i == -1 ? C : pe[B.__i] || C, B.__i = k, Te = U(p, B, be, $, y, L, H, he, R, ie), Oe = B.__e, B.ref && be.ref != B.ref && (be.ref && se(be.ref, null, B), ie.push(B.ref, B.__c || Oe, B)), He == null && Oe != null && (He = Oe), (ge = !!(4 & B.__u)) || be.__k === B.__k ? he = ye(B, he, p, ge) : typeof B.type == "function" && Te !== void 0 ? he = Te : Oe && (he = Oe.nextSibling), B.__u &= -7);
    return _.__e = He, he;
  }
  function re(p, h, _, P, $) {
    var y, L, H, he, R, ie = _.length, k = ie, be = 0;
    for (p.__k = new Array($), y = 0; y < $; y++) (L = h[y]) != null && typeof L != "boolean" && typeof L != "function" ? (typeof L == "string" || typeof L == "number" || typeof L == "bigint" || L.constructor == String ? L = p.__k[y] = z(null, L, null, null, null) : w(L) ? L = p.__k[y] = z(V, { children: L }, null, null, null) : L.constructor === void 0 && L.__b > 0 ? L = p.__k[y] = z(L.type, L.props, L.key, L.ref ? L.ref : null, L.__v) : p.__k[y] = L, he = y + be, L.__ = p, L.__b = p.__b + 1, H = null, (R = L.__i = ot(L, _, he, k)) != -1 && (k--, (H = _[R]) && (H.__u |= 2)), H == null || H.__v == null ? (R == -1 && ($ > ie ? be-- : $ < ie && be++), typeof L.type != "function" && (L.__u |= 4)) : R != he && (R == he - 1 ? be-- : R == he + 1 ? be++ : (R > he ? be-- : be++, L.__u |= 4))) : p.__k[y] = null;
    if (k) for (y = 0; y < ie; y++) (H = _[y]) != null && !(2 & H.__u) && (H.__e == P && (P = N(H)), Ie(H, H));
    return P;
  }
  function ye(p, h, _, P) {
    var $, y;
    if (typeof p.type == "function") {
      for ($ = p.__k, y = 0; $ && y < $.length; y++) $[y] && ($[y].__ = p, h = ye($[y], h, _, P));
      return h;
    }
  ...
  function ot(p, h, _, P) {
    var $, y, L, H = p.key, he = p.type, R = h[_], ie = R != null && !(2 & R.__u);
    if (R === null && H == null || ie && H == R.key && he == R.type) return _;
    if (P > (ie ? 1 : 0)) {
      for ($ = _ - 1, y = _ + 1; $ >= 0 || y < h.length; ) if ((R = h[L = $ >= 0 ? $-- : y++]) != null && !(2 & R.__u) && H == R.key && he == R.type) return L;
    }
    return -1;
  }
  function it(p, h, _) {
  ...
  function A(p, h, _, P, $) {
    ...
    else if (h[0] == "o" && h[1] == "n") y = h != (h = h.replace(m, "$1")), L = h.toLowerCase(), h = L in p || h == "onFocusOut" || h == "onFocusIn" ? L.slice(2) : h.slice(2), p.l || (p.l = {}), p.l[h + y] = _, _ ? P ? _.u = P.u : (_.u = v, p.addEventListener(h, y ? S : g, y)) : p.removeEventListener(h, y ? S : g, y);
    else {
      if ($ == "http://www.w3.org/2000/svg") h = h.replace(/xlink(H|:h)/, "h").replace(/sName$/, "s");
  ...
  function U(p, h, _, P, $, y, L, H, he, R) {
    var ie, k, be, B, Oe, He, Te, ge, pe, Xe, rt, Bt, wt, io, Zt, kt, An, Ve = h.type;
    if (h.constructor !== void 0) return null;
    128 & _.__u && (he = !!(32 & _.__u), y = [H = h.__e = _.__e]), (ie = i.__b) && ie(h);
    e: if (typeof Ve == "function") try {
      if (ge = h.props, pe = "prototype" in Ve && Ve.prototype.render, Xe = (ie = Ve.contextType) && P[ie.__c], rt = ie ? Xe ? Xe.props.value : ie.__ : P, _.__c ? Te = (k = h.__c = _.__c).__ = k.__E : (pe ? h.__c = k = new Ve(ge, rt) : (h.__c = k = new X(ge, rt), k.constructor = Ve, k.render = Ke), Xe && Xe.sub(k), k.state || (k.state = {}), k.__n = P, be = k.__d = !0, k.__h = [], k._sb = []), pe && k.__s == null && (k.__s = k.state), pe && Ve.getDerivedStateFromProps != null && (k.__s == k.state && (k.__s = E({}, k.__s)), E(k.__s, Ve.getDerivedStateFromProps(ge, k.__s))), B = k.props, Oe = k.state, k.__v = h, be) pe && Ve.getDerivedStateFromProps == null && k.componentWillMount != null && k.componentWillMount(), pe && k.componentDidMount != null && k.__h.push(k.componentDidMount);
      else {
        if (pe && Ve.getDerivedStateFromProps == null && ge !== B && k.componentWillReceiveProps != null && k.componentWillReceiveProps(ge, rt), h.__v == _.__v || !k.__e && k.shouldComponentUpdate != null && k.shouldComponentUpdate(ge, k.__s, rt) === !1) {
          for (h.__v != _.__v && (k.props = ge, k.state = k.__s, k.__d = !1), h.__e = _.__e, h.__k = _.__k, h.__k.some(function(ht) {
            ht && (ht.__ = h);
          }), Bt = 0; Bt < k._sb.length; Bt++) k.__h.push(k._sb[Bt]);
          k._sb = [], k.__h.length && L.push(k);
          break e;
        }
        k.componentWillUpdate != null && k.componentWillUpdate(ge, k.__s, rt), pe && k.componentDidUpdate != null && k.__h.push(function() {
          k.componentDidUpdate(B, Oe, He);
        });
      }
      if (k.context = rt, k.props = ge, k.__P = p, k.__e = !1, wt = i.__r, io = 0, pe) {
        for (k.state = k.__s, k.__d = !1, wt && wt(h), ie = k.render(k.props, k.state, k.context), Zt = 0; Zt < k._sb.length; Zt++) k.__h.push(k._sb[Zt]);
        k._sb = [];
      } else do
        k.__d = !1, wt && wt(h), ie = k.render(k.props, k.state, k.context), k.state = k.__s;
      while (k.__d && ++io < 25);
      k.state = k.__s, k.getChildContext != null && (P = E(E({}, P), k.getChildContext())), pe && !be && k.getSnapshotBeforeUpdate != null && (He = k.getSnapshotBeforeUpdate(B, Oe)), kt = ie, ie != null && ie.type === V && ie.key == null && (kt = q(ie.props.children)), H = le(p, w(kt) ? kt : [kt], h, _, P, $, y, L, H, he, R), k.base = h.__e, h.__u &= -161, k.__h.length && L.push(k), Te && (k.__E = k.__ = null);
    } catch (ht) {
      if (h.__v = null, he || y != null) if (ht.then) {
        ...
        for (An = y.length; An--; ) I(y[An]);
        Z(h);
      }
      else h.__e = _.__e, h.__k = _.__k, ht.then || Z(h);
      i.__e(ht, h, _);
    }
    else y == null && h.__v == _.__v ? (h.__k = _.__k, h.__e = _.__e) : H = h.__e = Ce(_.__e, h, _, P, $, y, L, he, R);
  ...
  function j(p, h, _) {
    ...
    i.__c && i.__c(h, p), p.some(function($) {
      try {
        p = $.__h, $.__h = [], p.some(function(y) {
          y.call($);
        });
      } catch (y) {
        i.__e(y, $.__v);
  ...
  function Ce(p, h, _, P, $, y, L, H, he) {
    var R, ie, k, be, B, Oe, He, Te = _.props || C, ge = h.props, pe = h.type;
    if (pe == "svg" ? $ = "http://www.w3.org/2000/svg" : pe == "math" ? $ = "http://www.w3.org/1998/Math/MathML" : $ || ($ = "http://www.w3.org/1999/xhtml"), y != null) {
    ...
    if (p == null) {
      ...
      p = document.createElementNS($, pe, ge.is && ge), H && (i.__m && i.__m(h, y), H = !1), y = null;
    }
    if (pe == null) Te === ge || H && p.data == ge || (p.data = ge);
    else {
      if (y = y && o.call(p.childNodes), !H && y != null) for (Te = {}, R = 0; R < p.attributes.length; R++) Te[(B = p.attributes[R]).name] = B.value;
      for (R in Te) if (B = Te[R], R != "children") {
        if (R == "dangerouslySetInnerHTML") k = B;
        else if (!(R in ge)) {
          if (R == "value" && "defaultValue" in ge || R == "checked" && "defaultChecked" in ge) continue;
          A(p, R, null, B, $);
        }
      }
      for (R in ge) B = ge[R], R == "children" ? be = B : R == "dangerouslySetInnerHTML" ? ie = B : R == "value" ? Oe = B : R == "checked" ? He = B : H && typeof B != "function" || Te[R] === B || A(p, R, B, Te[R], $);
      if (ie) H || k && (ie.__html == k.__html || ie.__html == p.innerHTML) || (p.innerHTML = ie.__html), h.__k = [];
      else if (k && (p.innerHTML = ""), le(h.type == "template" ? p.content : p, w(be) ? be : [be], h, _, P, pe == "foreignObject" ? "http://www.w3.org/1999/xhtml" : $, y, L, y ? y[0] : _.__k && N(_, 0), H, he), y != null) for (R = y.length; R--; ) I(y[R]);
      H || (R = "value", pe == "progress" && Oe == null ? p.removeAttribute("value") : Oe != null && (Oe !== p[R] || pe == "progress" && !Oe || pe == "option" && Oe != Te[R]) && A(p, R, Oe, Te[R], $), R = "checked", He != null && He != p[R] && A(p, R, He, Te[R], $));
    }
    return p;
  }
  function se(p, h, _) {
  ...
  function Ie(p, h, _) {
    ...
    if (P = p.__k) for ($ = 0; $ < P.length; $++) P[$] && Ie(P[$], h, _ || typeof p.type != "function");
  ...
  function at(p, h, _) {
    var P, $, y, L;
    h == document && (h = document.documentElement), i.__ && i.__(p, h), $ = (P = typeof _ == "function") ? null : _ && _.__k || h.__k, y = [], L = [], U(h, p = (!P && _ || h).__k = M(V, null, [p]), $ || C, C, h.namespaceURI, !P && _ ? [_] : $ ? null : h.firstChild ? o.call(h.childNodes) : null, y, !P && _ ? _ : $ ? $.__e : h.firstChild, P, L), j(y, p, L);
  }
  function bt(p, h) {
    at(p, h, bt);
  }
  function Re(p, h, _) {
    var P, $, y, L, H = E({}, p.props);
    for (y in p.type && p.type.defaultProps && (L = p.type.defaultProps), h) y == "key" ? P = h[y] : y == "ref" ? $ = h[y] : H[y] = h[y] === void 0 && L != null ? L[y] : h[y];
    return arguments.length > 2 && (H.children = arguments.length > 3 ? o.call(arguments, 2) : _), z(p.type, H, P || p.key, $ || p.ref, null);
  }
  function Cn(p) {
    function h(_) {
      var P, $;
      return this.getChildContext || (P = /* @__PURE__ */ new Set(), ($ = {})[h.__c] = this, this.getChildContext = function() {
        return $;
  ...
  o = D.slice, i = { __e: function(p, h, _, P) {
    for (var $, y, L; h = h.__; ) if (($ = h.__c) && !$.__) try {
      if ((y = $.constructor) && y.getDerivedStateFromError != null && ($.setState(y.getDerivedStateFromError(p)), L = $.__d), $.componentDidCatch != null && ($.componentDidCatch(p, P || {}), L = $.__d), L) return $.__E = $;
    } catch (H) {
      p = H;
    }
    throw p;
  ...
  }, ue.__r = 0, m = /(PointerCapture)$|Capture$/i, v = 0, g = O(!1), S = O(!0), x = 0;
}, 78(n, t, e) {
  ...
  var o, i, r, s, d = e(616), u = 0, c = [], l = d.options, m = l.__b, v = l.__r, g = l.diffed, S = l.__c, x = l.unmount, C = l.__;
  function D(A, O) {
    ...
    if (Z.t = A, !Z.__c && (Z.__ = [U ? U(O) : it(void 0, O), function(se) {
      ...
      var j = function(se, Ie, Ke) {
        ...
        if (at.every(function(Re) {
          return !Re.__N;
        })) return !q || q.call(this, se, Ie, Ke);
        var bt = Z.__c.props !== se;
        return at.forEach(function(Re) {
          if (Re.__N) {
            var Cn = Re.__[0];
            Re.__ = Re.__N, Re.__N = void 0, Cn !== Re.__[0] && (bt = !0);
          }
        }), q && q.call(this, se, Ie, Ke) || bt;
      };
      i.__f = !0;
      var q = i.shouldComponentUpdate, Ce = i.componentWillUpdate;
      i.componentWillUpdate = function(se, Ie, Ke) {
        if (this.__e) {
          var at = q;
          q = void 0, j(se, Ie, Ke), q = at;
        }
  ...
  function o(r, s) {
    for (var d = {}, u = [], c = 0; c < r.length; c++) {
      ...
      d[m] = v + 1;
      var S = e(g), x = { css: l[1], media: l[2], sourceMap: l[3], supports: l[4], layer: l[5] };
...
function ee(n) {
  ...
  var e = vo[n] = { id: n, exports: {} };
  return la[n].call(e.exports, e, e.exports, ee), e.exports;
}
ee.n = (n) => {
...
var Mn = {};
ee.r(Mn), ee.d(Mn, { apple: () => Va, checkmark: () => Ba, copy: () => Za, customProvider: () => Ja, discord: () => Ya, exclamation: () => Qa, facebook: () => Ga, github: () => Xa, google: () => er, linkedin: () => tr, mail: () => nr, microsoft: () => or, passkey: () => ir, password: () => ar, qrCodeScanner: () => rr, securityKey: () => sr, spinner: () => cr });
var b = ee(616), da = 0;
function a(n, t, e, o, i, r) {
  t || (t = {});
  var s, d, u = t;
  if ("ref" in u) for (d in u = {}, t) d == "ref" ? s = t[d] : u[d] = t[d];
  var c = { type: n, props: u, key: e, ref: s, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: --da, __i: -1, __u: 0, __source: i, __self: r };
...
function pa() {
  ...
  this.dispatchEvent(n), this._vdom = (0, b.h)(ha, gn({}, this._props, { context: n.detail.context }), li(this, this._vdomComponent)), (this.hasAttribute("hydrate") ? b.hydrate : b.render)(this._vdom, this._root);
}
function ci(n) {
...
function ma(n, t, e) {
  if (this._vdom) {
    var o = {};
    o[n] = e = e ?? void 0, o[ci(n)] = e, this._vdom = (0, b.cloneElement)(this._vdom, o), (0, b.render)(this._vdom, this._root);
  }
}
function fa() {
...
function li(n, t) {
  ...
  for (i = s.length; i--; ) {
    var d = li(s[i], null), u = s[i].slot;
    u ? o[u] = (0, b.h)(_o, { name: u }, d) : e[i] = d;
  }
  var c = t ? (0, b.h)(_o, null, e) : e;
...
(bo.prototype = new b.Component()).isPureReactComponent = !0, bo.prototype.shouldComponentUpdate = function(n, t) {
  return yo(this.props, n) || yo(this.state, t);
};
var wo = b.options.__b;
b.options.__b = function(n) {
  n.type && n.type.__f && n.ref && (n.props.ref = n.ref, n.ref = null), wo && wo(n);
};
var ga = typeof Symbol < "u" && Symbol.for && Symbol.for("react.forward_ref") || 3911, va = (b.toChildArray, b.options.__e);
...
var ko = b.options.unmount;
function ui(n, t, e) {
  return n && (n.__c && n.__c.__H && (n.__c.__H.__.forEach(function(o) {
    typeof o.__c == "function" && o.__c();
  }), n.__c.__H = null), (n = di({}, n)).__c != null && (n.__c.__P === e && (n.__c.__P = t), n.__c.__e = !0, n.__c = null), n.__k = n.__k && n.__k.map(function(o) {
    return ui(o, t, e);
  })), n;
}
function hi(n, t, e) {
...
b.options.unmount = function(n) {
  var t = n.__c;
  t && t.__R && t.__R(), t && 32 & n.__u && (n.type = null), ko && ko(n);
}, ($n.prototype = new b.Component()).__c = function(n, t) {
  var e = t.__c, o = this;
  o.o == null && (o.o = []), o.o.push(e);
  var i = pi(o.__v), r = !1, s = function() {
  ...
  var d = function() {
    if (!--o.__u) {
      if (o.state.__a) {
        var u = o.state.__a;
        o.__v.__k[0] = hi(u, u.__c.__P, u.__c.__O);
      }
      var c;
  ...
  if (this.__b) {
    if (this.__v.__k) {
      ...
      this.__v.__k[0] = ui(this.__b, e, o.__O = o.__P);
    }
    this.__b = null;
  }
...
(Jt.prototype = new b.Component()).__a = function(n) {
  var t = this, e = pi(t.__v), o = t.l.get(n);
...
b.options.event = function(n) {
  return xo && (n = xo(n)), n.persist = xa, n.isPropagationStopped = Ca, n.isDefaultPrevented = Aa, n.nativeEvent = n;
};
var Pa = { enumerable: !1, configurable: !0, get: function() {
  return this.class;
} }, Co = b.options.vnode;
b.options.vnode = function(n) {
  typeof n.type == "string" && function(t) {
    ...
    for (var s in e) {
      var d = e[s];
      if (!(s === "value" && "defaultValue" in e && d == null || ka && s === "children" && o === "noscript" || s === "class" || s === "className")) {
        var u = s.toLowerCase();
        s === "defaultValue" && "value" in e && e.value == null ? s = "value" : s === "download" && d === !0 ? d = "" : u === "translate" && d === "no" ? d = !1 : u[0] === "o" && u[1] === "n" ? u === "ondoubleclick" ? s = "ondblclick" : u !== "onchange" || o !== "input" && o !== "textarea" || Sa(e.type) ? u === "onfocus" ? s = "onfocusin" : u === "onblur" ? s = "onfocusout" : ba.test(s) && (s = u) : u = s = "oninput" : r && ya.test(s) ? s = s.replace(wa, "-$&").toLowerCase() : d === null && (d = void 0), u === "oninput" && i[s = u] && (s = "oninputCapture"), i[s] = d;
      }
    }
    ...
    })), e.class && !e.className ? (i.class = e.class, Object.defineProperty(i, "className", Pa)) : (e.className && !e.class || e.class && e.className) && (i.class = i.className = e.className), t.props = i;
  }(n), n.$$typeof = _a, Co && Co(n);
};
var Ao = b.options.__r;
b.options.__r = function(n) {
  Ao && Ao(n), n.__c;
};
var Po = b.options.diffed;
function qe() {
...
const Vn = "hanko-session-created", Bn = "hanko-session-expired", Zn = "hanko-user-logged-out", Jn = "hanko-user-deleted", mi = "hanko-after-state-change", fi = "hanko-before-state-change";
class gi extends CustomEvent {
  constructor(t, e) {
    super(t, { detail: e });
  }
}
class yn {
  constructor() {
    this.throttleLimit = 1e3, this._addEventListener = document.addEventListener.bind(document), this._removeEventListener = document.removeEventListener.bind(document), this._throttle = Ea.throttle;
  }
  wrapCallback(t, e) {
    const o = (i) => {
      t(i.detail);
  ...
  onSessionCreated(t, e) {
    return this.addEventListener(Vn, { callback: t, once: e }, !0);
  }
  onSessionExpired(t, e) {
    return this.addEventListener(Bn, { callback: t, once: e }, !0);
  }
  onUserLoggedOut(t, e) {
    return this.addEventListener(Zn, { callback: t, once: e });
  }
  onUserDeleted(t, e) {
    return this.addEventListener(Jn, { callback: t, once: e });
  }
  onAfterStateChange(t, e) {
    return this.addEventListener(mi, { callback: t, once: e }, !1);
  }
  onBeforeStateChange(t, e) {
    return this.addEventListener(fi, { callback: t, once: e }, !1);
  }
}
class vi {
  constructor() {
  ...
  dispatch(t, e) {
    this._dispatchEvent(new gi(t, e));
  }
  dispatchSessionCreatedEvent(t) {
    this.dispatch(Vn, t);
  }
  dispatchSessionExpiredEvent() {
    this.dispatch(Bn, null);
  }
...
class _i {
  ...
  getAuthCookie() {
    return Tn.get(this.authCookieName);
  }
  setAuthCookie(t, e) {
    ...
    Tn.set(this.authCookieName, t, i);
  }
  removeAuthCookie() {
    Tn.remove(this.authCookieName);
  }
}
class Ia {
  constructor(t) {
...
class $a {
  constructor(t) {
    this.headers = void 0, this.ok = void 0, this.status = void 0, this.statusText = void 0, this.url = void 0, this._decodedJSON = void 0, this.xhr = void 0, this.headers = new Oa(t), this.ok = t.status >= 200 && t.status <= 299, this.status = t.status, this.statusText = t.statusText, this.url = t.responseURL, this.xhr = t;
  }
  json() {
...
class Yn {
  constructor(t, e) {
    var o;
    this.timeout = void 0, this.api = void 0, this.dispatcher = void 0, this.cookie = void 0, this.sessionTokenStorage = void 0, this.lang = void 0, this.sessionTokenLocation = void 0, this.api = t, this.timeout = (o = e.timeout) != null ? o : 13e3, this.dispatcher = new vi(), this.cookie = new _i(qe({}, e)), this.sessionTokenStorage = new Ia({ keyName: e.cookieName }), this.lang = e.lang, this.sessionTokenLocation = e.sessionTokenLocation;
  }
...
class yi extends vi {
  constructor(t, e) {
    super(), this.listener = new yn(), this.checkInterval = 3e4, this.client = void 0, this.sessionState = void 0, this.windowActivityManager = void 0, this.scheduler = void 0, this.sessionChannel = void 0, this.isLoggedIn = void 0, this.client = new Gn(t, e), e.sessionCheckInterval && (this.checkInterval = e.sessionCheckInterval < 3e3 ? 3e3 : e.sessionCheckInterval), this.sessionState = new Ta(`${e.cookieName}_session_state`), this.sessionChannel = new La(this.getSessionCheckChannelName(e.sessionTokenLocation, e.sessionCheckChannelName), () => this.onChannelSessionExpired(), (r) => this.onChannelSessionCreated(r), () => this.onChannelLeadershipRequested()), this.scheduler = new Ua(this.checkInterval, () => this.checkSession(), () => this.onSessionExpired()), this.windowActivityManager = new Da(() => this.startSessionCheck(), () => this.scheduler.stop());
...
var ki = { type: me(ce), id: me(Me), transports: we(ce) }, Si = { appid: we(ce), appidExclude: we(ce), credProps: we(ce) }, xi = { appid: we(ce), appidExclude: we(ce), credProps: we(ce) }, Na = { publicKey: me({ rp: me(ce), user: me({ id: me(Me), name: me(ce), displayName: me(ce) }), challenge: me(Me), pubKeyCredParams: me(ce), timeout: we(ce), excludeCredentials: we([ki]), authenticatorSelection: we(ce), attestation: we(ce), extensions: we(Si) }), signal: we(ce) }, Ma = { type: me(ce), id: me(ce), rawId: me(Me), authenticatorAttachment: we(ce), response: me({ clientDataJSON: me(Me), attestationObject: me(Me), transports: Rn(ce, (n) => {
  var t;
  return ((t = n.getTransports) == null ? void 0 : t.call(n)) || [];
}) }), clientExtensionResults: Rn(xi, (n) => n.getClientExtensionResults()) }, Ra = { mediation: we(ce), publicKey: me({ challenge: me(Me), timeout: we(ce), rpId: we(ce), allowCredentials: we([ki]), userVerification: we(ce), extensions: we(Si) }), signal: we(ce) }, za = { type: me(ce), id: me(ce), rawId: me(Me), authenticatorAttachment: we(ce), response: me({ clientDataJSON: me(Me), authenticatorData: me(Me), signature: me(Me), userHandle: me(Me) }), clientExtensionResults: Rn(xi, (n) => n.getClientExtensionResults()) };
async function Eo(n) {
...
class Ze {
  ...
  async getWebauthnCredential(t) {
    return await Eo(qe({}, t, { signal: this.createAbortSignal() }));
  }
  async getConditionalWebauthnCredential(t) {
    return await Eo({ publicKey: t, mediation: "conditional", signal: this.createAbortSignal() });
  }
...
Ze.instance = null;
const Xn = "hanko_pkce_code_verifier", wn = () => {
  let n = "";
  ...
  typeof window < "u" && window.sessionStorage && window.sessionStorage.setItem(Xn, n);
}, Ci = () => typeof window < "u" && window.sessionStorage ? window.sessionStorage.getItem(Xn) : null, nt = () => {
  typeof window < "u" && window.sessionStorage && window.sessionStorage.removeItem(Xn);
};
...
const Oo = { preflight: async (n) => await n.actions.register_client_capabilities.run({ webauthn_available: ft.supported(), webauthn_conditional_mediation_available: await ft.isConditionalMediationAvailable(), webauthn_platform_authenticator_available: await ft.isPlatformAuthenticatorAvailable() }), login_passkey: async (n) => {
...
}, onboarding_verify_passkey_attestation: async (n) => Io(n, Ze.getInstance(), n.payload.creation_options), webauthn_credential_verification: async (n) => Io(n, Ze.getInstance(), n.payload.creation_options), async thirdparty(n) {
...
class ze {
  constructor(t, e, o, i = {}) {
    if (this.name = void 0, this.flowName = void 0, this.error = void 0, this.payload = void 0, this.actions = void 0, this.csrfToken = void 0, this.status = void 0, this.previousAction = void 0, this.isCached = void 0, this.cacheKey = void 0, this.hanko = void 0, this.invokedAction = void 0, this.excludeAutoSteps = void 0, this.autoStep = void 0, this.passkeyAutofillActivation = void 0, this.flowName = e, this.name = o.name, this.error = o.error, this.payload = o.payload, this.csrfToken = o.csrf_token, this.status = o.status, this.hanko = t, this.actions = this.buildActionMap(o.actions), this.name in Oo) {
      const l = Oo[this.name];
  ...
  buildActionMap(t) {
    ...
    return Object.keys(t).forEach((o) => {
      ...
      return Ht.createDisabled(r, this);
    } });
  }
...
class Ht {
  ...
  static createDisabled(t, e) {
    return new Ht({ action: t, href: "", inputs: {}, description: "Disabled action" }, e, !1);
  }
  async run(t = null, e = {}) {
    ...
    const m = { input_data: qe({}, Object.keys(this.inputs).reduce((g, S) => {
      const x = this.inputs[S];
      return x.value !== void 0 && (g[S] = x.value), g;
...
class Pi extends yn {
  constructor(t, e) {
    ...
    this.client = new Yn(t, o), this.session = new Gn(t, o), this.user = new Ai(t, o), this.relay = new yi(t, o), this.cookie = new _i(o);
  }
  setLang(t) {
    this.client.lang = t;
  }
...
var qa = ee(292), Je = ee.n(qa), ja = ee(360), Ye = ee.n(ja), Ha = ee(884), Qe = ee.n(Ha), Fa = ee(88), Ge = ee.n(Fa), on = ee(890), xt = {};
xt.setAttributes = Qe(), xt.insert = (n) => {
  window._hankoStyle = n;
}, xt.domAPI = Ye(), xt.insertStyleElement = Ge(), Je()(on.A, xt);
const Ft = on.A && on.A.locals ? on.A.locals : void 0, Wa = function(n) {
  function t(e) {
    var o = di({}, e);
    return delete o.ref, n(o, e.ref || null);
  }
  return t.$$typeof = ga, t.render = n, t.prototype.isReactComponent = t.__f = !0, t.displayName = "ForwardRef(" + (n.displayName || n.name) + ")", t;
}((n, t) => {
...
const T = an.A && an.A.locals ? an.A.locals : void 0;
var Ka = ee(452), Q = ee.n(Ka);
const Va = ({ size: n, secondary: t, disabled: e }) => a("svg", { id: "icon-apple", xmlns: "http://www.w3.org/2000/svg", width: n, height: n, viewBox: "20.5 16 15 19", className: Q()(T.icon, t && T.secondary, e && T.disabled), children: a("path", { d: "M28.2226562,20.3846154 C29.0546875,20.3846154 30.0976562,19.8048315 30.71875,19.0317864 C31.28125,18.3312142 31.6914062,17.352829 31.6914062,16.3744437 C31.6914062,16.2415766 31.6796875,16.1087095 31.65625,16 C30.7304687,16.0362365 29.6171875,16.640178 28.9492187,17.4494596 C28.421875,18.06548 27.9414062,19.0317864 27.9414062,20.0222505 C27.9414062,20.1671964 27.9648438,20.3121424 27.9765625,20.3604577 C28.0351562,20.3725366 28.1289062,20.3846154 28.2226562,20.3846154 Z M25.2929688,35 C26.4296875,35 26.9335938,34.214876 28.3515625,34.214876 C29.7929688,34.214876 30.109375,34.9758423 31.375,34.9758423 C32.6171875,34.9758423 33.4492188,33.792117 34.234375,32.6325493 C35.1132812,31.3038779 35.4765625,29.9993643 35.5,29.9389701 C35.4179688,29.9148125 33.0390625,28.9122695 33.0390625,26.0979021 C33.0390625,23.6579784 34.9140625,22.5588048 35.0195312,22.474253 C33.7773438,20.6382708 31.890625,20.5899555 31.375,20.5899555 C29.9804688,20.5899555 28.84375,21.4596313 28.1289062,21.4596313 C27.3554688,21.4596313 26.3359375,20.6382708 25.1289062,20.6382708 C22.8320312,20.6382708 20.5,22.5950413 20.5,26.2911634 C20.5,28.5861411 21.3671875,31.013986 22.4335938,32.5842339 C23.3476562,33.9129053 24.1445312,35 25.2929688,35 Z" }) }), Ba = ({ secondary: n, size: t, fadeOut: e, disabled: o }) => a("svg", { id: "icon-checkmark", xmlns: "http://www.w3.org/2000/svg", viewBox: "4 4 40 40", width: t, height: t, className: Q()(T.checkmark, n && T.secondary, e && T.fadeOut, o && T.disabled), children: a("path", { d: "M21.05 33.1 35.2 18.95l-2.3-2.25-11.85 11.85-6-6-2.25 2.25ZM24 44q-4.1 0-7.75-1.575-3.65-1.575-6.375-4.3-2.725-2.725-4.3-6.375Q4 28.1 4 24q0-4.15 1.575-7.8 1.575-3.65 4.3-6.35 2.725-2.7 6.375-4.275Q19.9 4 24 4q4.15 0 7.8 1.575 3.65 1.575 6.35 4.275 2.7 2.7 4.275 6.35Q44 19.85 44 24q0 4.1-1.575 7.75-1.575 3.65-4.275 6.375t-6.35 4.3Q28.15 44 24 44Zm0-3q7.1 0 12.05-4.975Q41 31.05 41 24q0-7.1-4.95-12.05Q31.1 7 24 7q-7.05 0-12.025 4.95Q7 16.9 7 24q0 7.05 4.975 12.025Q16.95 41 24 41Zm0-17Z" }) }), Za = ({ size: n, secondary: t, disabled: e }) => a("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 -960 960 960", width: n, height: n, className: Q()(T.icon, t && T.secondary, e && T.disabled), children: a("path", { d: "M360-240q-33 0-56.5-23.5T280-320v-480q0-33 23.5-56.5T360-880h360q33 0 56.5 23.5T800-800v480q0 33-23.5 56.5T720-240H360Zm0-80h360v-480H360v480ZM200-80q-33 0-56.5-23.5T120-160v-560h80v560h440v80H200Zm160-240v-480 480Z" }) }), Ja = ({ size: n, secondary: t, disabled: e }) => a("svg", { id: "icon-custom-provider", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: n, height: n, className: Q()(T.icon, t && T.secondary, e && T.disabled), children: [a("path", { d: "M0 0h24v24H0z", fill: "none" }), a("path", { d: "M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z" })] }), Ya = ({ size: n, secondary: t, disabled: e }) => a("svg", { id: "icon-discord", fill: "#fff", xmlns: "http://www.w3.org/2000/svg", width: n, height: n, viewBox: "0 0 127.14 96.36", className: Q()(T.icon, t && T.secondary, e && T.disabled), children: a("path", { d: "M107.7,8.07A105.15,105.15,0,0,0,81.47,0a72.06,72.06,0,0,0-3.36,6.83A97.68,97.68,0,0,0,49,6.83,72.37,72.37,0,0,0,45.64,0,105.89,105.89,0,0,0,19.39,8.09C2.79,32.65-1.71,56.6.54,80.21h0A105.73,105.73,0,0,0,32.71,96.36,77.7,77.7,0,0,0,39.6,85.25a68.42,68.42,0,0,1-10.85-5.18c.91-.66,1.8-1.34,2.66-2a75.57,75.57,0,0,0,64.32,0c.87.71,1.76,1.39,2.66,2a68.68,68.68,0,0,1-10.87,5.19,77,77,0,0,0,6.89,11.1A105.25,105.25,0,0,0,126.6,80.22h0C129.24,52.84,122.09,29.11,107.7,8.07ZM42.45,65.69C36.18,65.69,31,60,31,53s5-12.74,11.43-12.74S54,46,53.89,53,48.84,65.69,42.45,65.69Zm42.24,0C78.41,65.69,73.25,60,73.25,53s5-12.74,11.44-12.74S96.23,46,96.12,53,91.08,65.69,84.69,65.69Z" }) }), Qa = ({ size: n, secondary: t, disabled: e }) => a("svg", { id: "icon-exclamation", xmlns: "http://www.w3.org/2000/svg", viewBox: "5 2 13 20", width: n, height: n, className: Q()(T.exclamationMark, t && T.secondary, e && T.disabled), children: a("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z" }) }), Ga = ({ size: n, secondary: t, disabled: e }) => a("svg", { width: n, height: n, viewBox: "0 0 666.66668 666.66717", xmlns: "http://www.w3.org/2000/svg", children: [a("defs", { id: "defs13", children: a("clipPath", { clipPathUnits: "userSpaceOnUse", id: "clipPath25", children: a("path", { d: "M 0,700 H 700 V 0 H 0 Z", id: "path23" }) }) }), a("g", { id: "g17", transform: "matrix(1.3333333,0,0,-1.3333333,-133.33333,799.99999)", children: a("g", { id: "g19", children: a("g", { id: "g21", clipPath: "url(#clipPath25)", children: [a("g", { id: "g27", transform: "translate(600,350)", children: a("path", { className: Q()(T.facebookIcon, e ? T.disabledOutline : T.outline), d: "m 0,0 c 0,138.071 -111.929,250 -250,250 -138.071,0 -250,-111.929 -250,-250 0,-117.245 80.715,-215.622 189.606,-242.638 v 166.242 h -51.552 V 0 h 51.552 v 32.919 c 0,85.092 38.508,124.532 122.048,124.532 15.838,0 43.167,-3.105 54.347,-6.211 V 81.986 c -5.901,0.621 -16.149,0.932 -28.882,0.932 -40.993,0 -56.832,-15.528 -56.832,-55.9 V 0 h 81.659 l -14.028,-76.396 h -67.631 V -248.169 C -95.927,-233.218 0,-127.818 0,0", id: "path29" }) }), a("g", { id: "g31", transform: "translate(447.9175,273.6036)", children: a("path", { className: Q()(T.facebookIcon, e ? T.disabledLetter : T.letter), d: "M 0,0 14.029,76.396 H -67.63 v 27.019 c 0,40.372 15.838,55.899 56.831,55.899 12.733,0 22.981,-0.31 28.882,-0.931 v 69.253 c -11.18,3.106 -38.509,6.212 -54.347,6.212 -83.539,0 -122.048,-39.441 -122.048,-124.533 V 76.396 h -51.552 V 0 h 51.552 v -166.242 c 19.343,-4.798 39.568,-7.362 60.394,-7.362 10.254,0 20.358,0.632 30.288,1.831 L -67.63,0 Z", id: "path33" }) })] }) }) })] }), Xa = ({ size: n, secondary: t, disabled: e }) => a("svg", { id: "icon-github", xmlns: "http://www.w3.org/2000/svg", fill: "#fff", viewBox: "0 0 97.63 96", width: n, height: n, className: Q()(T.icon, t && T.secondary, e && T.disabled), children: [a("path", { d: "M48.854 0C21.839 0 0 22 0 49.217c0 21.756 13.993 40.172 33.405 46.69 2.427.49 3.316-1.059 3.316-2.362 0-1.141-.08-5.052-.08-9.127-13.59 2.934-16.42-5.867-16.42-5.867-2.184-5.704-5.42-7.17-5.42-7.17-4.448-3.015.324-3.015.324-3.015 4.934.326 7.523 5.052 7.523 5.052 4.367 7.496 11.404 5.378 14.235 4.074.404-3.178 1.699-5.378 3.074-6.6-10.839-1.141-22.243-5.378-22.243-24.283 0-5.378 1.94-9.778 5.014-13.2-.485-1.222-2.184-6.275.486-13.038 0 0 4.125-1.304 13.426 5.052a46.97 46.97 0 0 1 12.214-1.63c4.125 0 8.33.571 12.213 1.63 9.302-6.356 13.427-5.052 13.427-5.052 2.67 6.763.97 11.816.485 13.038 3.155 3.422 5.015 7.822 5.015 13.2 0 18.905-11.404 23.06-22.324 24.283 1.78 1.548 3.316 4.481 3.316 9.126 0 6.6-.08 11.897-.08 13.526 0 1.304.89 2.853 3.316 2.364 19.412-6.52 33.405-24.935 33.405-46.691C97.707 22 75.788 0 48.854 0z" }), " "] }), er = ({ size: n, disabled: t }) => a("svg", { id: "icon-google", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: n, height: n, className: T.googleIcon, children: [a("path", { className: Q()(T.googleIcon, t ? T.disabled : T.blue), d: "M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" }), a("path", { className: Q()(T.googleIcon, t ? T.disabled : T.green), d: "M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" }), a("path", { className: Q()(T.googleIcon, t ? T.disabled : T.yellow), d: "M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" }), a("path", { className: Q()(T.googleIcon, t ? T.disabled : T.red), d: "M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" }), a("path", { d: "M1 1h22v22H1z", fill: "none" })] }), tr = ({ size: n, secondary: t, disabled: e }) => a("svg", { id: "icon-linkedin", fill: "#fff", xmlns: "http://www.w3.org/2000/svg", width: n, viewBox: "0 0 24 24", height: n, className: Q()(T.icon, t && T.secondary, e && T.disabled), children: a("path", { d: "M20.5 2h-17A1.5 1.5 0 002 3.5v17A1.5 1.5 0 003.5 22h17a1.5 1.5 0 001.5-1.5v-17A1.5 1.5 0 0020.5 2zM8 19H5v-9h3zM6.5 8.25A1.75 1.75 0 118.3 6.5a1.78 1.78 0 01-1.8 1.75zM19 19h-3v-4.74c0-1.42-.6-1.93-1.38-1.93A1.74 1.74 0 0013 14.19a.66.66 0 000 .14V19h-3v-9h2.9v1.3a3.11 3.11 0 012.7-1.4c1.55 0 3.36.86 3.36 3.66z" }) }), nr = ({ size: n, secondary: t, disabled: e }) => a("svg", { id: "icon-mail", xmlns: "http://www.w3.org/2000/svg", width: n, height: n, viewBox: "0 -960 960 960", className: Q()(T.icon, t && T.secondary, e && T.disabled), children: a("path", { d: "M160-160q-33 0-56.5-23.5T80-240v-480q0-33 23.5-56.5T160-800h640q33 0 56.5 23.5T880-720v480q0 33-23.5 56.5T800-160H160Zm320-280L160-640v400h640v-400L480-440Zm0-80 320-200H160l320 200ZM160-640v-80 480-400Z" }) }), or = ({ size: n, disabled: t }) => a("svg", { id: "icon-microsoft", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: n, height: n, className: T.microsoftIcon, children: [a("rect", { className: Q()(T.microsoftIcon, t ? T.disabled : T.blue), x: "1", y: "1", width: "9", height: "9" }), a("rect", { className: Q()(T.microsoftIcon, t ? T.disabled : T.green), x: "1", y: "11", width: "9", height: "9" }), a("rect", { className: Q()(T.microsoftIcon, t ? T.disabled : T.yellow), x: "11", y: "1", width: "9", height: "9" }), a("rect", { className: Q()(T.microsoftIcon, t ? T.disabled : T.red), x: "11", y: "11", width: "9", height: "9" })] }), ir = ({ size: n, secondary: t, disabled: e }) => a("svg", { id: "icon-passkey", xmlns: "http://www.w3.org/2000/svg", viewBox: "3 1.5 19.5 19", width: n, height: n, className: Q()(T.icon, t && T.secondary, e && T.disabled), children: a("g", { id: "icon-passkey-all", children: [a("circle", { id: "icon-passkey-head", cx: "10.5", cy: "6", r: "4.5" }), a("path", { id: "icon-passkey-key", d: "M22.5,10.5a3.5,3.5,0,1,0-5,3.15V19L19,20.5,21.5,18,20,16.5,21.5,15l-1.24-1.24A3.5,3.5,0,0,0,22.5,10.5Zm-3.5,0a1,1,0,1,1,1-1A1,1,0,0,1,19,10.5Z" }), a("path", { id: "icon-passkey-body", d: "M14.44,12.52A6,6,0,0,0,12,12H9a6,6,0,0,0-6,6v2H16V14.49A5.16,5.16,0,0,1,14.44,12.52Z" })] }) }), ar = ({ size: n, secondary: t, disabled: e }) => a("svg", { id: "icon-password", xmlns: "http://www.w3.org/2000/svg", width: n, height: n, viewBox: "0 -960 960 960", className: Q()(T.icon, t && T.secondary, e && T.disabled), children: a("path", { d: "M80-200v-80h800v80H80Zm46-242-52-30 34-60H40v-60h68l-34-58 52-30 34 58 34-58 52 30-34 58h68v60h-68l34 60-52 30-34-60-34 60Zm320 0-52-30 34-60h-68v-60h68l-34-58 52-30 34 58 34-58 52 30-34 58h68v60h-68l34 60-52 30-34-60-34 60Zm320 0-52-30 34-60h-68v-60h68l-34-58 52-30 34 58 34-58 52 30-34 58h68v60h-68l34 60-52 30-34-60-34 60Z" }) }), rr = ({ size: n, secondary: t, disabled: e }) => a("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 -960 960 960", width: n, height: n, className: Q()(T.icon, t && T.secondary, e && T.disabled), children: a("path", { d: "M80-680v-200h200v80H160v120H80Zm0 600v-200h80v120h120v80H80Zm600 0v-80h120v-120h80v200H680Zm120-600v-120H680v-80h200v200h-80ZM700-260h60v60h-60v-60Zm0-120h60v60h-60v-60Zm-60 60h60v60h-60v-60Zm-60 60h60v60h-60v-60Zm-60-60h60v60h-60v-60Zm120-120h60v60h-60v-60Zm-60 60h60v60h-60v-60Zm-60-60h60v60h-60v-60Zm240-320v240H520v-240h240ZM440-440v240H200v-240h240Zm0-320v240H200v-240h240Zm-60 500v-120H260v120h120Zm0-320v-120H260v120h120Zm320 0v-120H580v120h120Z" }) }), sr = ({ size: n, secondary: t, disabled: e }) => a("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 -960 960 960", width: n, height: n, className: Q()(T.icon, t && T.secondary, e && T.disabled), children: a("path", { d: "M280-240q-100 0-170-70T40-480q0-100 70-170t170-70q66 0 121 33t87 87h432v240h-80v120H600v-120H488q-32 54-87 87t-121 33Zm0-80q66 0 106-40.5t48-79.5h246v120h80v-120h80v-80H434q-8-39-48-79.5T280-640q-66 0-113 47t-47 113q0 66 47 113t113 47Zm0-80q33 0 56.5-23.5T360-480q0-33-23.5-56.5T280-560q-33 0-56.5 23.5T200-480q0 33 23.5 56.5T280-400Zm0-80Z" }) }), cr = ({ size: n, disabled: t }) => a("svg", { id: "icon-spinner", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: n, height: n, className: Q()(T.loadingSpinner, t && T.disabled), children: [a("path", { d: "M12,1A11,11,0,1,0,23,12,11,11,0,0,0,12,1Zm0,19a8,8,0,1,1,8-8A8,8,0,0,1,12,20Z", opacity: ".25" }), a("path", { d: "M10.72,19.9a8,8,0,0,1-6.5-9.79A7.77,7.77,0,0,1,10.4,4.16a8,8,0,0,1,9.49,6.52A1.54,1.54,0,0,0,21.38,12h.13a1.37,1.37,0,0,0,1.38-1.54,11,11,0,1,0-12.7,12.39A1.54,1.54,0,0,0,12,21.34h0A1.47,1.47,0,0,0,10.72,19.9Z" })] }), Wt = ({ name: n, secondary: t, size: e = 18, fadeOut: o, disabled: i }) => a(Mn[n], { size: e, secondary: t, fadeOut: o, disabled: i }), eo = ({ children: n, isLoading: t, isSuccess: e, fadeOut: o, secondary: i, hasIcon: r, maxWidth: s }) => a(b.Fragment, { children: a("div", t ? { className: Q()(T.loadingSpinnerWrapper, T.centerContent, s && T.maxWidth), children: a(Wt, { name: "spinner", secondary: i }) } : e ? { className: Q()(T.loadingSpinnerWrapper, T.centerContent, s && T.maxWidth), children: a(Wt, { name: "checkmark", secondary: i, fadeOut: o }) } : { className: r ? T.loadingSpinnerWrapperIcon : T.loadingSpinnerWrapper, children: n }) }), lr = () => a(eo, { isLoading: !0 }), Ee = (n) => {
...
const xe = rn.A && rn.A.locals ? rn.A.locals : void 0, Ei = (n, t, e) => {
...
}, Ii = (0, b.createContext)({}), te = ({ onSubmit: n, children: t, hidden: e = !1, maxWidth: o, flowAction: i }) => a(Ii.Provider, { value: { flowAction: i }, children: i && i.enabled && !e ? a("form", { onSubmit: n || ((r) => function(s, d, u, c) {
  ...
  const m = (0, f.useRef)(null), { uiState: v } = (0, f.useContext)(Ue), { t: g } = (0, f.useContext)(J.TranslateContext), [S, x] = (0, f.useState)(!1), [C, D] = (0, f.useState)(!1), { flowAction: W } = (0, f.useContext)(Ii);
  Ei(W, x, D), (0, f.useEffect)(() => {
    const { current: I } = m;
    I && r && I.focus();
  }, [r]);
  const w = (0, f.useMemo)(() => c && (C || l.isSuccess), [C, l, c]), E = (0, f.useMemo)(() => v.isDisabled || l.disabled, [l, v]);
  return a("button", { part: i ? "button dangerous-button" : o ? "button secondary-button" : "button primary-button", title: t, ref: m, type: "submit", disabled: E, onClick: d, className: Q()(xe.button, i ? xe.dangerous : o ? xe.secondary : xe.primary), "data-bubble": s ? g("labels.lastUsed") : void 0, children: a(eo, { isLoading: S, isSuccess: w, secondary: !0, hasIcon: !!u, maxWidth: !0, children: [u ? a(Wt, { name: u, secondary: o, disabled: E }) : null, a("div", { className: xe.caption, children: a("span", { children: e }) })] }) });
}, Le = (n) => {
  var t, e, o, i, r, { label: s } = n, d = function(g, S) {
    var x = {};
    for (var C in g) Object.prototype.hasOwnProperty.call(g, C) && S.indexOf(C) < 0 && (x[C] = g[C]);
    if (g != null && typeof Object.getOwnPropertySymbols == "function") {
      var D = 0;
      for (C = Object.getOwnPropertySymbols(g); D < C.length; D++) S.indexOf(C[D]) < 0 && Object.prototype.propertyIsEnumerable.call(g, C[D]) && (x[C[D]] = g[C[D]]);
    }
    return x;
  }(n, ["label"]);
...
const Nt = sn.A && sn.A.locals ? sn.A.locals : void 0, to = ({ children: n, hidden: t }) => t ? null : a("section", { part: "divider", className: Nt.divider, children: [a("div", { part: "divider-line", className: Nt.line }), n ? a("div", { part: "divider-text", class: Nt.text, children: n }) : null, a("div", { part: "divider-line", className: Nt.line })] });
var cn = ee(217), Et = {};
Et.setAttributes = Qe(), Et.insert = (n) => {
  window._hankoStyle = n;
}, Et.domAPI = Ye(), Et.insertStyleElement = Ge(), Je()(cn.A, Et);
const Oi = cn.A && cn.A.locals ? cn.A.locals : void 0, Se = ({ state: n, error: t, flowError: e }) => {
  var o, i;
  ...
  }, [n]), a("section", { part: "error", className: Oi.errorBox, hidden: !(!((o = s.error) === null || o === void 0) && o.code) && !(e != null && e.code) && !t, children: [a("span", { children: a(Wt, { name: "exclamation", size: 15 }) }), a("span", { id: "errorMessage", part: "error-text", children: r(t ? `errors.${t.code}` : `flowErrors.${((i = s.error) === null || i === void 0 ? void 0 : i.code) || (e == null ? void 0 : e.code)}`) })] });
};
var ln = ee(547), It = {};
...
const Qt = dn.A && dn.A.locals ? dn.A.locals : void 0, zn = (n) => {
  ...
  }, [o]), I = (0, f.useCallback)(() => w ? null : a(b.Fragment, { children: [u ? a(b.Fragment, { children: [a(zn, { onClick: E, children: s("labels.yes") }), " / ", a(zn, { onClick: C, children: s("labels.no") }), " "] }) : null, a("button", Object.assign({}, r, { onClick: e ? x : o, disabled: u || r.disabled || d.isDisabled, part: "link", className: Q()(Qt.link, e ? Qt.danger : null), children: r.children }))] }), [w, d, u, e, o, E, r, s]);
  ...
  }, children: a(b.Fragment, u || !D && !W ? { children: I() } : { children: [a(eo, { isLoading: D, isSuccess: W, secondary: r.secondary, fadeOut: !0 }), I()] }) }) });
}, G = zn, $e = ({ children: n, hidden: t = !1 }) => t ? null : a("section", { className: Ft.footer, children: n }), no = (n) => {
...
$t.setAttributes = Qe(), $t.insert = (n) => {
  window._hankoStyle = n;
}, $t.domAPI = Ye(), $t.insertStyleElement = Ge(), Je()(un.A, $t);
const Dn = un.A && un.A.locals ? un.A.locals : void 0, K = ({ children: n, hidden: t, center: e }) => t ? null : a("p", { part: "paragraph", className: Q()(Dn.paragraph, e && Dn.center, e && Dn.column), children: n });
...
const dr = (n) => {
  var t;
  const { t: e } = (0, f.useContext)(J.TranslateContext), { init: o, initialComponentName: i, uiState: r, setUIState: s, hidePasskeyButtonOnLogin: d, lastLogin: u } = (0, f.useContext)(Ue), [c, l] = (0, f.useState)(!1), [m, v] = (0, f.useState)(null), [g, S] = (0, f.useState)(null), { flowState: x } = Ee(n.state), C = ft.supported(), [D, W] = (0, f.useState)(void 0), [w, E] = (0, f.useState)(null), [I, M] = (0, f.useState)(!1), z = (N) => {
  ...
  return (0, f.useEffect)(() => {
    ...
    N != null && N.email ? (v("email"), S(r.email)) : N != null && N.username ? (v("username"), S(r.username)) : (v("identifier"), S(r.email || r.username));
  ...
  }), maxWidth: !0, children: [X.email ? a(Le, { type: "email", autoComplete: "username webauthn", autoCorrect: "off", flowInput: X.email, onInput: z, value: g, placeholder: e("labels.email"), pattern: "^[^@]+@[^@]+\\.[^@]+$" }) : X.username ? a(Le, { type: "text", autoComplete: "username webauthn", autoCorrect: "off", flowInput: X.username, onInput: z, value: g, placeholder: e("labels.username") }) : a(Le, { type: "text", autoComplete: "username webauthn", autoCorrect: "off", flowInput: X.identifier, onInput: z, value: g, placeholder: e("labels.emailOrUsername") }), a(ne, { children: e("labels.continue") })] }), a(to, { hidden: !V, children: e("labels.or") })] }) : null, x.actions.thirdparty_oauth.enabled ? (t = x.actions.thirdparty_oauth.inputs.provider.allowed_values) === null || t === void 0 ? void 0 : t.map((N) => a(te, { flowAction: x.actions.thirdparty_oauth, onSubmit: (fe) => ((_e, ue) => Gt(void 0, void 0, void 0, function* () {
  ...
  }))(fe, N.value), children: a(ne, { isLoading: N.value == w, secondary: !0, icon: N.value.startsWith("custom_") ? "customProvider" : N.value, showLastUsed: (u == null ? void 0 : u.login_method) == "third_party" && (u == null ? void 0 : u.third_party_provider) == N.value, children: e("labels.signInWith", { provider: N.name }) }) }, N.value)) : null, x.actions.webauthn_generate_request_options.enabled && !d ? a(te, { flowAction: x.actions.webauthn_generate_request_options, children: a(ne, { secondary: !0, title: C ? null : e("labels.webauthnUnsupported"), disabled: !C, children: e("labels.signInPasskey") }) }) : null, x.actions.remember_me.enabled && a(b.Fragment, { children: [a(Sn, {}), a(no, { required: !1, type: "checkbox", label: e("labels.staySignedIn"), checked: I, onChange: (N) => Gt(void 0, void 0, void 0, function* () {
    return M((fe) => !fe), x.actions.remember_me.run({ remember_me: !I });
  }) })] })] }), a($e, { hidden: i !== "auth", children: a(K, { center: !0, children: [a("span", { children: e("labels.dontHaveAnAccount") }), a(G, { onClick: (N) => Gt(void 0, void 0, void 0, function* () {
...
}, oo = ({ passcodeDigits: n = [], numberOfInputs: t = 6, onInput: e, disabled: o = !1 }) => {
  const [i, r] = (0, f.useState)(0), s = () => n.slice(), d = () => {
    ...
    const S = g.clipboardData.getData("text/plain").slice(0, t - i).split(""), x = s();
    let C = i;
    for (let D = 0; D < t; ++D) D >= i && S.length > 0 && (x[D] = S.shift(), C++);
    r(C), e(x);
  }, m = (g) => {
  ...
  return (0, f.useEffect)(() => {
    n.length === 0 && r(0);
  }, [n]), a("div", { className: xe.passcodeInputWrapper, children: Array.from(Array(t)).map((g, S) => a(ur, { name: "passcode", index: S, focus: i === S, digit: n[S], onKeyDown: m, onInput: v, onPaste: l, onFocus: () => ((x) => {
    r(x);
  })(S), disabled: o }, S)) });
};
...
const hr = (n) => {
  ...
  }, [e]), v = (0, f.useCallback)((g) => To(void 0, void 0, void 0, function* () {
  ...
  return (0, f.useEffect)(() => {
    ...
    var g;
    d == 0 && ((g = e.error) === null || g === void 0 ? void 0 : g.code) == "rate_limit_exceeded" && i((S) => Object.assign(Object.assign({}, S), { error: null }));
  }, [d]), (0, f.useEffect)(() => {
    l([]), e.payload.resend_after >= 0 && u(e.payload.resend_after);
  }, [e]), a(b.Fragment, { children: [a(ke, { children: [a(de, { children: t("headlines.loginPasscode") }), a(Se, { state: e }), a(K, { children: o.email ? t("texts.enterPasscode") : t("texts.enterPasscodeNoEmail") }), a(K, { hidden: !o.email, children: a("b", { children: o.email }) }), a(te, { flowAction: e.actions.verify_passcode, onSubmit: (g) => To(void 0, void 0, void 0, function* () {
    return g.preventDefault(), v(c.join(""));
  }), children: [a(oo, { onInput: (g) => {
    if (l(g), g.filter((S) => S !== "").length === 6) return v(g.join(""));
  }, passcodeDigits: c, numberOfInputs: 6, disabled: r <= 0 || m }), a(ne, { disabled: r <= 0 || m, children: t("labels.continue") })] })] }), a($e, { children: [a(G, { flowAction: e.actions.back, loadingSpinnerPosition: "right", children: t("labels.back") }), a(G, { disabled: d > 0, flowAction: e.actions.resend_passcode, loadingSpinnerPosition: "left", children: d > 0 ? t("labels.passcodeResendAfter", { passcodeResendAfter: d }) : t("labels.sendNewPasscode") })] })] });
}, pr = (n) => {
  const { t } = (0, f.useContext)(J.TranslateContext), { flowState: e } = Ee(n.state);
  return a(b.Fragment, { children: [a(ke, { children: [a(de, { children: t("headlines.registerAuthenticator") }), a(Se, { state: e }), a(K, { children: t("texts.setupPasskey") }), a(te, { flowAction: e.actions.webauthn_generate_creation_options, children: a(ne, { autofocus: !0, icon: "passkey", children: t("labels.registerAuthenticator") }) })] }), a($e, { hidden: !e.actions.skip.enabled && !e.actions.back.enabled, children: [a(G, { loadingSpinnerPosition: "right", flowAction: e.actions.back, children: t("labels.back") }), a(G, { loadingSpinnerPosition: "left", flowAction: e.actions.skip, children: t("labels.skip") })] })] });
};
...
const mr = (n) => {
  ...
  }, [r]), a(b.Fragment, { children: [a(ke, { children: [a(de, { children: t("headlines.loginPassword") }), a(Se, { state: e }), a(te, { flowAction: e.actions.password_login, onSubmit: (c) => Do(void 0, void 0, void 0, function* () {
    return c.preventDefault(), e.actions.password_login.run({ password: o });
  }), children: [a(Le, { type: "password", flowInput: e.actions.password_login.inputs.password, autocomplete: "current-password", placeholder: t("labels.password"), onInput: (c) => Do(void 0, void 0, void 0, function* () {
    c.target instanceof HTMLInputElement && i(c.target.value);
  }), autofocus: !0 }), a(ne, { disabled: r > 0, children: r > 0 ? t("labels.passwordRetryAfter", { passwordRetryAfter: r }) : t("labels.signIn") })] }), e.actions.continue_to_login_method_chooser.enabled ? d : null] }), a($e, { children: [a(G, { flowAction: e.actions.back, loadingSpinnerPosition: "right", children: t("labels.back") }), e.actions.continue_to_login_method_chooser.enabled ? u : d] })] });
};
...
const fr = (n) => {
  ...
  return a(ke, { children: [a(de, { children: t("headlines.registerPassword") }), a(Se, { state: e }), a(K, { children: t("texts.passwordFormatHint", { minLength: e.actions.password_recovery.inputs.new_password.min_length, maxLength: 72 }) }), a(te, { flowAction: e.actions.password_recovery, onSubmit: (r) => Uo(void 0, void 0, void 0, function* () {
    return r.preventDefault(), e.actions.password_recovery.run({ new_password: o });
  }), children: [a(Le, { type: "password", autocomplete: "new-password", flowInput: e.actions.password_recovery.inputs.new_password, placeholder: t("labels.newPassword"), onInput: (r) => Uo(void 0, void 0, void 0, function* () {
    r.target instanceof HTMLInputElement && i(r.target.value);
  }), autofocus: !0 }), a(ne, { children: t("labels.continue") })] })] });
}, gr = (n) => {
  const { t } = (0, f.useContext)(J.TranslateContext), { flowState: e } = Ee(n.state);
  return a(b.Fragment, { children: [a(ke, { children: [a(de, { children: t("headlines.selectLoginMethod") }), a(Se, { flowError: e == null ? void 0 : e.error }), a(K, { children: t("texts.howDoYouWantToLogin") }), a(te, { flowAction: e.actions.continue_to_passcode_confirmation, children: a(ne, { secondary: !0, icon: "mail", children: t("labels.passcode") }) }), a(te, { flowAction: e.actions.continue_to_password_login, children: a(ne, { secondary: !0, icon: "password", children: t("labels.password") }) }), a(te, { flowAction: e.actions.webauthn_generate_request_options, children: a(ne, { secondary: !0, icon: "passkey", children: t("labels.passkey") }) })] }), a($e, { children: a(G, { flowAction: e.actions.back, loadingSpinnerPosition: "right", children: t("labels.back") }) })] });
};
...
const vr = (n) => {
  ...
  }, value: i.email, placeholder: e("labels.email"), pattern: "^.*[^0-9]+$" }) : null, a(ne, { autofocus: !0, children: e("labels.continue") })] }), a(to, { hidden: !W, children: e("labels.or") })] }) : null, d.actions.thirdparty_oauth.enabled ? (t = d.actions.thirdparty_oauth.inputs.provider.allowed_values) === null || t === void 0 ? void 0 : t.map((w) => a(te, { flowAction: d.actions.thirdparty_oauth, onSubmit: (E) => ((I, M) => Xt(void 0, void 0, void 0, function* () {
  ...
  }))(E, w.value), children: a(ne, { isLoading: w.value == v, secondary: !0, icon: w.value.startsWith("custom_") ? "customProvider" : w.value, children: e("labels.signInWith", { provider: w.name }) }) }, w.value)) : null, d.actions.remember_me.enabled && a(b.Fragment, { children: [a(Sn, {}), a(no, { required: !1, type: "checkbox", label: e("labels.staySignedIn"), checked: S, onChange: (w) => Xt(void 0, void 0, void 0, function* () {
    w.preventDefault();
    const E = yield d.actions.remember_me.run({ remember_me: !S }, { dispatchAfterStateChangeEvent: !1 });
    x((I) => !I), E.dispatchAfterStateChangeEvent();
  }) })] })] }), a($e, { hidden: s !== "auth", children: a(K, { center: !0, children: [a("span", { children: e("labels.alreadyHaveAnAccount") }), a(G, { onClick: (w) => Xt(void 0, void 0, void 0, function* () {
...
const _r = (n) => {
  const { t } = (0, f.useContext)(J.TranslateContext), { flowState: e } = Ee(n.state), [o, i] = (0, f.useState)();
  return a(b.Fragment, { children: [a(ke, { children: [a(de, { children: t("headlines.registerPassword") }), a(Se, { state: e }), a(K, { children: t("texts.passwordFormatHint", { minLength: e.actions.register_password.inputs.new_password.min_length, maxLength: 72 }) }), a(te, { flowAction: e.actions.register_password, onSubmit: (r) => Lo(void 0, void 0, void 0, function* () {
    return r.preventDefault(), e.actions.register_password.run({ new_password: o });
  }), children: [a(Le, { type: "password", autocomplete: "new-password", flowInput: e.actions.register_password.inputs.new_password, placeholder: t("labels.newPassword"), onInput: (r) => Lo(void 0, void 0, void 0, function* () {
    r.target instanceof HTMLInputElement && i(r.target.value);
  }), autofocus: !0 }), a(ne, { children: t("labels.continue") })] })] }), a($e, { hidden: !e.actions.back.enabled && !e.actions.skip.enabled, children: [a(G, { loadingSpinnerPosition: "right", flowAction: e.actions.back, children: t("labels.back") }), a(G, { loadingSpinnerPosition: "left", flowAction: e.actions.skip, children: t("labels.skip") })] })] });
};
var hn = ee(597), Tt = {};
Tt.setAttributes = Qe(), Tt.insert = (n) => {
  window._hankoStyle = n;
}, Tt.domAPI = Ye(), Tt.insertStyleElement = Ge(), Je()(hn.A, Tt);
...
const yr = ({ checkedItemID: n, setCheckedItemID: t, flowState: e, onState: o }) => {
...
}, br = ({ onCredentialNameSubmit: n, oldName: t, onBack: e, credential: o, credentialType: i, flowState: r }) => {
  ...
  return a(b.Fragment, { children: [a(ke, { children: [a(de, { children: s(i === "security-key" ? "headlines.renameSecurityKey" : "headlines.renamePasskey") }), a(Se, { flowError: null }), a(K, { children: s(i === "security-key" ? "texts.renameSecurityKey" : "texts.renamePasskey") }), a(te, { flowAction: r.actions.webauthn_credential_rename, onSubmit: (c) => n(c, o.id, d), children: [a(Le, { type: "text", name: i, value: d, minLength: 3, maxLength: 32, required: !0, placeholder: s(i === "security-key" ? "labels.newSecurityKeyName" : "labels.newPasskeyName"), onInput: (c) => function(l, m, v, g) {
    return new (v || (v = Promise))(function(S, x) {
      function C(w) {
        try {
          W(g.next(w));
        } catch (E) {
      ...
      function W(w) {
        var E;
        w.done ? S(w.value) : (E = w.value, E instanceof v ? E : new v(function(I) {
          I(E);
        })).then(C, D);
      }
      W((g = g.apply(l, [])).next());
  ...
  }), autofocus: !0 }), a(ne, { children: s("labels.save") })] })] }), a($e, { children: a(G, { onClick: e, loadingSpinnerPosition: "right", children: s("labels.back") }) })] });
}, No = ({ credentials: n = [], checkedItemID: t, setCheckedItemID: e, onBack: o, onCredentialNameSubmit: i, allowCredentialDeletion: r, credentialType: s, onCredentialDelete: d, flowState: u }) => {
  const { t: c } = (0, f.useContext)(J.TranslateContext), { setPage: l } = (0, f.useContext)(Ue), m = (g) => {
    if (g.name) return g.name;
    const S = g.public_key.replace(/[\W_]/g, "");
    return `${s === "security-key" ? "SecurityKey" : "Passkey"}-${S.substring(S.length - 7, S.length)}`;
  }, v = (g) => new Date(g).toLocaleString();
  return a(Kt, { name: s === "security-key" ? "security-key-edit-dropdown" : "passkey-edit-dropdown", columnSelector: (g) => m(g), data: n, contentSelector: (g) => a(b.Fragment, { children: [a(K, { children: [a(De, { children: c(s === "security-key" ? "headlines.renameSecurityKey" : "headlines.renamePasskey") }), c(s === "security-key" ? "texts.renameSecurityKey" : "texts.renamePasskey"), a("br", {}), a(G, { onClick: (S) => ((x, C, D) => {
    x.preventDefault(), l(a(br, { oldName: m(C), credential: C, credentialType: D, onBack: o, onCredentialNameSubmit: i, flowState: u }));
  })(S, g, s), loadingSpinnerPosition: "right", children: c("labels.rename") })] }), a(K, { hidden: !r, children: [a(De, { children: c(s === "security-key" ? "headlines.deleteSecurityKey" : "headlines.deletePasskey") }), c(s === "security-key" ? "texts.deleteSecurityKey" : "texts.deletePasskey"), a("br", {}), a(G, { dangerous: !0, flowAction: u.actions.webauthn_credential_delete, onClick: (S) => d(S, g.id), loadingSpinnerPosition: "right", children: c("labels.delete") })] }), a(K, { children: [a(De, { children: c("headlines.lastUsedAt") }), g.last_used_at ? v(g.last_used_at) : "-"] }), a(K, { children: [a(De, { children: c("headlines.createdAt") }), v(g.created_at)] })] }), checkedItemID: t, setCheckedItemID: e });
  ...
  return a(b.Fragment, { children: n ? a("div", { className: Oi.errorMessage, children: t(`flowErrors.${n == null ? void 0 : n.code}`) }) : null });
}, wr = ({ checkedItemID: n, setCheckedItemID: t, flowState: e, onState: o }) => {
  var i;
  const { t: r } = (0, f.useContext)(J.TranslateContext), { setUIState: s } = (0, f.useContext)(Ue), [d, u] = (0, f.useState)();
  return a(yt, { name: "email-create-dropdown", title: r("labels.addEmail"), checkedItemID: n, setCheckedItemID: t, children: [a(xn, { flowError: (i = e.actions.email_create.inputs.email) === null || i === void 0 ? void 0 : i.error }), a(te, { flowAction: e.actions.email_create, onSubmit: (c) => ((l, m) => function(v, g, S, x) {
    return new (S || (S = Promise))(function(C, D) {
      ...
      function E(I) {
        var M;
        I.done ? C(I.value) : (M = I.value, M instanceof S ? M : new S(function(z) {
          z(M);
        })).then(W, w);
      }
      E((x = x.apply(v, [])).next());
...
const kr = ({ checkedItemID: n, setCheckedItemID: t, onState: e, flowState: o }) => {
  var i, r, s;
  ...
  return a(yt, { name: "password-edit-dropdown", title: d(o.actions.password_create.enabled ? "labels.setPassword" : "labels.changePassword"), checkedItemID: n, setCheckedItemID: t, children: [a(K, { children: d("texts.passwordFormatHint", { minLength: (i = l.inputs.password.min_length) === null || i === void 0 ? void 0 : i.toString(10), maxLength: (r = l.inputs.password.max_length) === null || r === void 0 ? void 0 : r.toString(10) }) }), a(xn, { flowError: (s = o.actions.password_create.inputs.password) === null || s === void 0 ? void 0 : s.error }), a(te, { flowAction: l, onSubmit: (m) => ((v, g) => Mo(void 0, void 0, void 0, function* () {
    v.preventDefault();
    const S = yield l.run({ password: g }, { dispatchAfterStateChangeEvent: !1 });
    return e(S);
  ...
  }, value: u, flowInput: l.inputs.password }), a(ne, { children: d("labels.save") })] }), a(G, { dangerous: !0, flowAction: o.actions.password_delete, onClick: (m) => ((v) => Mo(void 0, void 0, void 0, function* () {
    v.preventDefault();
...
const Sr = ({ checkedItemID: n, setCheckedItemID: t, flowState: e, onState: o }) => {
  var i, r;
  ...
  return a(b.Fragment, { children: [a(ke, { children: [a(de, { children: e("headlines.deleteAccount") }), a(Se, { flowError: null }), a(K, { children: e("texts.deleteAccount") }), a(te, { flowAction: n.actions.account_delete, children: [a(no, { required: !0, type: "checkbox", label: e("labels.deleteAccount") }), a(ne, { children: e("labels.delete") })] })] }), a($e, { children: a(G, { onClick: t, children: e("labels.back") }) })] });
}, Cr = ({ checkedItemID: n, setCheckedItemID: t, flowState: e, onState: o }) => {
  ...
  return a(Kt, { name: "session-edit-dropdown", columnSelector: (s) => {
    ...
    var d, u, c;
    return a(b.Fragment, { children: [a(K, { hidden: !s.ip_address, children: [a(De, { children: i("headlines.ipAddress") }), s.ip_address] }), a(K, { children: [a(De, { children: i("headlines.lastUsed") }), r(s.last_used)] }), a(K, { children: [a(De, { children: i("headlines.createdAt") }), r(s.created_at)] }), !((c = (u = (d = e.actions.session_delete.inputs.session_id) === null || d === void 0 ? void 0 : d.allowed_values) === null || u === void 0 ? void 0 : u.map((l) => l.value)) === null || c === void 0) && c.includes(s.id) ? a(K, { children: [a(De, { children: i("headlines.revokeSession") }), a(G, { dangerous: !0, onClick: (l) => ((m, v) => function(g, S, x, C) {
...
const Ar = ({ checkedItemID: n, setCheckedItemID: t, flowState: e, onState: o }) => {
  var i, r, s, d;
...
const $i = (n) => {
  ...
  }), S = (C, D, W) => en(void 0, void 0, void 0, function* () {
    C.preventDefault();
    const w = yield l.actions.webauthn_credential_rename.run({ passkey_id: D, passkey_name: W }, { dispatchAfterStateChangeEvent: !1 });
    return g(w);
  }), x = (C) => (C.preventDefault(), c(a($i, { state: l, enablePasskeys: n.enablePasskeys })), Promise.resolve());
  return a(ke, { children: [a(Se, { state: ((t = l == null ? void 0 : l.error) === null || t === void 0 ? void 0 : t.code) !== "form_data_invalid_error" ? l : null }), l.actions.username_create.enabled || l.actions.username_update.enabled || l.actions.username_delete.enabled ? a(b.Fragment, { children: [a(de, { children: u("labels.username") }), l.payload.user.username ? a(K, { children: a("b", { children: l.payload.user.username.username }) }) : null, a(K, { children: l.actions.username_create.enabled || l.actions.username_update.enabled ? a(Sr, { onState: g, flowState: l, checkedItemID: m, setCheckedItemID: v }) : null })] }) : null, !((o = (e = l.payload) === null || e === void 0 ? void 0 : e.user) === null || o === void 0) && o.emails || l.actions.email_create.enabled ? a(b.Fragment, { children: [a(de, { children: u("headlines.profileEmails") }), a(K, { children: [a(yr, { flowState: l, onState: g, checkedItemID: m, setCheckedItemID: v }), l.actions.email_create.enabled ? a(wr, { flowState: l, onState: g, checkedItemID: m, setCheckedItemID: v }) : null] })] }) : null, l.actions.password_create.enabled || l.actions.password_update.enabled ? a(b.Fragment, { children: [a(de, { children: u("headlines.profilePassword") }), a(K, { children: a(kr, { flowState: l, onState: g, checkedItemID: m, setCheckedItemID: v }) })] }) : null, n.enablePasskeys && (!((r = (i = l.payload) === null || i === void 0 ? void 0 : i.user) === null || r === void 0) && r.passkeys || l.actions.webauthn_credential_create.enabled) ? a(b.Fragment, { children: [a(de, { children: u("headlines.profilePasskeys") }), a(K, { children: [a(No, { flowState: l, onBack: x, onCredentialNameSubmit: S, onCredentialDelete: (C, D) => en(void 0, void 0, void 0, function* () {
    C.preventDefault();
    const W = yield l.actions.webauthn_credential_delete.run({ passkey_id: D }, { dispatchAfterStateChangeEvent: !1 });
    return g(W);
  }), credentials: l.payload.user.passkeys, checkedItemID: m, setCheckedItemID: v, allowCredentialDeletion: !!l.actions.webauthn_credential_delete.enabled, credentialType: "passkey" }), l.actions.webauthn_credential_create.enabled ? a(Ro, { flowState: l, onState: g, credentialType: "passkey", checkedItemID: m, setCheckedItemID: v }) : null] })] }) : null, !((s = l.payload.user.mfa_config) === null || s === void 0) && s.security_keys_enabled ? a(b.Fragment, { children: [a(de, { children: u("headlines.securityKeys") }), a(K, { children: [a(No, { onBack: x, flowState: l, onCredentialNameSubmit: S, onCredentialDelete: (C, D) => en(void 0, void 0, void 0, function* () {
    C.preventDefault();
    const W = yield l.actions.security_key_delete.run({ security_key_id: D }, { dispatchAfterStateChangeEvent: !1 });
    return g(W);
  }), credentials: l.payload.user.security_keys, checkedItemID: m, setCheckedItemID: v, allowCredentialDeletion: !!l.actions.security_key_delete.enabled, credentialType: "security-key" }), l.actions.security_key_create.enabled ? a(Ro, { flowState: l, onState: g, credentialType: "security-key", checkedItemID: m, setCheckedItemID: v }) : null] })] }) : null, !((d = l.payload.user.mfa_config) === null || d === void 0) && d.totp_enabled ? a(b.Fragment, { children: [a(de, { children: u("headlines.authenticatorApp") }), a(K, { children: a(Ar, { onState: g, flowState: l, checkedItemID: m, setCheckedItemID: v }) })] }) : null, l.actions.connect_thirdparty_oauth_provider.enabled || l.actions.disconnect_thirdparty_oauth_provider.enabled ? a(b.Fragment, { children: [a(de, { children: u("headlines.connectedAccounts") }), a(Pr, { flowState: l, onState: g, checkedItemID: m, setCheckedItemID: v }), l.actions.connect_thirdparty_oauth_provider.enabled ? a(Er, { setCheckedItemID: v, flowState: l, onState: g, checkedItemID: m }) : null] }) : null, l.payload.sessions ? a(b.Fragment, { children: [a(de, { children: u("headlines.profileSessions") }), a(K, { children: a(Cr, { flowState: l, onState: g, checkedItemID: m, setCheckedItemID: v }) })] }) : null, l.actions.account_delete.enabled ? a(b.Fragment, { children: [a(Sn, {}), a(K, { children: a(to, {}) }), a(K, { children: a(te, { onSubmit: (C) => (C.preventDefault(), c(a(xr, { onBack: x, state: l })), Promise.resolve()), flowAction: l.actions.account_delete, children: a(ne, { dangerous: !0, children: u("headlines.deleteAccount") }) }) })] }) : null] });
}, Ir = $i, jo = ({ state: n, error: t }) => {
...
const Or = (n) => {
  const { t } = (0, f.useContext)(J.TranslateContext), { flowState: e } = Ee(n.state), [o, i] = (0, f.useState)();
  return a(b.Fragment, { children: [a(ke, { children: [a(de, { children: t("headlines.createEmail") }), a(Se, { state: e }), a(te, { onSubmit: (r) => Ho(void 0, void 0, void 0, function* () {
    return r.preventDefault(), e.actions.email_address_set.run({ email: o });
  }), flowAction: e.actions.email_address_set, children: [a(Le, { type: "email", autoComplete: "email", autoCorrect: "off", flowInput: e.actions.email_address_set.inputs.email, onInput: (r) => Ho(void 0, void 0, void 0, function* () {
    r.target instanceof HTMLInputElement && i(r.target.value);
  }), placeholder: t("labels.email"), pattern: "^.*[^0-9]+$", value: o }), a(ne, { children: t("labels.continue") })] })] }), a($e, { hidden: !e.actions.skip.enabled, children: [a("span", { hidden: !0 }), a(G, { flowAction: e.actions.skip, loadingSpinnerPosition: "left", children: t("labels.skip") })] })] });
};
...
const $r = (n) => {
  const { t } = (0, f.useContext)(J.TranslateContext), { flowState: e } = Ee(n.state), [o, i] = (0, f.useState)();
  return a(b.Fragment, { children: [a(ke, { children: [a(de, { children: t("headlines.createUsername") }), a(Se, { state: e }), a(te, { flowAction: e.actions.username_create, onSubmit: (r) => Fo(void 0, void 0, void 0, function* () {
    return r.preventDefault(), e.actions.username_create.run({ username: o });
  }), children: [a(Le, { type: "text", autoComplete: "username", autoCorrect: "off", flowInput: e.actions.username_create.inputs.username, onInput: (r) => Fo(void 0, void 0, void 0, function* () {
    r.target instanceof HTMLInputElement && i(r.target.value);
  }), value: o, placeholder: t("labels.username") }), a(ne, { children: t("labels.continue") })] })] }), a($e, { hidden: !e.actions.skip.enabled, children: [a("span", { hidden: !0 }), a(G, { flowAction: e.actions.skip, loadingSpinnerPosition: "left", children: t("labels.skip") })] })] });
}, Tr = (n) => {
  const { t } = (0, f.useContext)(J.TranslateContext), { flowState: e } = Ee(n.state);
  return a(b.Fragment, { children: [a(ke, { children: [a(de, { children: t("headlines.setupLoginMethod") }), a(Se, { flowError: e == null ? void 0 : e.error }), a(K, { children: t("texts.selectLoginMethodForFutureLogins") }), a(te, { flowAction: e.actions.continue_to_passkey_registration, children: a(ne, { secondary: !0, icon: "passkey", children: t("labels.passkey") }) }), a(te, { flowAction: e.actions.continue_to_password_registration, children: a(ne, { secondary: !0, icon: "password", children: t("labels.password") }) })] }), a($e, { hidden: !e.actions.back.enabled && !e.actions.skip.enabled, children: [a(G, { loadingSpinnerPosition: "right", flowAction: e.actions.back, children: t("labels.back") }), a(G, { loadingSpinnerPosition: "left", flowAction: e.actions.skip, children: t("labels.skip") })] })] });
};
...
const Dr = (n) => {
  const { t } = (0, f.useContext)(J.TranslateContext), { flowState: e } = Ee(n.state), [o, i] = (0, f.useState)([]), r = (0, f.useCallback)((s) => Wo(void 0, void 0, void 0, function* () {
    return e.actions.otp_code_validate.run({ otp_code: s });
  }), [e]);
  return (0, f.useEffect)(() => {
    i([]);
  }, [e]), a(b.Fragment, { children: [a(ke, { children: [a(de, { children: t("headlines.otpLogin") }), a(Se, { state: e }), a(K, { children: t("texts.otpLogin") }), a(te, { flowAction: e.actions.otp_code_validate, onSubmit: (s) => Wo(void 0, void 0, void 0, function* () {
    return s.preventDefault(), r(o.join(""));
  }), children: [a(oo, { onInput: (s) => {
    if (i(s), s.filter((d) => d !== "").length === 6) return r(s.join(""));
  }, passcodeDigits: o, numberOfInputs: 6 }), a(ne, { children: t("labels.continue") })] })] }), a($e, { hidden: !e.actions.continue_to_login_security_key.enabled, children: a(G, { loadingSpinnerPosition: "right", flowAction: e.actions.continue_to_login_security_key, children: t("labels.useAnotherMethod") }) })] });
}, Ur = (n) => {
  const { t } = (0, f.useContext)(J.TranslateContext), { flowState: e } = Ee(n.state);
  return a(b.Fragment, { children: [a(ke, { children: [a(de, { children: t("headlines.securityKeyLogin") }), a(Se, { state: e }), a(K, { children: t("texts.securityKeyLogin") }), a(te, { flowAction: e.actions.webauthn_generate_request_options, children: a(ne, { autofocus: !0, icon: "securityKey", children: t("labels.securityKeyUse") }) })] }), a($e, { hidden: !e.actions.continue_to_login_otp.enabled, children: a(G, { loadingSpinnerPosition: "right", flowAction: e.actions.continue_to_login_otp, children: t("labels.useAnotherMethod") }) })] });
}, Lr = (n) => {
  ...
  return a(b.Fragment, { children: [a(ke, { children: [a(de, { children: t("headlines.mfaSetUp") }), a(Se, { flowError: e == null ? void 0 : e.error }), a(K, { children: t("texts.mfaSetUp") }), o ? a(te, { flowAction: o, children: a(ne, { children: t("labels.continue") }) }) : a(b.Fragment, { children: [a(te, { flowAction: e.actions.continue_to_security_key_creation, children: a(ne, { secondary: !0, icon: "securityKey", children: t("labels.securityKey") }) }), a(te, { flowAction: e.actions.continue_to_otp_secret_creation, children: a(ne, { secondary: !0, icon: "qrCodeScanner", children: t("labels.authenticatorApp") }) })] })] }), a($e, { children: [a(G, { loadingSpinnerPosition: "right", flowAction: e.actions.back, children: t("labels.back") }), a(G, { loadingSpinnerPosition: "left", flowAction: e.actions.skip, children: t("labels.skip") })] })] });
};
var pn = ee(8), Dt = {};
Dt.setAttributes = Qe(), Dt.insert = (n) => {
  window._hankoStyle = n;
}, Dt.domAPI = Ye(), Dt.insertStyleElement = Ge(), Je()(pn.A, Dt);
const Nr = pn.A && pn.A.locals ? pn.A.locals : void 0, Mr = ({ children: n, text: t }) => {
  ...
  const { t: e } = (0, f.useContext)(J.TranslateContext);
  return a("div", { className: Nr.otpCreationDetails, children: [a("img", { alt: "QR-Code", src: n }), a(Sn, {}), a(Mr, { text: t, children: e("texts.otpSecretKey") }), a("div", { children: t })] });
};
...
const zr = (n) => {
  const { t } = (0, f.useContext)(J.TranslateContext), { flowState: e } = Ee(n.state), [o, i] = (0, f.useState)([]), r = (0, f.useCallback)((s) => Ko(void 0, void 0, void 0, function* () {
    return e.actions.otp_code_verify.run({ otp_code: s });
  }), [e]);
  return (0, f.useEffect)(() => {
    var s;
    ((s = e.error) === null || s === void 0 ? void 0 : s.code) === "passcode_invalid" && i([]);
  }, [e]), a(b.Fragment, { children: [a(ke, { children: [a(de, { children: t("headlines.otpSetUp") }), a(Se, { state: e }), a(K, { children: t("texts.otpScanQRCode") }), a(Rr, { src: e.payload.otp_image_source, secret: e.payload.otp_secret }), a(K, { children: t("texts.otpEnterVerificationCode") }), a(te, { flowAction: e.actions.otp_code_verify, onSubmit: (s) => Ko(void 0, void 0, void 0, function* () {
    return s.preventDefault(), r(o.join(""));
  }), children: [a(oo, { onInput: (s) => {
    if (i(s), s.filter((d) => d !== "").length === 6) return r(s.join(""));
  }, passcodeDigits: o, numberOfInputs: 6 }), a(ne, { children: t("labels.continue") })] })] }), a($e, { children: a(G, { flowAction: e.actions.back, loadingSpinnerPosition: "right", children: t("labels.back") }) })] });
}, qr = (n) => {
  const { t } = (0, f.useContext)(J.TranslateContext), { flowState: e } = Ee(n.state);
  return a(b.Fragment, { children: [a(ke, { children: [a(de, { children: t("headlines.securityKeySetUp") }), a(Se, { state: e }), a(K, { children: t("texts.securityKeySetUp") }), a(te, { flowAction: e.actions.webauthn_generate_creation_options, children: a(ne, { autofocus: !0, icon: "securityKey", children: t("labels.createSecurityKey") }) })] }), a($e, { hidden: !e.actions.back.enabled, children: a(G, { loadingSpinnerPosition: "right", flowAction: e.actions.back, children: t("labels.back") }) })] });
}, jr = (n) => {
  const { t } = (0, f.useContext)(J.TranslateContext), { flowState: e } = Ee(n.state);
  return a(b.Fragment, { children: [a(ke, { children: [a(de, { children: t("headlines.trustDevice") }), a(Se, { flowError: e == null ? void 0 : e.error }), a(K, { children: t("texts.trustDevice") }), a(te, { flowAction: e.actions.trust_device, children: a(ne, { children: t("labels.trustDevice") }) })] }), a($e, { children: [a(G, { flowAction: e.actions.back, loadingSpinnerPosition: "right", children: t("labels.back") }), a(G, { flowAction: e.actions.skip, loadingSpinnerPosition: "left", children: t("labels.skip") })] })] });
};
...
const Ue = (0, b.createContext)(null), Hr = (n) => {
  ...
  (0, f.useMemo)(() => c.onBeforeStateChange(({ state: j }) => {
  ...
  }, [o, i]), (0, f.useEffect)(() => c.onAfterStateChange((j) => Vo(void 0, [j], void 0, function* ({ state: q }) {
    var Ce;
    if (Ne(q)) switch (["onboarding_verify_passkey_attestation", "webauthn_credential_verification", "login_passkey", "thirdparty"].includes(q.name) || re((se) => Object.assign(Object.assign({}, se), { isDisabled: !1 })), q.name) {
      case "login_init":
        N(a(dr, { state: q })), q.passkeyAutofillActivation();
        break;
      ...
      case "password_creation":
        ...
        break;
      case "success":
        !((Ce = q.payload) === null || Ce === void 0) && Ce.last_login && localStorage.setItem(C, JSON.stringify(q.payload.last_login)), q.autoStep();
        break;
      case "profile_init":
        N(a(Ir, { state: q, enablePasskeys: r.enablePasskeys }));
        break;
      case "error":
        N(a(jo, { state: q }));
        break;
  ...
  const it = (0, f.useCallback)((j) => Vo(void 0, void 0, void 0, function* () {
    ...
    if (new URLSearchParams(window.location.search).get("saml_hint") === "idp_initiated") E("token_exchange"), yield c.createState("token_exchange", Object.assign(Object.assign({}, Ce), { dispatchAfterStateChangeEvent: !0 }));
      ...
      const se = yield c.createState(j, Ce);
  ...
  const O = Ue.Provider, U = J.TranslateProvider, Z = Wa;
  return a(O, { value: { init: A, initialComponentName: u.componentName, setUIState: re, uiState: le, hanko: c, setHanko: fe, lang: (e == null ? void 0 : e.toString()) || S, prefilledEmail: o, prefilledUsername: i, componentName: D, setComponentName: W, hidePasskeyButtonOnLogin: m, page: X, setPage: N, lastLogin: _e, isOwnFlow: Ne }, children: a(U, { translations: v, fallbackLang: S, root: g, children: a(Z, { ref: x, children: D !== "events" ? a(b.Fragment, { children: [l ? a("style", { nonce: d || void 0, dangerouslySetInnerHTML: { __html: window._hankoStyle.innerHTML } }) : null, X] }) : null }) }) });
}, Fr = { en: ee(6).en };
...
const Be = {}, Vt = (n, t) => {
  ...
  return a(Hr, Object.assign({ componentName: n, globalOptions: Be, createWebauthnAbortSignal: Jr }, t, { nonce: o }));
}, Wr = (n) => Vt("auth", n), Kr = (n) => Vt("login", n), Vr = (n) => Vt("registration", n), Br = (n) => Vt("profile", n), Zr = (n) => Vt("events", n);
let tn = new AbortController();
const Jr = () => (tn && tn.abort(), tn = new AbortController(), tn.signal), Ut = (n) => Ti(void 0, [n], void 0, function* ({ tagName: t, entryComponent: e, shadow: o = !0, observedAttributes: i }) {
  customElements.get(t) || function(r, s, d, u) {
    ...
    (c.prototype = Object.create(HTMLElement.prototype)).constructor = c, c.prototype.connectedCallback = pa, c.prototype.attributeChangedCallback = ma, c.prototype.disconnectedCallback = fa, d = d || r.observedAttributes || Object.keys(r.propTypes || {}), c.observedAttributes = d, d.forEach(function(l) {
      Object.defineProperty(c.prototype, l, { get: function() {
        var m, v, g, S;
        return (m = (v = this._vdom) == null || (g = v.props) == null ? void 0 : g[l]) != null ? m : (S = this._props) == null ? void 0 : S[l];
      }, set: function(m) {
...
}), Di = (n, ...t) => Ti(void 0, [n, ...t], void 0, function* (e, o = {}) {
  const i = ["api", "lang", "prefilled-email", "entry", "mode"];
  return o = Object.assign({ shadow: !0, injectStyles: !0, enablePasskeys: !0, hidePasskeyButtonOnLogin: !1, translations: null, translationsLocation: "/i18n", fallbackLanguage: "en", storageKey: "hanko", sessionCheckInterval: 3e4 }, o), Be.hanko = new Pi(e, { cookieName: o.storageKey, cookieDomain: o.cookieDomain, cookieSameSite: o.cookieSameSite, localStorageKey: o.storageKey, sessionCheckInterval: o.sessionCheckInterval, sessionTokenLocation: o.sessionTokenLocation }), Be.injectStyles = o.injectStyles, Be.enablePasskeys = o.enablePasskeys, Be.hidePasskeyButtonOnLogin = o.hidePasskeyButtonOnLogin, Be.translations = o.translations || Fr, Be.translationsLocation = o.translationsLocation, Be.fallbackLanguage = o.fallbackLanguage, Be.storageKey = o.storageKey, yield Promise.all([Ut(Object.assign(Object.assign({}, o), { tagName: "hanko-auth", entryComponent: Wr, observedAttributes: i })), Ut(Object.assign(Object.assign({}, o), { tagName: "hanko-login", entryComponent: Kr, observedAttributes: i })), Ut(Object.assign(Object.assign({}, o), { tagName: "hanko-registration", entryComponent: Vr, observedAttributes: i })), Ut(Object.assign(Object.assign({}, o), { tagName: "hanko-profile", entryComponent: Br, observedAttributes: i.filter((r) => ["api", "lang"].includes(r)) })), Ut(Object.assign(Object.assign({}, o), { tagName: "hanko-events", entryComponent: Zr, observedAttributes: [] }))]), { hanko: Be.hanko };
}), Yr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  Action: Ht,
  Client: Qn,
  CustomEventWithDetail: gi,
  Hanko: Pi,
  HankoError: ut,
  HttpClient: Yn,
  Relay: yi,
  ...
  getStoredCodeVerifier: Ci,
  register: Di,
  sessionCreatedType: Vn,
  sessionExpiredType: Bn,
  setStoredCodeVerifier: kn,
  userDeletedType: Jn,
  userLoggedOutType: Zn
}, Symbol.toStringTag, { value: "Module" })), Qr = Ni`
  :host {
    display: block;
...
}, o: (n, t) => Object.prototype.hasOwnProperty.call(n, t) }, Ui = {};
qn.d(Ui, { en: () => Gr });
const Gr = { headlines: { error: "An error has occurred", loginEmail: "Sign in or create account", loginEmailNoSignup: "Sign in", loginFinished: "Login successful", loginPasscode: "Enter passcode", loginPassword: "Enter password", registerAuthenticator: "Create a passkey", registerConfirm: "Create account?", registerPassword: "Set new password", otpSetUp: "Set up authenticator app", profileEmails: "Emails", profilePassword: "Password", profilePasskeys: "Passkeys", isPrimaryEmail: "Primary email address", setPrimaryEmail: "Set primary email address", createEmail: "Enter a new email", createUsername: "Enter a new username", emailVerified: "Verified", emailUnverified: "Unverified", emailDelete: "Delete", renamePasskey: "Rename passkey", deletePasskey: "Delete passkey", lastUsedAt: "Last used at", createdAt: "Created at", connectedAccounts: "Connected accounts", deleteAccount: "Delete account", accountNotFound: "Account not found", signIn: "Sign in", signUp: "Create account", selectLoginMethod: "Select login method", setupLoginMethod: "Set up login method", lastUsed: "Last seen", ipAddress: "IP address", revokeSession: "Revoke session", profileSessions: "Sessions", mfaSetUp: "Set up MFA", securityKeySetUp: "Add security key", securityKeyLogin: "Security key", otpLogin: "Authentication code", renameSecurityKey: "Rename security key", deleteSecurityKey: "Delete security key", securityKeys: "Security keys", authenticatorApp: "Authenticator app", authenticatorAppAlreadySetUp: "Authenticator app is set up", authenticatorAppNotSetUp: "Set up authenticator app", trustDevice: "Trust this browser?", deleteIdentity: "Delete connection" }, texts: { enterPasscode: "Enter the passcode sent to your email address.", enterPasscodeNoEmail: "Enter the passcode that was sent to your primary email address.", setupPasskey: "Sign in to your account easily and securely with a passkey. Note: Your biometric data is only stored on your devices and will never be shared with anyone.", createAccount: 'No account exists for "{emailAddress}". Do you want to create a new account?', otpEnterVerificationCode: "Enter the one-time password (OTP) obtained from your authenticator app below:", otpScanQRCode: "Scan the QR code using your authenticator app (such as Google Authenticator or any other TOTP app). Alternatively, you can manually enter the OTP secret key into the app.", otpSecretKey: "OTP secret key", passwordFormatHint: "Must be between {minLength} and {maxLength} characters long.", securityKeySetUp: "Use a dedicated security key via USB, Bluetooth, or NFC, or your mobile phone. Connect or activate your security key, then click the button below and follow the prompts to complete the registration.", setPrimaryEmail: "Set this email address to be used for contacting you.", isPrimaryEmail: "This email address will be used to contact you if necessary.", emailVerified: "This email address has been verified.", emailUnverified: "This email address has not been verified.", emailDelete: "If you delete this email address, it can no longer be used to sign in.", renamePasskey: "Set a name for the passkey.", deletePasskey: "Delete this passkey from your account.", deleteAccount: "Are you sure you want to delete this account? All data will be deleted immediately and cannot be recovered.", noAccountExists: 'No account exists for "{emailAddress}".', selectLoginMethodForFutureLogins: "Select one of the following login methods to use for future logins.", howDoYouWantToLogin: "How do you want to login?", mfaSetUp: "Protect your account with Multi-Factor Authentication (MFA). MFA adds an additional step to your login process, ensuring that even if your password or email account is compromised, your account stays secure.", securityKeyLogin: "Connect or activate your security key, then click the button below. Once ready, use it via USB, NFC, your mobile phone. Follow the prompts to complete the login process.", otpLogin: "Open your authenticator app to obtain the one-time password (OTP). Enter the code in the field below to complete your login.", renameSecurityKey: "Set a name for the security key.", deleteSecurityKey: "Delete this security key from your account.", authenticatorAppAlreadySetUp: "Your account is secured with an authenticator app that generates time-based one-time passwords (TOTP) for multi-factor authentication.", authenticatorAppNotSetUp: "Secure your account with an authenticator app that generates time-based one-time passwords (TOTP) for multi-factor authentication.", trustDevice: "If you trust this browser, you won’t need to enter your OTP (One-Time-Password) or use your security key for multi-factor authentication (MFA) the next time you log in." }, labels: { or: "or", no: "no", yes: "yes", email: "Email", continue: "Continue", copied: "copied", skip: "Skip", save: "Save", password: "Password", passkey: "Passkey", passcode: "Passcode", signInPassword: "Sign in with a password", signInPasscode: "Sign in with a passcode", forgotYourPassword: "Forgot your password?", back: "Back", signInPasskey: "Sign in with a passkey", registerAuthenticator: "Create a passkey", signIn: "Sign in", signUp: "Create account", sendNewPasscode: "Send new code", passwordRetryAfter: "Retry in {passwordRetryAfter}", passcodeResendAfter: "Request a new code in {passcodeResendAfter}", unverifiedEmail: "unverified", primaryEmail: "primary", setAsPrimaryEmail: "Set as primary", verify: "Verify", delete: "Delete", newEmailAddress: "New email address", newPassword: "New password", rename: "Rename", newPasskeyName: "New passkey name", addEmail: "Add email", createPasskey: "Create a passkey", webauthnUnsupported: "Passkeys are not supported by your browser", signInWith: "Continue with {provider}", deleteAccount: "Yes, delete this account.", emailOrUsername: "Email or username", username: "Username", optional: "optional", dontHaveAnAccount: "Don't have an account?", alreadyHaveAnAccount: "Already have an account?", changeUsername: "Change username", setUsername: "Set username", changePassword: "Change password", setPassword: "Set password", revoke: "Revoke", currentSession: "Current session", authenticatorApp: "Authenticator app", securityKey: "Security key", securityKeyUse: "Use security key", newSecurityKeyName: "New security key name", createSecurityKey: "Add a security key", authenticatorAppManage: "Manage authenticator app", authenticatorAppAdd: "Set up", configured: "configured", useAnotherMethod: "Use another method", lastUsed: "Last used", trustDevice: "Trust this browser", staySignedIn: "Stay signed in", connectAccount: "Connect account" }, errors: { somethingWentWrong: "A technical error has occurred. Please try again later.", requestTimeout: "The request timed out.", invalidPassword: "Wrong email or password.", invalidPasscode: "The passcode provided was not correct.", passcodeAttemptsReached: "The passcode was entered incorrectly too many times. Please request a new code.", tooManyRequests: "Too many requests have been made. Please wait to repeat the requested operation.", unauthorized: "Your session has expired. Please log in again.", invalidWebauthnCredential: "This passkey cannot be used anymore.", passcodeExpired: "The passcode has expired. Please request a new one.", userVerification: "User verification required. Please ensure your authenticator device is protected with a PIN or biometric.", emailAddressAlreadyExistsError: "The email address already exists.", maxNumOfEmailAddressesReached: "No further email addresses can be added.", thirdPartyAccessDenied: "Access denied. The request was cancelled by the user or the provider has denied access for other reasons.", thirdPartyMultipleAccounts: "Cannot identify account. The email address is used by multiple accounts.", thirdPartyUnverifiedEmail: "Email verification required. Please verify the used email address with your provider.", signupDisabled: "Account registration is disabled.", handlerNotFoundError: "The current step in your process is not supported by this application version. Please try again later or contact support if the issue persists." }, flowErrors: { technical_error: "A technical error has occurred. Please try again later.", flow_expired_error: "The session has expired, please click the button to restart.", value_invalid_error: "The entered value is invalid.", passcode_invalid: "The passcode provided was not correct.", passkey_invalid: "This passkey cannot be used anymore.", passcode_max_attempts_reached: "The passcode was entered incorrectly too many times. Please request a new code.", rate_limit_exceeded: "Too many requests have been made. Please wait to repeat the requested operation.", unknown_username_error: "The username is unknown.", unknown_email_error: "The email address is unknown.", username_already_exists: "The username is already taken.", invalid_username_error: "The username must contain only letters, numbers, and underscores.", email_already_exists: "The email is already taken.", not_found: "The requested resource was not found.", operation_not_permitted_error: "The operation is not permitted.", flow_discontinuity_error: "The process cannot be continued due to user settings or the provider's configuration.", form_data_invalid_error: "The submitted form data contains errors.", unauthorized: "Your session has expired. Please log in again.", value_missing_error: "The value is missing.", value_too_long_error: "Value is too long.", value_too_short_error: "The value is too short.", webauthn_credential_invalid_mfa_only: "This credential can be used as a second factor security key only.", webauthn_credential_already_exists: "The request either timed out, was canceled or the device is already registered. Please try again or try using another device.", platform_authenticator_required: "Your account is configured to use platform authenticators, but your current device or browser does not support this feature. Please try again with a compatible device or browser.", third_party_access_denied: "Access denied. The request was cancelled by the user or the provider has denied access for other reasons." } }, Xr = Ui.en, es = {
  headlines: {
...
}, Bo = "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='16'%20height='16'%20fill='currentColor'%20class='bi%20bi-person-vcard'%20viewBox='0%200%2016%2016'%3e%3cpath%20d='M5%208a2%202%200%201%200%200-4%202%202%200%200%200%200%204m4-2.5a.5.5%200%200%201%20.5-.5h4a.5.5%200%200%201%200%201h-4a.5.5%200%200%201-.5-.5M9%208a.5.5%200%200%201%20.5-.5h4a.5.5%200%200%201%200%201h-4A.5.5%200%200%201%209%208m1%202.5a.5.5%200%200%201%20.5-.5h3a.5.5%200%200%201%200%201h-3a.5.5%200%200%201-.5-.5'/%3e%3cpath%20d='M2%202a2%202%200%200%200-2%202v8a2%202%200%200%200%202%202h12a2%202%200%200%200%202-2V4a2%202%200%200%200-2-2zM1%204a1%201%200%200%201%201-1h12a1%201%200%200%201%201%201v8a1%201%200%200%201-1%201H8.96q.04-.245.04-.5C9%2010.567%207.21%209%205%209c-2.086%200-3.8%201.398-3.984%203.181A1%201%200%200%201%201%2012z'/%3e%3c/svg%3e", Zo = "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='16'%20height='16'%20fill='currentColor'%20class='bi%20bi-box-arrow-right'%20viewBox='0%200%2016%2016'%3e%3cpath%20fill-rule='evenodd'%20d='M10%2012.5a.5.5%200%200%201-.5.5h-8a.5.5%200%200%201-.5-.5v-9a.5.5%200%200%201%20.5-.5h8a.5.5%200%200%201%20.5.5v2a.5.5%200%200%200%201%200v-2A1.5%201.5%200%200%200%209.5%202h-8A1.5%201.5%200%200%200%200%203.5v9A1.5%201.5%200%200%200%201.5%2014h8a1.5%201.5%200%200%200%201.5-1.5v-2a.5.5%200%200%200-1%200z'/%3e%3cpath%20fill-rule='evenodd'%20d='M15.854%208.354a.5.5%200%200%200%200-.708l-3-3a.5.5%200%200%200-.708.708L14.293%207.5H5.5a.5.5%200%200%200%200%201h8.793l-2.147%202.146a.5.5%200%200%200%20.708.708z'/%3e%3c/svg%3e", Jo = "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='16'%20height='16'%20fill='currentColor'%20class='bi%20bi-map'%20viewBox='0%200%2016%2016'%3e%3cpath%20fill-rule='evenodd'%20d='M15.817.113A.5.5%200%200%201%2016%20.5v14a.5.5%200%200%201-.402.49l-5%201a.5.5%200%200%201-.196%200L5.5%2015.01l-4.902.98A.5.5%200%200%201%200%2015.5v-14a.5.5%200%200%201%20.402-.49l5-1a.5.5%200%200%201%20.196%200L10.5.99l4.902-.98a.5.5%200%200%201%20.415.103M10%201.91l-4-.8v12.98l4%20.8zm1%2012.98%204-.8V1.11l-4%20.8zm-6-.8V1.11l-4%20.8v12.98z'/%3e%3c/svg%3e", Yo = "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='16'%20height='16'%20fill='currentColor'%20class='bi%20bi-person-check'%20viewBox='0%200%2016%2016'%3e%3cpath%20d='M12.5%2016a3.5%203.5%200%201%200%200-7%203.5%203.5%200%200%200%200%207m1.679-4.493-1.335%202.226a.75.75%200%200%201-1.174.144l-.774-.773a.5.5%200%200%201%20.708-.708l.547.548%201.17-1.951a.5.5%200%201%201%20.858.514M11%205a3%203%200%201%201-6%200%203%203%200%200%201%206%200M8%207a2%202%200%201%200%200-4%202%202%200%200%200%200%204'/%3e%3cpath%20d='M8.256%2014a4.5%204.5%200%200%201-.229-1.004H3c.001-.246.154-.986.832-1.664C4.484%2010.68%205.711%2010%208%2010q.39%200%20.74.025c.226-.341.496-.65.804-.918Q8.844%209.002%208%209c-5%200-6%203-6%204s1%201%201%201z'/%3e%3c/svg%3e", os = "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='16'%20height='16'%20fill='currentColor'%20class='bi%20bi-chevron-down'%20viewBox='0%200%2016%2016'%3e%3cpath%20fill-rule='evenodd'%20d='M1.646%204.646a.5.5%200%200%201%20.708%200L8%2010.293l5.646-5.647a.5.5%200%200%201%20.708.708l-6%206a.5.5%200%200%201-.708%200l-6-6a.5.5%200%200%201%200-.708'/%3e%3c/svg%3e", is = "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='16'%20height='16'%20fill='currentColor'%20class='bi%20bi-chevron-up'%20viewBox='0%200%2016%2016'%3e%3cpath%20fill-rule='evenodd'%20d='M7.646%204.646a.5.5%200%200%201%20.708%200l6%206a.5.5%200%200%201-.708.708L8%205.707l-5.646%205.647a.5.5%200%200%201-.708-.708z'/%3e%3c/svg%3e";
var as = Object.defineProperty, rs = Object.getOwnPropertyDescriptor, ae = (n, t, e, o) => {
  for (var i = o > 1 ? void 0 : o ? rs(t, e) : t, r = n.length - 1, s; r >= 0; r--)
    (s = n[r]) && (i = (o ? s(t, e, i) : s(i)) || i);
  return o && i && as(t, e, i), i;
};
let Qo = !1, Lt = null;
async function ss(n) {
  if (!Qo)
    return Lt || (Lt = (async () => {
      ...
      try {
        await Di(n, {
          ...
          translations: { en: Xr, es, fr: ts, pt: ns },
          fallbackLanguage: "en"
        }), Qo = !0, console.log("[hanko-auth] Hanko registration complete");
      } catch (t) {
...
}, Go = (n) => `hanko-verified-${n}`, Xo = (n) => `hanko-onboarding-${n}`;
let oe = class extends zt {
  ...
  constructor() {
    ...
    }, this._debugMode = !1, this._lastSessionId = null, this._hanko = null, this._isPrimary = !1, this._handleVisibilityChange = () => {
    ...
    return ve`
      <div class="dropdown-content ${this.isOpen ? "open" : ""}">
        <button data-action="profile" @click=${this.handleDropdownSelect}>
          <img src="${Bo}" class="icon" alt="Account icon" />
          ${this.t("myHotAccount")}
        </button>
        ${this.osmRequired ? this.osmConnected ? ve`
                <button class="osm-connected" disabled>
                  <img src="${Yo}" alt="Check icon" class="icon" />
              ...
              ` : ve`
                ...
                >
                  <img src="${Jo}" alt="Check icon" class="icon" />
                  ${this.t("connectToOsm")}
                </button>
              ` : ""}
        <button data-action="logout" @click=${this.handleDropdownSelect}>
          <img src="${Zo}" alt="Log out icon" class="icon" />
          ${this.t("logOut")}
        </button>
      </div>
    `;
  ...
  async init() {
    ...
    try {
      ...
      ), this.log("Current lang prop:", this.lang), await ss(this.hankoUrl), this.hankoReady = !0, this._broadcastState();
      const { Hanko: n } = await Promise.resolve().then(() => Yr), t = window.location.hostname, e = t === "localhost" || t === "127.0.0.1", o = t.split("."), i = o.length >= 2 ? `.${o.slice(-2).join(".")}` : t, r = e ? {} : {
        cookieDomain: i,
        cookieName: "hanko",
        cookieSameSite: "lax"
      };
    ...
    try {
      ...
      try {
        ...
        if (r.ok) {
          ...
          if (this.user) {
            const d = Go(window.location.hostname), u = sessionStorage.getItem(d);
  ...
  async checkAppMapping() {
    if (!this.mappingCheckUrl || !this.user)
      return !0;
    const n = Xo(window.location.hostname);
  ...
  setupEventListeners() {
    this.updateComplete.then(() => {
      ...
      n && (this._currentHankoAuthElement = n, this.log("Attaching event listeners to hanko-auth element"), n.addEventListener("onSessionCreated", (e) => {
        var i, r;
      ...
      if (this.showProfile)
        return this.hankoReady ? ve`
          ...
          >
            ${ca(
          this.lang,
          ve`<hanko-auth lang="${this.lang}"></hanko-auth>`
        )}
          </div>
        ` : (this.log(
