 ...
 */
const rn = globalThis, Gn = rn.ShadowRoot && (rn.ShadyCSS === void 0 || rn.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Xn = Symbol(), So = /* @__PURE__ */ new WeakMap();
let ui = class {
  constructor(e, t, o) {
...
const Ki = (n) => new ui(typeof n == "string" ? n : n + "", void 0, Xn), Vi = (n, ...e) => {
  const t = n.length === 1 ? n[0] : e.reduce((o, i, r) => o + ((s) => {
  ...
  if (Gn) n.adoptedStyleSheets = e.map((t) => t instanceof CSSStyleSheet ? t : t.styleSheet);
    ...
    const o = document.createElement("style"), i = rn.litNonce;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Zi, defineProperty: Ji, getOwnPropertyDescriptor: Yi, getOwnPropertyNames: Qi, getOwnPropertySymbols: Gi, getPrototypeOf: Xi } = Object, st = globalThis, Ao = st.trustedTypes, er = Ao ? Ao.emptyScript : "", Dn = st.reactiveElementPolyfillSupport, Tt = (n, e) => n, fn = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? er : null;
      break;
...
let pt = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, t, o) {
    const { get: i, set: r } = Yi(this.prototype, e) ?? { get() {
      return this[t];
    }, set(s) {
      this[t] = s;
    } };
    return { get: i, set(s) {
      ...
      r == null || r.call(this, s), this.requestUpdate(e, c, o);
  ...
  _$ET(e, t) {
    ...
    if (i !== void 0 && o.reflect === !0) {
      const s = (((r = o.converter) == null ? void 0 : r.toAttribute) !== void 0 ? o.converter : fn).toAttribute(t, o.type);
  ...
  _$AK(e, t) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      const c = o.getPropertyOptions(i), d = typeof c.converter == "function" ? { fromAttribute: c.converter } : ((r = c.converter) == null ? void 0 : r.fromAttribute) !== void 0 ? c.converter : fn;
      this._$Em = i;
  ...
  requestUpdate(e, t, o, i = !1, r) {
    ...
    if (e !== void 0) {
      ...
      if (i === !1 && (r = this[e]), o ?? (o = c.getPropertyOptions(e)), !((o.hasChanged ?? eo)(r, t) || o.useDefault && o.reflect && r === ((s = this._$Ej) == null ? void 0 : s.get(e)) && !this.hasAttribute(c._$Eu(e, o)))) return;
      this.C(e, t, o);
    }
    this.isUpdatePending === !1 && (this._$ES = this._$EP());
  }
  C(e, t, { useDefault: o, reflect: i, wrapped: r }, s) {
    o && !(this._$Ej ?? (this._$Ej = /* @__PURE__ */ new Map())).has(e) && (this._$Ej.set(e, s ?? t ?? this[e]), r !== !0 || s !== void 0) || (this._$AL.has(e) || (this.hasUpdated || o || (t = void 0), this._$AL.set(e, t)), i === !0 && this._$Em !== e && (this._$Eq ?? (this._$Eq = /* @__PURE__ */ new Set())).add(e));
  }
  async _$EP() {
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (i.size > 0) for (const [r, s] of i) {
        const { wrapped: c } = s, d = this[r];
        c !== !0 || this._$AL.has(r) || d === void 0 || this.C(r, void 0, s, d);
      }
    }
    let e = !1;
    const t = this._$AL;
...
pt.elementStyles = [], pt.shadowRootOptions = { mode: "open" }, pt[Tt("elementProperties")] = /* @__PURE__ */ new Map(), pt[Tt("finalized")] = /* @__PURE__ */ new Map(), Dn == null || Dn({ ReactiveElement: pt }), (st.reactiveElementVersions ?? (st.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Nt = globalThis, Po = (n) => n, vn = Nt.trustedTypes, Oo = vn ? vn.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, hi = "$lit$", at = `lit$${Math.random().toFixed(9).slice(2)}$`, pi = "?" + at, tr = `<${pi}>`, ht = document, Rt = () => ht.createComment(""), qt = (n) => n === null || typeof n != "object" && typeof n != "function", to = Array.isArray, nr = (n) => to(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", $n = `[ 	
\f\r]`, yt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Eo = /-->/g, Io = />/g, ct = RegExp(`>|${$n}(?:([^\\s"'>=/]+)(${$n}*=${$n}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Do = /'/g, $o = /"/g, mi = /^(?:script|style|textarea|title)$/i, or = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), ye = or(1), ft = Symbol.for("lit-noChange"), Le = Symbol.for("lit-nothing"), jo = /* @__PURE__ */ new WeakMap(), dt = ht.createTreeWalker(ht, 129);
function gi(n, e) {
...
const ir = (n, e) => {
  ...
  for (let c = 0; c < t; c++) {
    ...
    r += s === yt ? d + tr : h >= 0 ? (o.push(l), d.slice(0, h) + hi + d.slice(h) + at + m) : d + at + (h === -2 ? c : m);
  }
  return [gi(n, r + (n[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), o];
};
let Bn = class fi {
  constructor({ strings: e, _$litType$: t }, o) {
    ...
    this.parts = [];
    let r = 0, s = 0;
    const c = e.length - 1, d = this.parts, [l, u] = ir(e, t);
    ...
    for (; (i = dt.nextNode()) !== null && d.length < c; ) {
      if (i.nodeType === 1) {
        ...
        let h = -1;
        for (; (h = i.data.indexOf(at, h + 1)) !== -1; ) d.push({ type: 7, index: r }), h += at.length - 1;
      }
      r++;
    }
  }
...
let rr = class {
  ...
  u(e) {
    ...
    dt.currentNode = i;
    let r = dt.nextNode(), s = 0, c = 0, d = o[0];
    for (; d !== void 0; ) {
      if (s === d.index) {
        let l;
        d.type === 2 ? l = new no(r, r.nextSibling, this, e) : d.type === 1 ? l = new d.ctor(r, d.name, d.strings, this, e) : d.type === 6 && (l = new cr(r, this, e)), this._$AV.push(l), d = o[++c];
      }
      s !== (d == null ? void 0 : d.index) && (r = dt.nextNode(), s++);
    }
  ...
  _$AI(e, t = this) {
    e = vt(this, e, t), qt(e) ? e === Le || e == null || e === "" ? (this._$AH !== Le && this._$AR(), this._$AH = Le) : e !== this._$AH && e !== ft && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : nr(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    ...
    if (((r = this._$AH) == null ? void 0 : r._$AD) === i) this._$AH.p(t);
      ...
      const s = new rr(i, this), c = s.u(this.options);
  ...
  k(e) {
    ...
    const t = this._$AH;
    let o, i = 0;
    for (const r of e) i === t.length ? t.push(o = new vi(this.O(Rt()), this.O(Rt()), this, this.options)) : o = t[i], o._$AI(r), i++;
    i < t.length && (this._$AR(o && o._$AB.nextSibling, i), t.length = i);
  }
  _$AR(e = this._$AA.nextSibling, t) {
    var o;
    for ((o = this._$AP) == null ? void 0 : o.call(this, !1, !0, t); e !== this._$AB; ) {
      const i = Po(e).nextSibling;
      Po(e).remove(), e = i;
    }
  }
  setConnected(e) {
  ...
  _$AI(e, t = this, o, i) {
    ...
    let s = !1;
    if (r === void 0) e = vt(this, e, t, 0), s = !qt(e) || e !== this._$AH && e !== ft, s && (this._$AH = e);
    else {
      const c = e;
      let d, l;
      for (e = r[0], d = 0; d < r.length - 1; d++) l = vt(this, c[o + d], t, d), l === ft && (l = this._$AH[d]), s || (s = !qt(l) || l !== this._$AH[d]), l === Le ? e = Le : e !== Le && (e += (l ?? "") + r[d + 1]), this._$AH[d] = l;
    }
    s && !i && this.j(e);
  }
  j(e) {
...
const dr = (n, e, t) => {
  ...
  if (i === void 0) {
    ...
    o._$litPart$ = i = new no(e.insertBefore(Rt(), r), r, void 0, t ?? {});
  }
  return i._$AI(n), i;
};
/**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const hr = { attribute: !0, type: String, converter: fn, reflect: !1, hasChanged: eo }, pr = (n = hr, e, t) => {
...
function Ue(n) {
  return (e, t) => typeof t == "object" ? pr(n, e, t) : ((o, i, r) => {
 ...
 */
function Ze(n) {
  return Ue({ ...n, state: !0, attribute: !1 });
}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const mr = (n) => (...e) => ({ _$litDirective$: n, values: e });
let gr = class {
  constructor(e) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const fr = {}, vr = (n, e = fr) => n._$AH = e;
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const _r = mr(class extends gr {
  constructor() {
  ...
  update(n, [e, t]) {
    return e !== this.key && (vr(n), this.key = e), t;
  }
});
/*! For license information please see elements.js.LICENSE.txt */
var yr = { 7: function(n, e, t) {
  (function(o, i, r) {
    var s = function() {
      return s = Object.assign || function(x) {
        for (var P, A = 1, S = arguments.length; A < S; A++) for (var O in P = arguments[A]) Object.prototype.hasOwnProperty.call(P, O) && (x[O] = P[O]);
        return x;
    ...
    function c(x, P) {
      ...
      var S, O, $ = A.call(x), T = [];
      try {
        for (; (P === void 0 || P-- > 0) && !(S = $.next()).done; ) T.push(S.value);
      } catch (N) {
        O = { error: N };
      } finally {
        try {
    ...
    function d(x, P) {
      return [x, !x || x.endsWith("/") ? "" : "/", P, ".json"].join("");
    }
    function l(x, P) {
      var A = x;
      return P && Object.keys(P).forEach(function(S) {
        var O = P[S], $ = new RegExp("{".concat(S, "}"), "gm");
        A = A.replace($, O.toString());
      }), A;
    }
    function u(x, P, A) {
      var S = x[P];
      ...
      do {
        var T = S[$ += O.shift()];
        T === void 0 || typeof T != "object" && O.length ? O.length ? $ += "." : S = A : (S = T, $ = "");
      } while (O.length);
      return S;
    }
    ...
    o.TranslateContext = m, o.TranslateProvider = function(x) {
      var P = function(T, N) {
        T = Object.assign({}, f, T), h = N || h;
        var ae = c(r.useState(T.lang), 2), ke = ae[0], se = ae[1], Se = c(r.useState(h), 2), M = Se[0], H = Se[1], _e = c(r.useState(!1), 2), Te = _e[0], Ie = _e[1], Ne = function(le) {
        ...
        return r.useEffect(function() {
          Ne(T.fallbackLang), Ne(ke);
        }, [ke]), { lang: ke, setLang: se, t: function(le, ce) {
          if (!M.hasOwnProperty(ke)) return le;
          var me = u(M, ke, le);
          return me === le && ke !== T.fallbackLang && (me = u(M, T.fallbackLang, le)), l(me, ce);
        }, isReady: Te };
      }({ root: x.root || "assets", lang: x.lang || "en", fallbackLang: x.fallbackLang || "en" }, x.translations), A = P.t, S = P.setLang, O = P.lang, $ = P.isReady;
      return i.h(m.Provider, { value: { t: A, setLang: S, lang: O, isReady: $ } }, x.children);
  ...
  t.d(e, { A: () => c });
  var o = t(645), i = t.n(o), r = t(278), s = t.n(r)()(i());
  ...
  t.r(e), t.d(e, { Component: () => N, Fragment: () => T, cloneElement: () => We, createContext: () => Fe, createElement: () => S, createRef: () => $, h: () => S, hydrate: () => He, isValidElement: () => s, options: () => i, render: () => ge, toChildArray: () => _e });
  ...
  function S(g, v, b) {
    ...
    return O(g, z, D, U, null);
  }
  function O(g, v, b, D, U) {
    var I = { type: g, props: v, key: b, ref: D, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, __h: null, constructor: void 0, __v: U ?? ++r };
  ...
  function Se() {
    var g, v, b, D, U, I, z, ee;
    for (c.sort(u); g = c.shift(); ) g.__d && (v = c.length, D = void 0, U = void 0, z = (I = (b = g).__v).__e, (ee = b.__P) && (D = [], (U = P({}, I)).__v = I.__v + 1, De(ee, I, U, b.__n, ee.ownerSVGElement !== void 0, I.__h != null ? [z] : null, D, z ?? ae(I), I.__h), k(D, I), I.__e != z && ke(I)), c.length > v && c.sort(u));
    Se.__r = 0;
  }
  function M(g, v, b, D, U, I, z, ee, G, be) {
    var w, we, J, R, E, xe, V, F = D && D.__k || m, qe = F.length;
    for (b.__k = [], w = 0; w < v.length; w++) if ((R = b.__k[w] = (R = v[w]) == null || typeof R == "boolean" || typeof R == "function" ? null : typeof R == "string" || typeof R == "number" || typeof R == "bigint" ? O(null, R, null, null, R) : Array.isArray(R) ? O(T, { children: R }, null, null, null) : R.__b > 0 ? O(R.type, R.props, R.key, R.ref ? R.ref : null, R.__v) : R) != null) {
      ...
      De(g, R, J = J || f, U, I, z, ee, G, be), E = R.__e, (we = R.ref) && J.ref != we && (V || (V = []), J.ref && V.push(J.ref, null, R), V.push(we, R.__c || E, R)), E != null ? (xe == null && (xe = E), typeof R.type == "function" && R.__k === J.__k ? R.__d = G = H(R, G, g) : G = Te(g, R, J, F, E, G), typeof b.type == "function" && (b.__d = G)) : G && J.__e == G && G.parentNode != g && (G = ae(J));
    }
  ...
  function H(g, v, b) {
    for (var D, U = g.__k, I = 0; U && I < U.length; I++) (D = U[I]) && (D.__ = g, v = typeof D.type == "function" ? H(D, v, b) : Te(b, D, D, U, D.__e, v));
    return v;
  }
  function _e(g, v) {
  ...
  function Te(g, v, b, D, U, I) {
    var z, ee, G;
    if (v.__d !== void 0) z = v.__d, v.__d = void 0;
    else if (b == null || U != I || U.parentNode == null) e: if (I == null || I.parentNode !== g) g.appendChild(U), z = null;
    else {
      for (ee = I, G = 0; (ee = ee.nextSibling) && G < D.length; G += 1) if (ee == U) break e;
      g.insertBefore(U, I), z = I;
    }
  ...
  function De(g, v, b, D, U, I, z, ee, G) {
    var be, w, we, J, R, E, xe, V, F, qe, it, fe, Vt, rt, q, B = v.type;
    ...
    try {
      e: if (typeof B == "function") {
        ...
        if (w.context = qe, w.props = V, w.__P = g, fe = i.__r, Vt = 0, "prototype" in B && B.prototype.render) {
          for (w.state = w.__s, w.__d = !1, fe && fe(v), be = w.render(w.props, w.state, w.context), rt = 0; rt < w._sb.length; rt++) w.__h.push(w._sb[rt]);
          w._sb = [];
        } else do
          w.__d = !1, fe && fe(v), be = w.render(w.props, w.state, w.context), w.state = w.__s;
        while (w.__d && ++Vt < 25);
        w.state = w.__s, w.getChildContext != null && (D = P(P({}, D), w.getChildContext())), we || w.getSnapshotBeforeUpdate == null || (E = w.getSnapshotBeforeUpdate(J, R)), q = be != null && be.type === T && be.key == null ? be.props.children : be, M(g, Array.isArray(q) ? q : [q], v, b, D, U, I, z, ee, G), w.base = v.__e, v.__h = null, w.__h.length && z.push(w), xe && (w.__E = w.__ = null), w.__e = !1;
      } else I == null && v.__v === b.__v ? (v.__k = b.__k, v.__e = b.__e) : v.__e = p(b.__e, v, b, D, U, I, z, G);
      (be = i.diffed) && be(v);
    } catch (Qe) {
  ...
  function p(g, v, b, D, U, I, z, ee) {
    ...
    if (g == null) {
      ...
      g = U ? document.createElementNS("http://www.w3.org/2000/svg", R) : document.createElement(R, J.is && J), I = null, ee = !1;
    }
    if (R === null) we === J || ee && g.data === J || (g.data = J);
      ...
      else if (E = v.props.children, M(g, Array.isArray(E) ? E : [E], v, b, D, U && R !== "foreignObject", I, z, I ? I[0] : b.__k && ae(b, 0), ee), I != null) for (E = I.length; E--; ) I[E] != null && A(I[E]);
  ...
  function L(g, v, b) {
    ...
    if (D = g.__k) for (U = 0; U < D.length; U++) D[U] && L(D[U], v, b || typeof g.type != "function");
  ...
  function ge(g, v, b) {
    var D, U, I;
    i.__ && i.__(g, v), U = (D = typeof b == "function") ? null : b && b.__k || v.__k, I = [], De(v, g = (!D && b || v).__k = S(T, null, [g]), U || f, f, v.ownerSVGElement !== void 0, !D && b ? [b] : U ? null : v.firstChild ? o.call(v.childNodes) : null, I, !D && b ? b : U ? U.__e : v.firstChild, D), k(I, g);
  }
  function He(g, v) {
    ge(g, v, He);
  }
  function We(g, v, b) {
    var D, U, I, z = P({}, g.props);
    for (I in v) I == "key" ? D = v[I] : I == "ref" ? U = v[I] : z[I] = v[I];
    return arguments.length > 2 && (z.children = arguments.length > 3 ? o.call(arguments, 2) : b), O(g.type, z, D || g.key, U || g.ref, null);
  }
  function Fe(g, v) {
    var b = { __c: v = "__cC" + h++, __: g, Consumer: function(D, U) {
      return D.children(U);
    }, Provider: function(D) {
      var U, I;
      return this.getChildContext || (U = [], (I = {})[v] = this, this.getChildContext = function() {
        ...
        this.props.value !== z.value && U.some(function(ee) {
          ee.__e = !0, se(ee);
        });
      }, this.sub = function(z) {
        U.push(z);
        ...
        z.componentWillUnmount = function() {
          U.splice(U.indexOf(z), 1), ee && ee.call(z);
        };
      }), D.children;
    } };
  ...
  o = m.slice, i = { __e: function(g, v, b, D) {
    for (var U, I, z; v = v.__; ) if ((U = v.__c) && !U.__) try {
      if ((I = U.constructor) && I.getDerivedStateFromError != null && (U.setState(I.getDerivedStateFromError(g)), z = U.__d), U.componentDidCatch != null && (U.componentDidCatch(g, D || {}), z = U.__d), z) return U.__E = U;
    } catch (ee) {
      g = ee;
    }
    throw g;
  ...
  }, N.prototype.render = T, c = [], l = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, u = function(g, v) {
    return g.__v.__b - v.__v.__b;
  }, Se.__r = 0, h = 0;
}, 78: (n, e, t) => {
  t.r(e), t.d(e, { useCallback: () => se, useContext: () => Se, useDebugValue: () => M, useEffect: () => $, useErrorBoundary: () => H, useId: () => _e, useImperativeHandle: () => ae, useLayoutEffect: () => T, useMemo: () => ke, useReducer: () => O, useRef: () => N, useState: () => S });
  ...
  c.options.__b = function(k) {
    ...
    })) : (p.__h.forEach(le), p.__h.forEach(ce), p.__h = [])), r = i;
  }, c.options.diffed = function(k) {
    m && m(k);
    var p = k.__c;
    p && p.__H && (p.__H.__h.length && (l.push(p) !== 1 && s === c.options.requestAnimationFrame || ((s = c.options.requestAnimationFrame) || Ne)(Te)), p.__H.__.forEach(function(y) {
  ...
  var e = [];
  function t(r) {
    for (var s = -1, c = 0; c < e.length; c++) if (e[c].identifier === r) {
      s = c;
      break;
    }
    return s;
  ...
  var e, t = (e = [], function(r, s) {
    return e[r] = s, e.filter(Boolean).join(`
`);
  });
  function o(r, s, c, d) {
    var l;
  ...
  n.exports = function(r) {
    ...
    var s = i.singletonCounter++, c = i.singleton || (i.singleton = r.insertStyleElement(r));
...
function X(n) {
  ...
  return yr[n].call(t.exports, t, t.exports, X), t.exports;
}
X.n = (n) => {
...
var re = {};
X.d(re, { fK: () => wn, tJ: () => Ii, Z7: () => Cn, Q9: () => Li, Lv: () => $i, qQ: () => xn, I4: () => Mi, O8: () => Ce, ku: () => ro, ls: () => io, bO: () => ao, yv: () => An, AT: () => lo, m_: () => Wt, KG: () => so, DH: () => Sn, kf: () => fo, oY: () => je, xg: () => Ui, Wg: () => Ye, J: () => Ti, AC: () => co, D_: () => Xe, jx: () => ji, nX: () => uo, Nx: () => oo, Sd: () => gt, kz: () => us, fX: () => ho, qA: () => po, tz: () => go, gN: () => mo });
var Zn = {};
X.r(Zn), X.d(Zn, { apple: () => ca, checkmark: () => da, copy: () => ua, customProvider: () => ha, discord: () => pa, exclamation: () => ma, facebook: () => ga, github: () => fa, google: () => va, linkedin: () => _a, mail: () => ya, microsoft: () => ba, passkey: () => ka, password: () => wa, qrCodeScanner: () => Sa, securityKey: () => xa, spinner: () => Aa });
var C = X(616), br = 0;
function a(n, e, t, o, i, r) {
  var s, c, d = {};
  for (c in e) c == "ref" ? s = e[c] : d[c] = e[c];
  var l = { type: n, props: d, key: t, ref: s, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, __h: null, constructor: void 0, __v: --br, __source: i, __self: r };
...
function wr(n) {
  ...
  var e = n.children, t = function(o, i) {
    if (o == null) return {};
    var r, s, c = {}, d = Object.keys(o);
    for (s = 0; s < d.length; s++) i.indexOf(r = d[s]) >= 0 || (c[r] = o[r]);
    return c;
  }(n, kr);
...
function Sr() {
  ...
  this.dispatchEvent(n), this._vdom = (0, C.h)(wr, _n({}, this._props, { context: n.detail.context }), yi(this, this._vdomComponent)), (this.hasAttribute("hydrate") ? C.hydrate : C.render)(this._vdom, this._root);
}
function _i(n) {
...
function yi(n, e) {
  ...
  var t = [], o = {}, i = 0, r = n.attributes, s = n.childNodes;
  for (i = r.length; i--; ) r[i].name !== "slot" && (o[r[i].name] = r[i].value, o[_i(r[i].name)] = r[i].value);
  for (i = s.length; i--; ) {
    var c = yi(s[i], null), d = s[i].slot;
    d ? o[d] = (0, C.h)(Uo, { name: d }, c) : t[i] = c;
  }
  var l = e ? (0, C.h)(Uo, null, t) : t;
...
(No.prototype = new C.Component()).isPureReactComponent = !0, No.prototype.shouldComponentUpdate = function(n, e) {
  return To(this.props, n) || To(this.state, e);
};
var Mo = C.options.__b;
C.options.__b = function(n) {
  n.type && n.type.__f && n.ref && (n.props.ref = n.ref, n.ref = null), Mo && Mo(n);
};
var Cr = typeof Symbol < "u" && Symbol.for && Symbol.for("react.forward_ref") || 3911, Pr = (C.toChildArray, C.options.__e);
...
C.options.unmount = function(n) {
...
}, (Un.prototype = new C.Component()).__c = function(n, e) {
  var t = e.__c, o = this;
  o.t == null && (o.t = []), o.t.push(t);
  var i = Si(o.__v), r = !1, s = function() {
  ...
  this.t = [];
}, Un.prototype.render = function(n, e) {
  if (this.__b) {
    if (this.__v.__k) {
...
var Or = typeof Symbol < "u" && Symbol.for && Symbol.for("react.element") || 60103, Er = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|image|letter|lighting|marker(?!H|W|U)|overline|paint|pointer|shape|stop|strikethrough|stroke|text(?!L)|transform|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/, Ir = /^on(Ani|Tra|Tou|BeforeInp|Compo)/, Dr = /[A-Z0-9]/g, $r = typeof document < "u", jr = function(n) {
...
C.options.event = function(n) {
  return zo && (n = zo(n)), n.persist = Lr, n.isPropagationStopped = Ur, n.isDefaultPrevented = Tr, n.nativeEvent = n;
};
...
C.options.vnode = function(n) {
  ...
  if (typeof e == "string") {
    for (var i in o = {}, t) {
      var r = t[i];
      if (!(i === "value" && "defaultValue" in t && r == null || $r && i === "children" && e === "noscript")) {
        var s = i.toLowerCase();
        i === "defaultValue" && "value" in t && t.value == null ? i = "value" : i === "download" && r === !0 ? r = "" : s === "ondoubleclick" ? i = "ondblclick" : s !== "onchange" || e !== "input" && e !== "textarea" || jr(t.type) ? s === "onfocus" ? i = "onfocusin" : s === "onblur" ? i = "onfocusout" : Ir.test(i) ? i = s : e.indexOf("-") === -1 && Er.test(i) ? i = i.replace(Dr, "-$&").toLowerCase() : r === null && (r = void 0) : s = i = "oninput", s === "oninput" && o[i = s] && (i = "oninputCapture"), o[i] = r;
      }
    }
...
var Ci = { type: ve(ue), id: ve(Be), transports: Ae(ue) }, Pi = { appid: Ae(ue), appidExclude: Ae(ue), credProps: Ae(ue) }, Oi = { appid: Ae(ue), appidExclude: Ae(ue), credProps: Ae(ue) }, Nr = { publicKey: ve({ rp: ve(ue), user: ve({ id: ve(Be), name: ve(ue), displayName: ve(ue) }), challenge: ve(Be), pubKeyCredParams: ve(ue), timeout: Ae(ue), excludeCredentials: Ae([Ci]), authenticatorSelection: Ae(ue), attestation: Ae(ue), extensions: Ae(Pi) }), signal: Ae(ue) }, Mr = { type: ve(ue), id: ve(ue), rawId: ve(Be), authenticatorAttachment: Ae(ue), response: ve({ clientDataJSON: ve(Be), attestationObject: ve(Be), transports: Jn(ue, (n) => {
  var e;
  return ((e = n.getTransports) == null ? void 0 : e.call(n)) || [];
}) }), clientExtensionResults: Jn(Oi, (n) => n.getClientExtensionResults()) }, Rr = { mediation: Ae(ue), publicKey: ve({ challenge: ve(Be), timeout: Ae(ue), rpId: Ae(ue), allowCredentials: Ae([Ci]), userVerification: Ae(ue), extensions: Ae(Pi) }), signal: Ae(ue) }, qr = { type: ve(ue), id: ve(ue), rawId: ve(Be), authenticatorAttachment: Ae(ue), response: ve({ clientDataJSON: ve(Be), authenticatorData: ve(Be), signature: ve(Be), userHandle: ve(Be) }), clientExtensionResults: Jn(Oi, (n) => n.getClientExtensionResults()) };
async function Vo(n) {
...
class ro extends Ce {
  constructor(e) {
    super("Invalid Passcode error", "invalidPasscode", e), Object.setPrototypeOf(this, ro.prototype);
  }
}
class ao extends Ce {
  constructor(e) {
...
var Nn = function n(e, t) {
  ...
  return Object.create({ set: o, get: function(i) {
    if (typeof document < "u" && (!arguments.length || i)) {
      for (var r = document.cookie ? document.cookie.split("; ") : [], s = {}, c = 0; c < r.length; c++) {
...
class Kr {
  constructor(e) {
    this.headers = void 0, this.ok = void 0, this.status = void 0, this.statusText = void 0, this.url = void 0, this._decodedJSON = void 0, this.xhr = void 0, this.headers = new Fr(e), this.ok = e.status >= 200 && e.status <= 299, this.status = e.status, this.statusText = e.statusText, this.url = e.responseURL, this.xhr = e;
  }
  json() {
...
class Vr {
  constructor(e, t) {
    this.timeout = void 0, this.api = void 0, this.dispatcher = void 0, this.cookie = void 0, this.sessionTokenStorage = void 0, this.lang = void 0, this.sessionTokenLocation = void 0, this.api = e, this.timeout = t.timeout, this.dispatcher = new Di(), this.cookie = new Hr(yn({}, t)), this.sessionTokenStorage = new Wr({ keyName: t.cookieName }), this.lang = t.lang, this.sessionTokenLocation = t.sessionTokenLocation;
  }
  _fetch(e, t, o = new XMLHttpRequest()) {
    const i = this, r = this.api + e, s = this.timeout, c = this.getAuthToken(), d = this.lang;
    return new Promise(function(l, u) {
      o.open(t.method, r, !0), o.setRequestHeader("Accept", "application/json"), o.setRequestHeader("Content-Type", "application/json"), o.setRequestHeader("X-Language", d), c && o.setRequestHeader("Authorization", `Bearer ${c}`), o.timeout = s, o.withCredentials = !0, o.onload = () => {
        i.processHeaders(o), l(new Kr(o));
      }, o.onerror = () => {
        u(new je());
      }, o.ontimeout = () => {
        u(new Sn());
...
`).forEach((r) => {
      ...
      const r = new RegExp("^https://"), s = !!this.api.match(r) && !!window.location.href.match(r), c = i === "session" ? void 0 : new Date((/* @__PURE__ */ new Date()).getTime() + 1e3 * o);
...
class lt {
  constructor(e, t) {
    this.client = void 0, this.client = new Vr(e, t);
  }
}
class $i extends lt {
  getDomain(e) {
...
class Pn {
  constructor() {
    this.throttleLimit = 1e3, this._addEventListener = document.addEventListener.bind(document), this._removeEventListener = document.removeEventListener.bind(document), this._throttle = Br.throttle;
  }
  wrapCallback(e, t) {
    const o = (i) => {
      e(i.detail);
  ...
  addEventListener(e, t, o) {
    return this.addEventListenerWithType(Pn.mapAddEventListenerParams(e, t, o));
  }
...
class Xr extends Di {
  constructor(e, t) {
    super(), this.listener = new Pn(), this.checkInterval = 3e4, this.client = void 0, this.sessionState = void 0, this.windowActivityManager = void 0, this.scheduler = void 0, this.sessionChannel = void 0, this.isLoggedIn = void 0, this.client = new fo(e, t), this.checkInterval = t.sessionCheckInterval, this.sessionState = new Jr(`${t.cookieName}_session_state`), this.sessionChannel = new Gr(this.getSessionCheckChannelName(t.sessionTokenLocation, t.sessionCheckChannelName), () => this.onChannelSessionExpired(), (r) => this.onChannelSessionCreated(r), () => this.onChannelLeadershipRequested()), this.scheduler = new Qr(this.checkInterval, () => this.checkSession(), () => this.onSessionExpired()), this.windowActivityManager = new Yr(() => this.startSessionCheck(), () => this.scheduler.stop());
...
class Rn {
  ...
  constructor({ name: e, payload: t, error: o, status: i, actions: r, csrf_token: s }, c) {
    Object.defineProperty(this, Mn, { value: ea }), this.name = void 0, this.payload = void 0, this.error = void 0, this.status = void 0, this.csrf_token = void 0, Object.defineProperty(this, bt, { writable: !0, value: void 0 }), this.actions = void 0, this.fetchNextState = void 0, this.name = e, this.payload = t, this.error = o, this.status = i, this.csrf_token = s, Tn(this, bt)[bt] = r, this.actions = Tn(this, Mn)[Mn](r, s), this.fetchNextState = c;
  }
  runAction(e, t) {
    const o = {};
  ...
  validateAction(e) {
    if ("inputs" in e) for (const t in e.inputs) {
      ...
      o.required && !r && i(mt.Required, "is required"), (o.min_length != null || o.max_length != null) && ("length" in r || i(mt.InvalidInputDefinition, 'has min/max length requirement, but is missing "length" property', "string", typeof r), o.min_length != null && r < o.min_length && i(mt.MinLength, `too short (min ${o.min_length})`, o.min_length, r.length), o.max_length != null && r > o.max_length && i(mt.MaxLength, `too long (max ${o.max_length})`, o.max_length, r.length));
    }
  }
}
function ea(n, e) {
...
class ta extends lt {
  constructor(...e) {
    ...
    super(...e), t = this, this.run = async function(o, i) {
      try {
        if (!Zo(o)) throw new na(o);
        const s = i[o.name];
        if (!s) throw new vo(o);
        let c = await s(o);
        if (typeof (r = c) == "object" && r !== null && "href" in r && "inputs" in r && (c = await c.run()), Zo(c)) return t.run(c, i);
      } catch (s) {
  ...
  async init(e, t) {
    var o = this;
    const i = await async function r(s, c) {
      try {
        const d = await o.client.post(s, c);
        return new Rn(d.json(), r);
      } catch (d) {
  ...
  async fromString(e, t) {
    var o = this;
    const i = new Rn(JSON.parse(e), async function r(s, c) {
      try {
        const d = await o.client.post(s, c);
        return new Rn(d.json(), r);
      } catch (d) {
...
var oa = X(292), et = X.n(oa), ia = X(360), tt = X.n(ia), ra = X(884), nt = X.n(ra), aa = X(88), ot = X.n(aa), an = X(914), kt = {};
kt.setAttributes = nt(), kt.insert = (n) => {
  window._hankoStyle = n;
}, kt.domAPI = tt(), kt.insertStyleElement = ot(), et()(an.A, kt);
const zt = an.A && an.A.locals ? an.A.locals : void 0, sa = function(n) {
  function e(t) {
    var o = bi({}, t);
    return delete o.ref, n(o, t.ref || null);
  }
  return e.$$typeof = Cr, e.render = e, e.prototype.isReactComponent = e.__f = !0, e.displayName = "ForwardRef(" + (n.displayName || n.name) + ")", e;
}((n, e) => {
  const { lang: t, hanko: o, setHanko: i } = (0, _.useContext)(pe), { setLang: r } = (0, _.useContext)(Z.TranslateContext);
  return (0, _.useEffect)(() => {
    r(t.replace(/[-]/, "")), i((s) => (s.setLang(t), s));
  }, [o, t, i, r]), a("section", Object.assign({ part: "container", className: zt.container, ref: e }, { children: n.children }));
});
var sn = X(697), wt = {};
...
var la = X(633), Q = X.n(la);
const ca = ({ size: n, secondary: e, disabled: t }) => a("svg", Object.assign({ id: "icon-apple", xmlns: "http://www.w3.org/2000/svg", width: n, height: n, viewBox: "20.5 16 15 19", className: Q()(j.icon, e && j.secondary, t && j.disabled) }, { children: a("path", { d: "M28.2226562,20.3846154 C29.0546875,20.3846154 30.0976562,19.8048315 30.71875,19.0317864 C31.28125,18.3312142 31.6914062,17.352829 31.6914062,16.3744437 C31.6914062,16.2415766 31.6796875,16.1087095 31.65625,16 C30.7304687,16.0362365 29.6171875,16.640178 28.9492187,17.4494596 C28.421875,18.06548 27.9414062,19.0317864 27.9414062,20.0222505 C27.9414062,20.1671964 27.9648438,20.3121424 27.9765625,20.3604577 C28.0351562,20.3725366 28.1289062,20.3846154 28.2226562,20.3846154 Z M25.2929688,35 C26.4296875,35 26.9335938,34.214876 28.3515625,34.214876 C29.7929688,34.214876 30.109375,34.9758423 31.375,34.9758423 C32.6171875,34.9758423 33.4492188,33.792117 34.234375,32.6325493 C35.1132812,31.3038779 35.4765625,29.9993643 35.5,29.9389701 C35.4179688,29.9148125 33.0390625,28.9122695 33.0390625,26.0979021 C33.0390625,23.6579784 34.9140625,22.5588048 35.0195312,22.474253 C33.7773438,20.6382708 31.890625,20.5899555 31.375,20.5899555 C29.9804688,20.5899555 28.84375,21.4596313 28.1289062,21.4596313 C27.3554688,21.4596313 26.3359375,20.6382708 25.1289062,20.6382708 C22.8320312,20.6382708 20.5,22.5950413 20.5,26.2911634 C20.5,28.5861411 21.3671875,31.013986 22.4335938,32.5842339 C23.3476562,33.9129053 24.1445312,35 25.2929688,35 Z" }) })), da = ({ secondary: n, size: e, fadeOut: t, disabled: o }) => a("svg", Object.assign({ id: "icon-checkmark", xmlns: "http://www.w3.org/2000/svg", viewBox: "4 4 40 40", width: e, height: e, className: Q()(j.checkmark, n && j.secondary, t && j.fadeOut, o && j.disabled) }, { children: a("path", { d: "M21.05 33.1 35.2 18.95l-2.3-2.25-11.85 11.85-6-6-2.25 2.25ZM24 44q-4.1 0-7.75-1.575-3.65-1.575-6.375-4.3-2.725-2.725-4.3-6.375Q4 28.1 4 24q0-4.15 1.575-7.8 1.575-3.65 4.3-6.35 2.725-2.7 6.375-4.275Q19.9 4 24 4q4.15 0 7.8 1.575 3.65 1.575 6.35 4.275 2.7 2.7 4.275 6.35Q44 19.85 44 24q0 4.1-1.575 7.75-1.575 3.65-4.275 6.375t-6.35 4.3Q28.15 44 24 44Zm0-3q7.1 0 12.05-4.975Q41 31.05 41 24q0-7.1-4.95-12.05Q31.1 7 24 7q-7.05 0-12.025 4.95Q7 16.9 7 24q0 7.05 4.975 12.025Q16.95 41 24 41Zm0-17Z" }) })), ua = ({ size: n, secondary: e, disabled: t }) => a("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 -960 960 960", width: n, height: n, className: Q()(j.icon, e && j.secondary, t && j.disabled) }, { children: a("path", { d: "M360-240q-33 0-56.5-23.5T280-320v-480q0-33 23.5-56.5T360-880h360q33 0 56.5 23.5T800-800v480q0 33-23.5 56.5T720-240H360Zm0-80h360v-480H360v480ZM200-80q-33 0-56.5-23.5T120-160v-560h80v560h440v80H200Zm160-240v-480 480Z" }) })), ha = ({ size: n, secondary: e, disabled: t }) => a("svg", Object.assign({ id: "icon-custom-provider", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: n, height: n, className: Q()(j.icon, e && j.secondary, t && j.disabled) }, { children: [a("path", { d: "M0 0h24v24H0z", fill: "none" }), a("path", { d: "M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z" })] })), pa = ({ size: n, secondary: e, disabled: t }) => a("svg", Object.assign({ id: "icon-discord", fill: "#fff", xmlns: "http://www.w3.org/2000/svg", width: n, height: n, viewBox: "0 0 127.14 96.36", className: Q()(j.icon, e && j.secondary, t && j.disabled) }, { children: a("path", { d: "M107.7,8.07A105.15,105.15,0,0,0,81.47,0a72.06,72.06,0,0,0-3.36,6.83A97.68,97.68,0,0,0,49,6.83,72.37,72.37,0,0,0,45.64,0,105.89,105.89,0,0,0,19.39,8.09C2.79,32.65-1.71,56.6.54,80.21h0A105.73,105.73,0,0,0,32.71,96.36,77.7,77.7,0,0,0,39.6,85.25a68.42,68.42,0,0,1-10.85-5.18c.91-.66,1.8-1.34,2.66-2a75.57,75.57,0,0,0,64.32,0c.87.71,1.76,1.39,2.66,2a68.68,68.68,0,0,1-10.87,5.19,77,77,0,0,0,6.89,11.1A105.25,105.25,0,0,0,126.6,80.22h0C129.24,52.84,122.09,29.11,107.7,8.07ZM42.45,65.69C36.18,65.69,31,60,31,53s5-12.74,11.43-12.74S54,46,53.89,53,48.84,65.69,42.45,65.69Zm42.24,0C78.41,65.69,73.25,60,73.25,53s5-12.74,11.44-12.74S96.23,46,96.12,53,91.08,65.69,84.69,65.69Z" }) })), ma = ({ size: n, secondary: e, disabled: t }) => a("svg", Object.assign({ id: "icon-exclamation", xmlns: "http://www.w3.org/2000/svg", viewBox: "5 2 13 20", width: n, height: n, className: Q()(j.exclamationMark, e && j.secondary, t && j.disabled) }, { children: a("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z" }) })), ga = ({ size: n, secondary: e, disabled: t }) => a("svg", Object.assign({ width: n, height: n, viewBox: "0 0 666.66668 666.66717", xmlns: "http://www.w3.org/2000/svg" }, { children: [a("defs", Object.assign({ id: "defs13" }, { children: a("clipPath", Object.assign({ clipPathUnits: "userSpaceOnUse", id: "clipPath25" }, { children: a("path", { d: "M 0,700 H 700 V 0 H 0 Z", id: "path23" }) })) })), a("g", Object.assign({ id: "g17", transform: "matrix(1.3333333,0,0,-1.3333333,-133.33333,799.99999)" }, { children: a("g", Object.assign({ id: "g19" }, { children: a("g", Object.assign({ id: "g21", clipPath: "url(#clipPath25)" }, { children: [a("g", Object.assign({ id: "g27", transform: "translate(600,350)" }, { children: a("path", { className: Q()(j.facebookIcon, t ? j.disabledOutline : j.outline), d: "m 0,0 c 0,138.071 -111.929,250 -250,250 -138.071,0 -250,-111.929 -250,-250 0,-117.245 80.715,-215.622 189.606,-242.638 v 166.242 h -51.552 V 0 h 51.552 v 32.919 c 0,85.092 38.508,124.532 122.048,124.532 15.838,0 43.167,-3.105 54.347,-6.211 V 81.986 c -5.901,0.621 -16.149,0.932 -28.882,0.932 -40.993,0 -56.832,-15.528 -56.832,-55.9 V 0 h 81.659 l -14.028,-76.396 h -67.631 V -248.169 C -95.927,-233.218 0,-127.818 0,0", id: "path29" }) })), a("g", Object.assign({ id: "g31", transform: "translate(447.9175,273.6036)" }, { children: a("path", { className: Q()(j.facebookIcon, t ? j.disabledLetter : j.letter), d: "M 0,0 14.029,76.396 H -67.63 v 27.019 c 0,40.372 15.838,55.899 56.831,55.899 12.733,0 22.981,-0.31 28.882,-0.931 v 69.253 c -11.18,3.106 -38.509,6.212 -54.347,6.212 -83.539,0 -122.048,-39.441 -122.048,-124.533 V 76.396 h -51.552 V 0 h 51.552 v -166.242 c 19.343,-4.798 39.568,-7.362 60.394,-7.362 10.254,0 20.358,0.632 30.288,1.831 L -67.63,0 Z", id: "path33" }) }))] })) })) }))] })), fa = ({ size: n, secondary: e, disabled: t }) => a("svg", Object.assign({ id: "icon-github", xmlns: "http://www.w3.org/2000/svg", fill: "#fff", viewBox: "0 0 97.63 96", width: n, height: n, className: Q()(j.icon, e && j.secondary, t && j.disabled) }, { children: [a("path", { d: "M48.854 0C21.839 0 0 22 0 49.217c0 21.756 13.993 40.172 33.405 46.69 2.427.49 3.316-1.059 3.316-2.362 0-1.141-.08-5.052-.08-9.127-13.59 2.934-16.42-5.867-16.42-5.867-2.184-5.704-5.42-7.17-5.42-7.17-4.448-3.015.324-3.015.324-3.015 4.934.326 7.523 5.052 7.523 5.052 4.367 7.496 11.404 5.378 14.235 4.074.404-3.178 1.699-5.378 3.074-6.6-10.839-1.141-22.243-5.378-22.243-24.283 0-5.378 1.94-9.778 5.014-13.2-.485-1.222-2.184-6.275.486-13.038 0 0 4.125-1.304 13.426 5.052a46.97 46.97 0 0 1 12.214-1.63c4.125 0 8.33.571 12.213 1.63 9.302-6.356 13.427-5.052 13.427-5.052 2.67 6.763.97 11.816.485 13.038 3.155 3.422 5.015 7.822 5.015 13.2 0 18.905-11.404 23.06-22.324 24.283 1.78 1.548 3.316 4.481 3.316 9.126 0 6.6-.08 11.897-.08 13.526 0 1.304.89 2.853 3.316 2.364 19.412-6.52 33.405-24.935 33.405-46.691C97.707 22 75.788 0 48.854 0z" }), " "] })), va = ({ size: n, disabled: e }) => a("svg", Object.assign({ id: "icon-google", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: n, height: n, className: j.googleIcon }, { children: [a("path", { className: Q()(j.googleIcon, e ? j.disabled : j.blue), d: "M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" }), a("path", { className: Q()(j.googleIcon, e ? j.disabled : j.green), d: "M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" }), a("path", { className: Q()(j.googleIcon, e ? j.disabled : j.yellow), d: "M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" }), a("path", { className: Q()(j.googleIcon, e ? j.disabled : j.red), d: "M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" }), a("path", { d: "M1 1h22v22H1z", fill: "none" })] })), _a = ({ size: n, secondary: e, disabled: t }) => a("svg", Object.assign({ id: "icon-linkedin", fill: "#fff", xmlns: "http://www.w3.org/2000/svg", width: n, viewBox: "0 0 24 24", height: n, className: Q()(j.icon, e && j.secondary, t && j.disabled) }, { children: a("path", { d: "M20.5 2h-17A1.5 1.5 0 002 3.5v17A1.5 1.5 0 003.5 22h17a1.5 1.5 0 001.5-1.5v-17A1.5 1.5 0 0020.5 2zM8 19H5v-9h3zM6.5 8.25A1.75 1.75 0 118.3 6.5a1.78 1.78 0 01-1.8 1.75zM19 19h-3v-4.74c0-1.42-.6-1.93-1.38-1.93A1.74 1.74 0 0013 14.19a.66.66 0 000 .14V19h-3v-9h2.9v1.3a3.11 3.11 0 012.7-1.4c1.55 0 3.36.86 3.36 3.66z" }) })), ya = ({ size: n, secondary: e, disabled: t }) => a("svg", Object.assign({ id: "icon-mail", xmlns: "http://www.w3.org/2000/svg", width: n, height: n, viewBox: "0 -960 960 960", className: Q()(j.icon, e && j.secondary, t && j.disabled) }, { children: a("path", { d: "M160-160q-33 0-56.5-23.5T80-240v-480q0-33 23.5-56.5T160-800h640q33 0 56.5 23.5T880-720v480q0 33-23.5 56.5T800-160H160Zm320-280L160-640v400h640v-400L480-440Zm0-80 320-200H160l320 200ZM160-640v-80 480-400Z" }) })), ba = ({ size: n, disabled: e }) => a("svg", Object.assign({ id: "icon-microsoft", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: n, height: n, className: j.microsoftIcon }, { children: [a("rect", { className: Q()(j.microsoftIcon, e ? j.disabled : j.blue), x: "1", y: "1", width: "9", height: "9" }), a("rect", { className: Q()(j.microsoftIcon, e ? j.disabled : j.green), x: "1", y: "11", width: "9", height: "9" }), a("rect", { className: Q()(j.microsoftIcon, e ? j.disabled : j.yellow), x: "11", y: "1", width: "9", height: "9" }), a("rect", { className: Q()(j.microsoftIcon, e ? j.disabled : j.red), x: "11", y: "11", width: "9", height: "9" })] })), ka = ({ size: n, secondary: e, disabled: t }) => a("svg", Object.assign({ id: "icon-passkey", xmlns: "http://www.w3.org/2000/svg", viewBox: "3 1.5 19.5 19", width: n, height: n, className: Q()(j.icon, e && j.secondary, t && j.disabled) }, { children: a("g", Object.assign({ id: "icon-passkey-all" }, { children: [a("circle", { id: "icon-passkey-head", cx: "10.5", cy: "6", r: "4.5" }), a("path", { id: "icon-passkey-key", d: "M22.5,10.5a3.5,3.5,0,1,0-5,3.15V19L19,20.5,21.5,18,20,16.5,21.5,15l-1.24-1.24A3.5,3.5,0,0,0,22.5,10.5Zm-3.5,0a1,1,0,1,1,1-1A1,1,0,0,1,19,10.5Z" }), a("path", { id: "icon-passkey-body", d: "M14.44,12.52A6,6,0,0,0,12,12H9a6,6,0,0,0-6,6v2H16V14.49A5.16,5.16,0,0,1,14.44,12.52Z" })] })) })), wa = ({ size: n, secondary: e, disabled: t }) => a("svg", Object.assign({ id: "icon-password", xmlns: "http://www.w3.org/2000/svg", width: n, height: n, viewBox: "0 -960 960 960", className: Q()(j.icon, e && j.secondary, t && j.disabled) }, { children: a("path", { d: "M80-200v-80h800v80H80Zm46-242-52-30 34-60H40v-60h68l-34-58 52-30 34 58 34-58 52 30-34 58h68v60h-68l34 60-52 30-34-60-34 60Zm320 0-52-30 34-60h-68v-60h68l-34-58 52-30 34 58 34-58 52 30-34 58h68v60h-68l34 60-52 30-34-60-34 60Zm320 0-52-30 34-60h-68v-60h68l-34-58 52-30 34 58 34-58 52 30-34 58h68v60h-68l34 60-52 30-34-60-34 60Z" }) })), Sa = ({ size: n, secondary: e, disabled: t }) => a("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 -960 960 960", width: n, height: n, className: Q()(j.icon, e && j.secondary, t && j.disabled) }, { children: a("path", { d: "M80-680v-200h200v80H160v120H80Zm0 600v-200h80v120h120v80H80Zm600 0v-80h120v-120h80v200H680Zm120-600v-120H680v-80h200v200h-80ZM700-260h60v60h-60v-60Zm0-120h60v60h-60v-60Zm-60 60h60v60h-60v-60Zm-60 60h60v60h-60v-60Zm-60-60h60v60h-60v-60Zm120-120h60v60h-60v-60Zm-60 60h60v60h-60v-60Zm-60-60h60v60h-60v-60Zm240-320v240H520v-240h240ZM440-440v240H200v-240h240Zm0-320v240H200v-240h240Zm-60 500v-120H260v120h120Zm0-320v-120H260v120h120Zm320 0v-120H580v120h120Z" }) })), xa = ({ size: n, secondary: e, disabled: t }) => a("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 -960 960 960", width: n, height: n, className: Q()(j.icon, e && j.secondary, t && j.disabled) }, { children: a("path", { d: "M280-240q-100 0-170-70T40-480q0-100 70-170t170-70q66 0 121 33t87 87h432v240h-80v120H600v-120H488q-32 54-87 87t-121 33Zm0-80q66 0 106-40.5t48-79.5h246v120h80v-120h80v-80H434q-8-39-48-79.5T280-640q-66 0-113 47t-47 113q0 66 47 113t113 47Zm0-80q33 0 56.5-23.5T360-480q0-33-23.5-56.5T280-560q-33 0-56.5 23.5T200-480q0 33 23.5 56.5T280-400Zm0-80Z" }) })), Aa = ({ size: n, disabled: e }) => a("svg", Object.assign({ id: "icon-spinner", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: n, height: n, className: Q()(j.loadingSpinner, e && j.disabled) }, { children: [a("path", { d: "M12,1A11,11,0,1,0,23,12,11,11,0,0,0,12,1Zm0,19a8,8,0,1,1,8-8A8,8,0,0,1,12,20Z", opacity: ".25" }), a("path", { d: "M10.72,19.9a8,8,0,0,1-6.5-9.79A7.77,7.77,0,0,1,10.4,4.16a8,8,0,0,1,9.49,6.52A1.54,1.54,0,0,0,21.38,12h.13a1.37,1.37,0,0,0,1.38-1.54,11,11,0,1,0-12.7,12.39A1.54,1.54,0,0,0,12,21.34h0A1.47,1.47,0,0,0,10.72,19.9Z" })] })), Ht = ({ name: n, secondary: e, size: t = 18, fadeOut: o, disabled: i }) => a(Zn[n], { size: t, secondary: e, fadeOut: o, disabled: i }), _o = ({ children: n, isLoading: e, isSuccess: t, fadeOut: o, secondary: i, hasIcon: r, maxWidth: s }) => a(C.Fragment, { children: a("div", e ? Object.assign({ className: Q()(j.loadingSpinnerWrapper, j.centerContent, s && j.maxWidth) }, { children: a(Ht, { name: "spinner", secondary: i }) }) : t ? Object.assign({ className: Q()(j.loadingSpinnerWrapper, j.centerContent, s && j.maxWidth) }, { children: a(Ht, { name: "checkmark", secondary: i, fadeOut: o }) }) : Object.assign({ className: r ? j.loadingSpinnerWrapperIcon : j.loadingSpinnerWrapper }, { children: n })) }), Ca = () => {
...
const Pe = ln.A && ln.A.locals ? ln.A.locals : void 0, Pa = () => {
  const { t: n } = (0, _.useContext)(Z.TranslateContext);
  return a("span", Object.assign({ className: Q()(Pe.lastUsed) }, { children: n("labels.lastUsed") }));
}, ne = (n) => {
  var { uiAction: e, title: t, children: o, secondary: i, dangerous: r, autofocus: s, showLastUsed: c, onClick: d, icon: l } = n, u = function(S, O) {
    var $ = {};
    for (var T in S) Object.prototype.hasOwnProperty.call(S, T) && O.indexOf(T) < 0 && ($[T] = S[T]);
    if (S != null && typeof Object.getOwnPropertySymbols == "function") {
      var N = 0;
      for (T = Object.getOwnPropertySymbols(S); N < T.length; N++) O.indexOf(T[N]) < 0 && Object.prototype.propertyIsEnumerable.call(S, T[N]) && ($[T[N]] = S[T[N]]);
    }
    return $;
  ...
  const x = (0, _.useMemo)(() => e && f.loadingAction === e || u.isLoading, [u, e, f]), P = (0, _.useMemo)(() => e && f.succeededAction === e || u.isSuccess, [u, e, f]), A = (0, _.useMemo)(() => m || u.disabled, [u, m]);
  ...
  var e, t, o, i, r, { label: s } = n, c = function(m, x) {
    var P = {};
    for (var A in m) Object.prototype.hasOwnProperty.call(m, A) && x.indexOf(A) < 0 && (P[A] = m[A]);
    if (m != null && typeof Object.getOwnPropertySymbols == "function") {
      var S = 0;
      for (A = Object.getOwnPropertySymbols(m); S < A.length; S++) x.indexOf(A[S]) < 0 && Object.prototype.propertyIsEnumerable.call(m, A[S]) && (P[A[S]] = m[A[S]]);
    }
    return P;
  }(n, ["label"]);
...
const Ut = cn.A && cn.A.locals ? cn.A.locals : void 0, yo = ({ children: n, hidden: e }) => e ? null : a("section", Object.assign({ part: "divider", className: Ut.divider }, { children: [a("div", { part: "divider-line", className: Ut.line }), n ? a("div", Object.assign({ part: "divider-text", class: Ut.text }, { children: n })) : null, a("div", { part: "divider-line", className: Ut.line })] }));
var dn = X(905), At = {};
...
const Ri = dn.A && dn.A.locals ? dn.A.locals : void 0, Ee = ({ state: n, error: e, flowError: t }) => {
  var o, i;
  const { t: r } = (0, _.useContext)(Z.TranslateContext), { uiState: s, setUIState: c } = (0, _.useContext)(pe);
  return (0, _.useEffect)(() => {
    var d, l;
...
const bn = un.A && un.A.locals ? un.A.locals : void 0, he = ({ children: n }) => a("h1", Object.assign({ part: "headline1", className: Q()(bn.headline, bn.grade1) }, { children: n }));
var hn = X(995), Pt = {};
Pt.setAttributes = nt(), Pt.insert = (n) => {
  window._hankoStyle = n;
}, Pt.domAPI = tt(), Pt.insertStyleElement = ot(), et()(hn.A, Pt);
const Jt = hn.A && hn.A.locals ? hn.A.locals : void 0, Yn = (n) => {
  var { loadingSpinnerPosition: e, dangerous: t = !1, onClick: o, uiAction: i } = n, r = function(O, $) {
    var T = {};
    for (var N in O) Object.prototype.hasOwnProperty.call(O, N) && $.indexOf(N) < 0 && (T[N] = O[N]);
    if (O != null && typeof Object.getOwnPropertySymbols == "function") {
      var ae = 0;
      for (N = Object.getOwnPropertySymbols(O); ae < N.length; ae++) $.indexOf(N[ae]) < 0 && Object.prototype.propertyIsEnumerable.call(O, N[ae]) && (T[N[ae]] = O[N[ae]]);
    }
    return T;
  ...
  } }, { children: a(C.Fragment, e && (x || P) ? { children: [a(_o, { isLoading: x, isSuccess: P, secondary: r.secondary, fadeOut: !0 }), S()] } : { children: S() }) })) });
}, te = Yn, Re = ({ children: n, hidden: e = !1 }) => e ? null : a("section", Object.assign({ className: zt.footer }, { children: n })), bo = (n) => {
  var { label: e } = n, t = function(o, i) {
    var r = {};
    for (var s in o) Object.prototype.hasOwnProperty.call(o, s) && i.indexOf(s) < 0 && (r[s] = o[s]);
    if (o != null && typeof Object.getOwnPropertySymbols == "function") {
      var c = 0;
      for (s = Object.getOwnPropertySymbols(o); c < s.length; c++) i.indexOf(s[c]) < 0 && Object.prototype.propertyIsEnumerable.call(o, s[c]) && (r[s[c]] = o[s[c]]);
    }
    return r;
  }(n, ["label"]);
  return a("div", Object.assign({ className: Pe.inputWrapper }, { children: a("label", Object.assign({ className: Pe.checkboxWrapper }, { children: [a("input", Object.assign({ part: "input checkbox-input", type: "checkbox", "aria-label": e, className: Pe.checkbox }, t)), a("span", Object.assign({ className: Q()(Pe.label, t.disabled ? Pe.disabled : null) }, { children: e }))] })) }));
}, On = () => a("section", { className: Ut.spacer });
...
const Oa = (n) => {
  ...
  const { t: u } = (0, _.useContext)(Z.TranslateContext), { init: h, hanko: f, initialComponentName: m, setLoadingAction: x, uiState: P, setUIState: A, stateHandler: S, hidePasskeyButtonOnLogin: O, lastLogin: $ } = (0, _.useContext)(pe), [T, N] = (0, _.useState)(null), [ae, ke] = (0, _.useState)(P.username || P.email), { flowState: se } = Me(n.state), Se = gt.supported(), [M, H] = (0, _.useState)(void 0), [_e, Te] = (0, _.useState)(null), [Ie, Ne] = (0, _.useState)(!1), le = (k) => {
  ...
  return (0, _.useEffect)(() => {
    ...
    y.preventDefault(), Te(L);
    const K = yield se.actions.thirdparty_oauth({ provider: L, redirect_to: window.location.toString() }).run();
    K.error && Te(null), yield f.flow.run(K, S);
  }))(p, k.value) }, { children: a(ne, Object.assign({ isLoading: k.value == _e, secondary: !0, icon: k.value.startsWith("custom_") ? "customProvider" : k.value, showLastUsed: ($ == null ? void 0 : $.login_method) == "third_party" && ($ == null ? void 0 : $.third_party_provider) == k.value }, { children: u("labels.signInWith", { provider: k.name }) })) }), k.value)) : null, ((l = (d = se.actions).remember_me) === null || l === void 0 ? void 0 : l.call(d, null)) && a(C.Fragment, { children: [a(On, {}), a(bo, { required: !1, type: "checkbox", label: u("labels.staySignedIn"), checked: Ie, onChange: (k) => Ot(void 0, void 0, void 0, function* () {
  ...
  const r = (0, _.useRef)(null), { isDisabled: s } = (0, _.useContext)(pe), c = () => {
    const { current: l } = r;
    l && (l.focus(), l.select());
  ...
  return (0, _.useEffect)(() => {
    ...
    t && c();
  }, [t]), a("div", Object.assign({ className: Pe.passcodeDigitWrapper }, { children: a("input", Object.assign({}, i, { part: "input passcode-input", "aria-label": `${i.name}-digit-${e + 1}`, name: i.name + e.toString(10), type: "text", inputMode: "numeric", maxLength: 1, ref: r, value: o.charAt(0), required: !0, className: Pe.input, disabled: d })) }));
}, ko = ({ passcodeDigits: n = [], numberOfInputs: e = 6, onInput: t, disabled: o = !1 }) => {
  const [i, r] = (0, _.useState)(0), s = () => n.slice(), c = () => {
    i < e - 1 && r(i + 1);
  }, d = () => {
    i > 0 && r(i - 1);
  }, l = (m) => {
    ...
    const x = m.clipboardData.getData("text/plain").slice(0, e - i).split(""), P = s();
    let A = i;
    for (let S = 0; S < e; ++S) S >= i && x.length > 0 && (P[S] = x.shift(), A++);
    r(A), t(P);
  }, h = (m) => {
...
const Ia = pn.A && pn.A.locals ? pn.A.locals : void 0, W = ({ children: n, hidden: e }) => e ? null : a("p", Object.assign({ part: "paragraph", className: Ia.paragraph }, { children: n }));
...
const Da = (n) => {
  var e, t;
  const { t: o } = (0, _.useContext)(Z.TranslateContext), { flowState: i } = Me(n.state), { hanko: r, uiState: s, setUIState: c, setLoadingAction: d, setSucceededAction: l, stateHandler: u } = (0, _.useContext)(pe), [h, f] = (0, _.useState)(), [m, x] = (0, _.useState)(i.payload.resend_after), [P, A] = (0, _.useState)([]), S = (0, _.useMemo)(() => {
    var $;
    return (($ = i.error) === null || $ === void 0 ? void 0 : $.code) === "passcode_max_attempts_reached";
  }, [i]), O = (0, _.useCallback)(($) => Yt(void 0, void 0, void 0, function* () {
    d("passcode-submit");
  ...
  return (0, _.useEffect)(() => {
    ...
    var $;
    m == 0 && (($ = i.error) === null || $ === void 0 ? void 0 : $.code) == "rate_limit_exceeded" && c((T) => Object.assign(Object.assign({}, T), { error: null }));
  }, [m]), (0, _.useEffect)(() => {
    var $;
    (($ = i.error) === null || $ === void 0 ? void 0 : $.code) === "passcode_invalid" && A([]), i.payload.resend_after >= 0 && x(i.payload.resend_after);
  }, [i]), a(C.Fragment, { children: [a(Oe, { children: [a(he, { children: o("headlines.loginPasscode") }), a(Ee, { state: i }), a(W, { children: s.email ? o("texts.enterPasscode", { emailAddress: s.email }) : o("texts.enterPasscodeNoEmail") }), a(oe, Object.assign({ onSubmit: ($) => Yt(void 0, void 0, void 0, function* () {
    return $.preventDefault(), O(P.join(""));
  }) }, { children: [a(ko, { onInput: ($) => {
    if (A($), $.filter((T) => T !== "").length === 6) return O($.join(""));
  }, passcodeDigits: P, numberOfInputs: 6, disabled: h <= 0 || S }), a(ne, Object.assign({ disabled: h <= 0 || S, uiAction: "passcode-submit" }, { children: o("labels.continue") }))] }))] }), a(Re, { children: [a(te, Object.assign({ hidden: !(!((t = (e = i.actions).back) === null || t === void 0) && t.call(e, null)), onClick: ($) => Yt(void 0, void 0, void 0, function* () {
    $.preventDefault(), d("back");
    const T = yield i.actions.back(null).run();
    d(null), yield r.flow.run(T, u);
  }), loadingSpinnerPosition: "right", isLoading: s.loadingAction === "back" }, { children: o("labels.back") })), a(te, Object.assign({ uiAction: "passcode-resend", disabled: m > 0, onClick: ($) => Yt(void 0, void 0, void 0, function* () {
...
const ja = (n) => {
  var e, t, o, i;
  const { t: r } = (0, _.useContext)(Z.TranslateContext), { hanko: s, stateHandler: c, setLoadingAction: d } = (0, _.useContext)(pe), { flowState: l } = Me(n.state), [u, h] = (0, _.useState)(), [f, m] = (0, _.useState)(), x = (O) => It(void 0, void 0, void 0, function* () {
  ...
  }), P = (O) => It(void 0, void 0, void 0, function* () {
    O.preventDefault(), d("choose-login-method");
    const $ = yield l.actions.continue_to_login_method_chooser(null).run();
    d(null), yield s.flow.run($, c);
  }), A = (0, _.useMemo)(() => {
    var O, $;
    return a(te, Object.assign({ hidden: !(!(($ = (O = l.actions).continue_to_passcode_confirmation_recovery) === null || $ === void 0) && $.call(O, null)), uiAction: "password-recovery", onClick: x, loadingSpinnerPosition: "left" }, { children: r("labels.forgotYourPassword") }));
  }, [x, r]), S = (0, _.useMemo)(() => a(te, Object.assign({ uiAction: "choose-login-method", onClick: P, loadingSpinnerPosition: "left" }, { children: "Choose another method" })), [P]);
  return (0, _.useEffect)(() => {
    ...
    d(null), yield s.flow.run($, c);
  }), loadingSpinnerPosition: "right" }, { children: r("labels.back") })), !((i = (o = l.actions).continue_to_login_method_chooser) === null || i === void 0) && i.call(o, null) ? S : A] })] });
};
...
const La = (n) => {
  const { t: e } = (0, _.useContext)(Z.TranslateContext), { hanko: t, stateHandler: o, setLoadingAction: i } = (0, _.useContext)(pe), { flowState: r } = Me(n.state), [s, c] = (0, _.useState)();
  return a(Oe, { children: [a(he, { children: e("headlines.registerPassword") }), a(Ee, { state: r }), a(W, { children: e("texts.passwordFormatHint", { minLength: r.actions.password_recovery(null).inputs.new_password.min_length, maxLength: 72 }) }), a(oe, Object.assign({ onSubmit: (d) => Jo(void 0, void 0, void 0, function* () {
    d.preventDefault(), i("password-submit");
    const l = yield r.actions.password_recovery({ new_password: s }).run();
    i(null), yield t.flow.run(l, o);
  }) }, { children: [a(Ve, { type: "password", autocomplete: "new-password", flowInput: r.actions.password_recovery(null).inputs.new_password, placeholder: e("labels.newPassword"), onInput: (d) => Jo(void 0, void 0, void 0, function* () {
    d.target instanceof HTMLInputElement && c(d.target.value);
  }), autofocus: !0 }), a(ne, Object.assign({ uiAction: "password-submit" }, { children: e("labels.continue") }))] }))] });
};
...
const Ta = (n) => {
  var e, t, o, i, r, s, c;
  const { t: d } = (0, _.useContext)(Z.TranslateContext), { init: l, hanko: u, uiState: h, setUIState: f, stateHandler: m, setLoadingAction: x, initialComponentName: P } = (0, _.useContext)(pe), { flowState: A } = Me(n.state), S = (t = (e = A.actions).register_login_identifier) === null || t === void 0 ? void 0 : t.call(e, null).inputs, O = !(!(S != null && S.email) || !(S != null && S.username)), [$, T] = (0, _.useState)(void 0), [N, ae] = (0, _.useState)(null), [ke, se] = (0, _.useState)(!1), Se = (0, _.useMemo)(() => {
    var M, H;
  ...
  return (0, _.useEffect)(() => {
    ...
    T(_e), M.delete("error"), M.delete("error_description"), history.replaceState(null, null, window.location.pathname + (M.size < 1 ? "" : `?${M.toString()}`));
  }, []), a(C.Fragment, { children: [a(Oe, { children: [a(he, { children: d("headlines.signUp") }), a(Ee, { state: A, error: $ }), S ? a(C.Fragment, { children: [a(oe, Object.assign({ onSubmit: (M) => Gt(void 0, void 0, void 0, function* () {
...
const Na = (n) => {
  var e, t, o, i, r, s, c, d;
  const { t: l } = (0, _.useContext)(Z.TranslateContext), { hanko: u, stateHandler: h, setLoadingAction: f } = (0, _.useContext)(pe), { flowState: m } = Me(n.state), [x, P] = (0, _.useState)();
...
const Je = mn.A && mn.A.locals ? mn.A.locals : void 0, En = function({ name: n, columnSelector: e, contentSelector: t, data: o, checkedItemID: i, setCheckedItemID: r, dropdown: s = !1 }) {
  ...
  return a(En, { name: "email-edit-dropdown", columnSelector: (l) => {
    const u = a("span", Object.assign({ className: Je.description }, { children: l.is_verified ? l.is_primary ? a(C.Fragment, { children: [" -", " ", c("labels.primaryEmail")] }) : null : a(C.Fragment, { children: [" -", " ", c("labels.unverifiedEmail")] }) }));
    return l.is_primary ? a(C.Fragment, { children: [a("b", { children: l.address }), u] }) : a(C.Fragment, { children: [l.address, u] });
  }, data: r, contentSelector: (l) => {
    var u;
    return a(C.Fragment, { children: [l.is_primary ? a(C.Fragment, { children: a(W, { children: [a(ze, { children: c("headlines.isPrimaryEmail") }), c("texts.isPrimaryEmail")] }) }) : a(C.Fragment, { children: a(W, { children: [a(ze, { children: c("headlines.setPrimaryEmail") }), c("texts.setPrimaryEmail"), a("br", {}), a(te, Object.assign({ uiAction: "email-set-primary", onClick: (h) => e(h, l.id), loadingSpinnerPosition: "right" }, { children: c("labels.setAsPrimaryEmail") }))] }) }), l.is_verified ? a(C.Fragment, { children: a(W, { children: [a(ze, { children: c("headlines.emailVerified") }), c("texts.emailVerified")] }) }) : a(C.Fragment, { children: a(W, { children: [a(ze, { children: c("headlines.emailUnverified") }), c("texts.emailUnverified"), a("br", {}), a(te, Object.assign({ uiAction: "email-verify", onClick: (h) => t(h, l.id), loadingSpinnerPosition: "right" }, { children: c("labels.verify") }))] }) }), s.includes(l.id) ? a(C.Fragment, { children: a(W, { children: [a(ze, { children: c("headlines.emailDelete") }), c("texts.emailDelete"), a("br", {}), a(te, Object.assign({ uiAction: "email-delete", dangerous: !0, onClick: (h) => n(h, l.id), disabled: d, loadingSpinnerPosition: "right" }, { children: c("labels.delete") }))] }) }) : null, ((u = l.identities) === null || u === void 0 ? void 0 : u.length) > 0 ? a(C.Fragment, { children: a(W, { children: [a(ze, { children: c("headlines.connectedAccounts") }), l.identities.map((h) => h.provider).join(", ")] }) }) : null] });
  }, checkedItemID: o, setCheckedItemID: i });
}, Ra = ({ onCredentialNameSubmit: n, oldName: e, onBack: t, credential: o, credentialType: i }) => {
  const { t: r } = (0, _.useContext)(Z.TranslateContext), [s, c] = (0, _.useState)(e);
  return a(C.Fragment, { children: [a(Oe, { children: [a(he, { children: r(i === "security-key" ? "headlines.renameSecurityKey" : "headlines.renamePasskey") }), a(Ee, { flowError: null }), a(W, { children: r(i === "security-key" ? "texts.renameSecurityKey" : "texts.renamePasskey") }), a(oe, Object.assign({ onSubmit: (d) => n(d, o.id, s) }, { children: [a(Ve, { type: "text", name: i, value: s, minLength: 3, maxLength: 32, required: !0, placeholder: r(i === "security-key" ? "labels.newSecurityKeyName" : "labels.newPasskeyName"), onInput: (d) => {
    return l = void 0, u = void 0, f = function* () {
      ...
      function S(O) {
        var $;
        O.done ? m(O.value) : ($ = O.value, $ instanceof h ? $ : new h(function(T) {
          T($);
        })).then(P, A);
      }
...
}, qa = ({ inputs: n, onEmailSubmit: e, checkedItemID: t, setCheckedItemID: o }) => {
  var i;
  const { t: r } = (0, _.useContext)(Z.TranslateContext), [s, c] = (0, _.useState)();
  return a(Ft, Object.assign({ name: "email-create-dropdown", title: r("labels.addEmail"), checkedItemID: t, setCheckedItemID: o }, { children: [a(wo, { flowError: (i = n.email) === null || i === void 0 ? void 0 : i.error }), a(oe, Object.assign({ onSubmit: (d) => e(d, s).then(() => c("")) }, { children: [a(Ve, { markError: !0, type: "email", placeholder: r("labels.newEmailAddress"), onInput: (d) => {
  ...
  const { t: i } = (0, _.useContext)(Z.TranslateContext), r = gt.supported();
...
}, Xo = ({ inputs: n, checkedItemID: e, setCheckedItemID: t, onUsernameSubmit: o, onUsernameDelete: i, hasUsername: r, allowUsernameDeletion: s }) => {
  var c;
  const { t: d } = (0, _.useContext)(Z.TranslateContext), [l, u] = (0, _.useState)();
  return a(Ft, Object.assign({ name: "username-edit-dropdown", title: d(r ? "labels.changeUsername" : "labels.setUsername"), checkedItemID: e, setCheckedItemID: t }, { children: [a(wo, { flowError: (c = n.username) === null || c === void 0 ? void 0 : c.error }), a(oe, Object.assign({ onSubmit: (h) => o(h, l).then(() => u("")) }, { children: [a(Ve, { markError: !0, placeholder: d("labels.username"), type: "text", onInput: (h) => {
    h.preventDefault(), h.target instanceof HTMLInputElement && u(h.target.value);
  }, value: l, flowInput: n.username }), a(ne, Object.assign({ uiAction: "username-set" }, { children: d("labels.save") }))] })), a(te, Object.assign({ hidden: !s, uiAction: "username-delete", dangerous: !0, onClick: (h) => i(h).then(() => u("")), loadingSpinnerPosition: "right" }, { children: d("labels.delete") }))] }));
}, za = ({ onBack: n, onAccountDelete: e }) => {
  const { t } = (0, _.useContext)(Z.TranslateContext);
  return a(C.Fragment, { children: [a(Oe, { children: [a(he, { children: t("headlines.deleteAccount") }), a(Ee, { flowError: null }), a(W, { children: t("texts.deleteAccount") }), a(oe, Object.assign({ onSubmit: e }, { children: [a(bo, { required: !0, type: "checkbox", label: t("labels.deleteAccount") }), a(ne, Object.assign({ uiAction: "account_delete" }, { children: t("labels.delete") }))] }))] }), a(Re, { children: a(te, Object.assign({ onClick: n }, { children: t("labels.back") })) })] });
}, Ha = ({ sessions: n = [], checkedItemID: e, setCheckedItemID: t, onSessionDelete: o, deletableSessionIDs: i }) => {
  const { t: r } = (0, _.useContext)(Z.TranslateContext), s = (c) => new Date(c).toLocaleString();
  return a(En, { name: "session-edit-dropdown", columnSelector: (c) => {
    const d = a("b", { children: c.user_agent ? c.user_agent : c.id }), l = c.current ? a("span", Object.assign({ className: Je.description }, { children: a(C.Fragment, { children: [" -", " ", r("labels.currentSession")] }) })) : null;
    return a(C.Fragment, { children: [d, l] });
  }, data: n, contentSelector: (c) => a(C.Fragment, { children: [a(W, Object.assign({ hidden: !c.ip_address }, { children: [a(ze, { children: r("headlines.ipAddress") }), c.ip_address] })), a(W, { children: [a(ze, { children: r("headlines.lastUsed") }), s(c.last_used)] }), a(W, { children: [a(ze, { children: r("headlines.createdAt") }), s(c.created_at)] }), i != null && i.includes(c.id) ? a(W, { children: [a(ze, { children: r("headlines.revokeSession") }), a(te, Object.assign({ uiAction: "session-delete", dangerous: !0, onClick: (d) => o(d, c.id), loadingSpinnerPosition: "right" }, { children: r("labels.revoke") }))] }) : null] }), checkedItemID: e, setCheckedItemID: t });
}, Wa = ({ checkedItemID: n, setCheckedItemID: e, onDelete: t, onConnect: o, authAppSetUp: i, allowDeletion: r }) => {
  const { t: s } = (0, _.useContext)(Z.TranslateContext), c = a("span", Object.assign({ className: Je.description }, { children: i ? a(C.Fragment, { children: [" -", " ", s("labels.configured")] }) : null })), d = a(C.Fragment, { children: [s("labels.authenticatorAppManage"), " ", c] });
  return a(Ft, Object.assign({ name: "authenticator-app-manage-dropdown", title: d, checkedItemID: n, setCheckedItemID: e }, { children: [a(ze, { children: s(i ? "headlines.authenticatorAppAlreadySetUp" : "headlines.authenticatorAppNotSetUp") }), a(W, { children: [s(i ? "texts.authenticatorAppAlreadySetUp" : "texts.authenticatorAppNotSetUp"), a("br", {}), a(te, i ? Object.assign({ hidden: !r, uiAction: "auth-app-remove", onClick: (l) => t(l), loadingSpinnerPosition: "right", dangerous: !0 }, { children: s("labels.delete") }) : Object.assign({ uiAction: "auth-app-add", onClick: (l) => o(l), loadingSpinnerPosition: "right" }, { children: s("labels.authenticatorAppAdd") }))] })] }));
};
...
const qi = (n) => {
  var e, t, o, i, r, s, c, d, l, u, h, f, m, x, P, A, S, O, $, T, N, ae, ke, se, Se, M, H, _e, Te, Ie, Ne, le, ce, me, De, k, p, y, L, K, ge, He, We, Fe, g, v, b, D, U, I, z, ee;
  ...
  }), onUsernameDelete: it, checkedItemID: xe, setCheckedItemID: V }) : null, !((m = (f = E.actions).username_update) === null || m === void 0) && m.call(f, null) ? a(Xo, { inputs: E.actions.username_update(null).inputs, hasUsername: !!E.payload.user.username, allowUsernameDeletion: !!(!((P = (x = E.actions).username_delete) === null || P === void 0) && P.call(x, null)), onUsernameSubmit: (q, B) => $e(void 0, void 0, void 0, function* () {
    return F(q, "username-set", E.actions.username_update({ username: B }).run);
  }), onUsernameDelete: it, checkedItemID: xe, setCheckedItemID: V }) : null] })] }) : null, !((S = (A = E.payload) === null || A === void 0 ? void 0 : A.user) === null || S === void 0) && S.emails || !(($ = (O = E.actions).email_create) === null || $ === void 0) && $.call(O, null) ? a(C.Fragment, { children: [a(he, { children: G("headlines.profileEmails") }), a(W, { children: [a(Ma, { emails: E.payload.user.emails, onEmailDelete: (q, B) => $e(void 0, void 0, void 0, function* () {
  ...
  }), checkedItemID: xe, setCheckedItemID: V, deletableEmailIDs: (ae = (N = (T = E.actions).email_delete) === null || N === void 0 ? void 0 : N.call(T, null).inputs.email_id.allowed_values) === null || ae === void 0 ? void 0 : ae.map((q) => q.value) }), !((se = (ke = E.actions).email_create) === null || se === void 0) && se.call(ke, null) ? a(qa, { inputs: E.actions.email_create(null).inputs, onEmailSubmit: (q, B) => $e(void 0, void 0, void 0, function* () {
    return J((Qe) => Object.assign(Object.assign({}, Qe), { email: B })), F(q, "email-submit", E.actions.email_create({ email: B }).run);
  }), checkedItemID: xe, setCheckedItemID: V }) : null] })] }) : null, !((M = (Se = E.actions).password_create) === null || M === void 0) && M.call(Se, null) ? a(C.Fragment, { children: [a(he, { children: G("headlines.profilePassword") }), a(W, { children: a(Qo, { inputs: E.actions.password_create(null).inputs, onPasswordSubmit: (q, B) => $e(void 0, void 0, void 0, function* () {
    return F(q, "password-submit", E.actions.password_create({ password: B }).run);
  }), onPasswordDelete: qe, checkedItemID: xe, setCheckedItemID: V }) })] }) : null, !((_e = (H = E.actions).password_update) === null || _e === void 0) && _e.call(H, null) ? a(C.Fragment, { children: [a(he, { children: G("headlines.profilePassword") }), a(W, { children: a(Qo, { allowPasswordDelete: !!(!((Ie = (Te = E.actions).password_delete) === null || Ie === void 0) && Ie.call(Te, null)), inputs: E.actions.password_update(null).inputs, onPasswordSubmit: (q, B) => $e(void 0, void 0, void 0, function* () {
    return F(q, "password-submit", E.actions.password_update({ password: B }).run);
  }), onPasswordDelete: qe, checkedItemID: xe, setCheckedItemID: V, passwordExists: !0 }) })] }) : null, n.enablePasskeys && (!((le = (Ne = E.payload) === null || Ne === void 0 ? void 0 : Ne.user) === null || le === void 0) && le.passkeys || !((me = (ce = E.actions).webauthn_credential_create) === null || me === void 0) && me.call(ce, null)) ? a(C.Fragment, { children: [a(he, { children: G("headlines.profilePasskeys") }), a(W, { children: [a(Yo, { onBack: rt, onCredentialNameSubmit: fe, onCredentialDelete: (q, B) => $e(void 0, void 0, void 0, function* () {
  ...
  }), setError: null, checkedItemID: xe, setCheckedItemID: V }) : null] })] }) : null, !((L = E.payload.user.mfa_config) === null || L === void 0) && L.security_keys_enabled ? a(C.Fragment, { children: [a(he, { children: G("headlines.securityKeys") }), a(W, { children: [a(Yo, { onBack: rt, onCredentialNameSubmit: fe, onCredentialDelete: (q, B) => $e(void 0, void 0, void 0, function* () {
    return F(q, "security-key-delete", E.actions.security_key_delete({ security_key_id: B }).run);
  }), credentials: E.payload.user.security_keys, setError: null, checkedItemID: xe, setCheckedItemID: V, allowCredentialDeletion: !!(!((ge = (K = E.actions).security_key_delete) === null || ge === void 0) && ge.call(K, null)), credentialType: "security-key" }), !((We = (He = E.actions).security_key_create) === null || We === void 0) && We.call(He, null) ? a(Go, { credentialType: "security-key", onCredentialSubmit: (q) => $e(void 0, void 0, void 0, function* () {
    return F(q, "security-key-submit", E.actions.security_key_create(null).run);
  }), setError: null, checkedItemID: xe, setCheckedItemID: V }) : null] })] }) : null, !((Fe = E.payload.user.mfa_config) === null || Fe === void 0) && Fe.totp_enabled ? a(C.Fragment, { children: [a(he, { children: G("headlines.authenticatorApp") }), a(W, { children: a(Wa, { onConnect: (q) => $e(void 0, void 0, void 0, function* () {
  ...
  }), allowDeletion: !!(!((v = (g = E.actions).otp_secret_delete) === null || v === void 0) && v.call(g, null)), authAppSetUp: (b = E.payload.user.mfa_config) === null || b === void 0 ? void 0 : b.auth_app_set_up, checkedItemID: xe, setCheckedItemID: V }) })] }) : null, E.payload.sessions ? a(C.Fragment, { children: [a(he, { children: G("headlines.profileSessions") }), a(W, { children: a(Ha, { sessions: E.payload.sessions, setError: null, checkedItemID: xe, setCheckedItemID: V, onSessionDelete: (q, B) => $e(void 0, void 0, void 0, function* () {
    return F(q, "session-delete", E.actions.session_delete({ session_id: B }).run);
  }), deletableSessionIDs: (I = (U = (D = E.actions).session_delete) === null || U === void 0 ? void 0 : U.call(D, null).inputs.session_id.allowed_values) === null || I === void 0 ? void 0 : I.map((q) => q.value) }) })] }) : null, !((ee = (z = E.actions).account_delete) === null || ee === void 0) && ee.call(z, null) ? a(C.Fragment, { children: [a(On, {}), a(W, { children: a(yo, {}) }), a(W, { children: a(oe, Object.assign({ onSubmit: (q) => (q.preventDefault(), R(a(za, { onBack: rt, onAccountDelete: Vt })), Promise.resolve()) }, { children: a(ne, Object.assign({ dangerous: !0 }, { children: G("headlines.deleteAccount") })) })) })] }) : null] });
}, Fa = qi, ei = ({ state: n, error: e }) => {
  const { t } = (0, _.useContext)(Z.TranslateContext), { init: o, componentName: i } = (0, _.useContext)(pe), r = (0, _.useCallback)(() => o(i), [i, o]);
  return (0, _.useEffect)(() => (addEventListener("hankoAuthSuccess", r), () => {
    removeEventListener("hankoAuthSuccess", r);
  }), [r]), a(Oe, { children: [a(he, { children: t("headlines.error") }), a(Ee, { state: n, error: e }), a(oe, Object.assign({ onSubmit: (s) => {
    s.preventDefault(), r();
  } }, { children: a(ne, Object.assign({ uiAction: "retry" }, { children: t("labels.continue") })) }))] });
};
...
const Ka = (n) => {
  var e, t, o, i;
  const { t: r } = (0, _.useContext)(Z.TranslateContext), { hanko: s, stateHandler: c, setLoadingAction: d } = (0, _.useContext)(pe), { flowState: l } = Me(n.state), [u, h] = (0, _.useState)();
...
const Ba = (n) => {
  ...
  const { t: m } = (0, _.useContext)(Z.TranslateContext), { hanko: x, setLoadingAction: P, stateHandler: A } = (0, _.useContext)(pe), { flowState: S } = Me(n.state);
  return a(C.Fragment, { children: [a(Oe, { children: [a(he, { children: m("headlines.setupLoginMethod") }), a(Ee, { flowError: S == null ? void 0 : S.error }), a(W, { children: m("texts.selectLoginMethodForFutureLogins") }), a(oe, Object.assign({ hidden: !(!((t = (e = S.actions).continue_to_passkey_registration) === null || t === void 0) && t.call(e, null)), onSubmit: (O) => en(void 0, void 0, void 0, function* () {
    ...
    P(null), yield x.flow.run($, A);
  }) }, { children: a(ne, Object.assign({ secondary: !0, uiAction: "passkey-submit", icon: "passkey" }, { children: m("labels.passkey") })) })), a(oe, Object.assign({ hidden: !(!((i = (o = S.actions).continue_to_password_registration) === null || i === void 0) && i.call(o, null)), onSubmit: (O) => en(void 0, void 0, void 0, function* () {
    O.preventDefault(), P("password-submit");
    const $ = yield S.actions.continue_to_password_registration(null).run();
    P(null), yield x.flow.run($, A);
  }) }, { children: a(ne, Object.assign({ secondary: !0, uiAction: "password-submit", icon: "password" }, { children: m("labels.password") })) }))] }), a(Re, Object.assign({ hidden: !(!((s = (r = S.actions).back) === null || s === void 0) && s.call(r, null)) && !(!((d = (c = S.actions).skip) === null || d === void 0) && d.call(c, null)) }, { children: [a(te, Object.assign({ uiAction: "back", onClick: (O) => en(void 0, void 0, void 0, function* () {
    O.preventDefault(), P("back");
    const $ = yield S.actions.back(null).run();
    P(null), yield x.flow.run($, A);
  }), loadingSpinnerPosition: "right", hidden: !(!((u = (l = S.actions).back) === null || u === void 0) && u.call(l, null)) }, { children: m("labels.back") })), a(te, Object.assign({ uiAction: "skip", onClick: (O) => en(void 0, void 0, void 0, function* () {
...
const Za = (n) => {
  var e, t, o, i;
  const { t: r } = (0, _.useContext)(Z.TranslateContext), { flowState: s } = Me(n.state), { hanko: c, setLoadingAction: d, stateHandler: l } = (0, _.useContext)(pe), [u, h] = (0, _.useState)([]), f = (0, _.useCallback)((m) => Wn(void 0, void 0, void 0, function* () {
    d("passcode-submit");
  ...
  return (0, _.useEffect)(() => {
    ...
    d(null), yield c.flow.run(x, l);
  }), loadingSpinnerPosition: "right", hidden: !(!((i = (o = s.actions).continue_to_login_security_key) === null || i === void 0) && i.call(o, null)) }, { children: r("labels.useAnotherMethod") })) }))] });
};
...
const Ja = (n) => {
  var e, t, o, i;
  const { t: r } = (0, _.useContext)(Z.TranslateContext), { hanko: s, setLoadingAction: c, stateHandler: d } = (0, _.useContext)(pe), { flowState: l } = Me(n.state);
  return a(C.Fragment, { children: [a(Oe, { children: [a(he, { children: r("headlines.securityKeyLogin") }), a(Ee, { state: l }), a(W, { children: r("texts.securityKeyLogin") }), a(oe, Object.assign({ onSubmit: (u) => ti(void 0, void 0, void 0, function* () {
    u.preventDefault(), c("passkey-submit");
    const h = yield l.actions.webauthn_generate_request_options(null).run();
    yield s.flow.run(h, d);
  }) }, { children: a(ne, Object.assign({ uiAction: "passkey-submit", autofocus: !0, icon: "securityKey" }, { children: r("labels.securityKeyUse") })) }))] }), a(Re, Object.assign({ hidden: !(!((t = (e = l.actions).continue_to_login_otp) === null || t === void 0) && t.call(e, null)) }, { children: a(te, Object.assign({ uiAction: "skip", onClick: (u) => ti(void 0, void 0, void 0, function* () {
...
const Qa = gn.A && gn.A.locals ? gn.A.locals : void 0, Ga = ({ children: n, text: e }) => {
  const { t } = (0, _.useContext)(Z.TranslateContext), [o, i] = (0, _.useState)(!1);
  return a("section", Object.assign({ className: zt.clipboardContainer }, { children: [a("div", { children: [n, " "] }), a("div", Object.assign({ className: zt.clipboardIcon, onClick: (r) => {
    ...
    var s, c, d, l;
  } }, { children: o ? a("span", { children: ["- ", t("labels.copied")] }) : a(Ht, { name: "copy", secondary: !0, size: 13 }) }))] }));
}, Xa = ({ src: n, secret: e }) => {
  const { t } = (0, _.useContext)(Z.TranslateContext);
  return a("div", Object.assign({ className: Qa.otpCreationDetails }, { children: [a("img", { alt: "QR-Code", src: n }), a(On, {}), a(Ga, Object.assign({ text: e }, { children: t("texts.otpSecretKey") })), a("div", { children: e })] }));
};
...
const es = (n) => {
  const { t: e } = (0, _.useContext)(Z.TranslateContext), { flowState: t } = Me(n.state), { hanko: o, uiState: i, setLoadingAction: r, stateHandler: s } = (0, _.useContext)(pe), [c, d] = (0, _.useState)([]), l = (0, _.useCallback)((u) => Fn(void 0, void 0, void 0, function* () {
    r("passcode-submit");
    const h = yield t.actions.otp_code_verify({ otp_code: u }).run();
    r(null), yield o.flow.run(h, s);
  }), [t, r, s]);
  return (0, _.useEffect)(() => {
    var u;
    ((u = t.error) === null || u === void 0 ? void 0 : u.code) === "passcode_invalid" && d([]);
  }, [t]), a(C.Fragment, { children: [a(Oe, { children: [a(he, { children: e("headlines.otpSetUp") }), a(Ee, { state: t }), a(W, { children: e("texts.otpScanQRCode") }), a(Xa, { src: t.payload.otp_image_source, secret: t.payload.otp_secret }), a(W, { children: e("texts.otpEnterVerificationCode") }), a(oe, Object.assign({ onSubmit: (u) => Fn(void 0, void 0, void 0, function* () {
    return u.preventDefault(), l(c.join(""));
  }) }, { children: [a(ko, { onInput: (u) => {
    if (d(u), u.filter((h) => h !== "").length === 6) return l(u.join(""));
  }, passcodeDigits: c, numberOfInputs: 6 }), a(ne, Object.assign({ uiAction: "passcode-submit" }, { children: e("labels.continue") }))] }))] }), a(Re, { children: a(te, Object.assign({ onClick: (u) => Fn(void 0, void 0, void 0, function* () {
...
const ts = (n) => {
  var e, t, o, i;
  const { t: r } = (0, _.useContext)(Z.TranslateContext), { hanko: s, setLoadingAction: c, stateHandler: d } = (0, _.useContext)(pe), { flowState: l } = Me(n.state);
  return a(C.Fragment, { children: [a(Oe, { children: [a(he, { children: r("headlines.securityKeySetUp") }), a(Ee, { state: l }), a(W, { children: r("texts.securityKeySetUp") }), a(oe, Object.assign({ onSubmit: (u) => ni(void 0, void 0, void 0, function* () {
    u.preventDefault(), c("passkey-submit");
    const h = yield l.actions.webauthn_generate_creation_options(null).run();
    yield s.flow.run(h, d);
  }) }, { children: a(ne, Object.assign({ uiAction: "passkey-submit", autofocus: !0, icon: "securityKey" }, { children: r("labels.createSecurityKey") })) }))] }), a(Re, Object.assign({ hidden: !(!((t = (e = l.actions).back) === null || t === void 0) && t.call(e, null)) }, { children: a(te, Object.assign({ uiAction: "back", onClick: (u) => ni(void 0, void 0, void 0, function* () {
...
const ns = (n) => {
  var e, t, o, i;
  const { t: r } = (0, _.useContext)(Z.TranslateContext), { hanko: s, setLoadingAction: c, stateHandler: d } = (0, _.useContext)(pe), { flowState: l } = Me(n.state);
  return a(C.Fragment, { children: [a(Oe, { children: [a(he, { children: r("headlines.trustDevice") }), a(Ee, { flowError: l == null ? void 0 : l.error }), a(W, { children: r("texts.trustDevice") }), a(oe, Object.assign({ onSubmit: (u) => Kn(void 0, void 0, void 0, function* () {
    u.preventDefault(), c("trust-device-submit");
    const h = yield l.actions.trust_device(null).run();
    c(null), yield s.flow.run(h, d);
  }) }, { children: a(ne, Object.assign({ uiAction: "trust-device-submit" }, { children: r("labels.trustDevice") })) }))] }), a(Re, { children: [a(te, Object.assign({ uiAction: "back", onClick: (u) => Kn(void 0, void 0, void 0, function* () {
    u.preventDefault(), c("back");
    const h = yield l.actions.back(null).run();
    c(null), yield s.flow.run(h, d);
  }), loadingSpinnerPosition: "right", hidden: !(!((t = (e = l.actions).back) === null || t === void 0) && t.call(e, null)) }, { children: r("labels.back") })), a(te, Object.assign({ uiAction: "skip", onClick: (u) => Kn(void 0, void 0, void 0, function* () {
    u.preventDefault(), c("skip");
...
const nn = "flow-state", pe = (0, C.createContext)(null), os = (n) => {
  var { lang: e, experimental: t = "", prefilledEmail: o, prefilledUsername: i, globalOptions: r, createWebauthnAbortSignal: s } = n, c = function(p, y) {
    var L = {};
  ...
  const x = (0, _.useRef)(null), P = (0, _.useMemo)(() => `${r.storageKey}_last_login`, [r.storageKey]), [A, S] = (0, _.useState)(c.componentName), O = (0, _.useMemo)(() => t.split(" ").filter((p) => p.length).map((p) => p), [t]), $ = (0, _.useMemo)(() => a(Ca, {}), []), [T, N] = (0, _.useState)($), [, ae] = (0, _.useState)(d), [ke, se] = (0, _.useState)(), [Se, M] = (0, _.useState)({ email: o, username: i }), H = (0, _.useCallback)((p) => {
    ...
    H(null), N(a(ei, { error: p instanceof Ce ? p : new je(p) }));
    ...
    var y;
    !((y = p.payload) === null || y === void 0) && y.last_login && localStorage.setItem(P, JSON.stringify(p.payload.last_login));
    const { claims: L } = p.payload, K = Date.parse(L.expiration) - Date.now();
    d.relay.dispatchSessionCreatedEvent({ claims: L, expirationSeconds: K }), Te();
  }, profile_init(p) {
    N(a(Fa, { state: p, enablePasskeys: r.enablePasskeys }));
  }, thirdparty(p) {
    return Ke(this, void 0, void 0, function* () {
    ...
    N(a(ns, { state: p }));
  } }), [r.enablePasskeys, d, Te, H]), me = (0, _.useCallback)((p) => Ke(void 0, void 0, void 0, function* () {
    H("switch-flow");
    const y = localStorage.getItem(P);
    y && se(JSON.parse(y));
  ...
  return a(pe.Provider, Object.assign({ value: { init: De, initialComponentName: c.componentName, isDisabled: Ie, setUIState: M, setLoadingAction: H, setSucceededAction: _e, uiState: Se, hanko: d, setHanko: ae, lang: (e == null ? void 0 : e.toString()) || m, prefilledEmail: o, prefilledUsername: i, componentName: A, setComponentName: S, experimentalFeatures: O, hidePasskeyButtonOnLogin: u, page: T, setPage: N, stateHandler: ce, lastLogin: ke } }, { children: a(Z.TranslateProvider, Object.assign({ translations: h, fallbackLang: m, root: f }, { children: a(sa, Object.assign({ ref: x }, { children: A !== "events" ? a(C.Fragment, { children: [l ? a("style", { dangerouslySetInnerHTML: { __html: window._hankoStyle.innerHTML } }) : null, T] }) : null })) })) }));
}, is = { en: X(6).en };
...
const Ge = {}, Kt = (n, e) => a(os, Object.assign({ componentName: n, globalOptions: Ge, createWebauthnAbortSignal: ds }, e)), rs = (n) => Kt("auth", n), as = (n) => Kt("login", n), ss = (n) => Kt("registration", n), ls = (n) => Kt("profile", n), cs = (n) => Kt("events", n);
...
const ds = () => (on && on.abort(), on = new AbortController(), on.signal), jt = ({ tagName: n, entryComponent: e, shadow: t = !0, observedAttributes: o }) => zi(void 0, void 0, void 0, function* () {
  customElements.get(n) || function(i, r, s, c) {
    function d() {
...
let ie = class extends Mt {
  ...
  constructor() {
    ...
    try {
      ...
      if (n) {
        ...
        this.user = e, this.loading = !1, e.avatarUrl && (this.profilePictureUrl = e.avatarUrl);
      }
    } catch {
    }
  }
  ...
  async init() {
    ...
    try {
      ...
      const { Hanko: n } = await Promise.resolve().then(() => ps), e = window.location.hostname, t = e === "localhost" || e === "127.0.0.1", o = e.split("."), i = o.length >= 2 ? `.${o.slice(-2).join(".")}` : e, r = t ? {} : {
        cookieDomain: i,
        cookieName: "hanko",
        cookieSameSite: "lax"
      };
  ...
  async fetchProfileDisplayName() {
    try {
      ...
      if (e.ok) {
        ...
        const o = t.osm_avatar_url || t.picture_url;
        this.profilePictureUrl = o || "", this.log("Profile picture set to:", this.profilePictureUrl), t.language && (this.userProfileLanguage = t.language, this.log("Language set from profile:", this.userProfileLanguage));
      }
    } catch (n) {
...
ie.styles = ms;
de([
  Ue({ type: String, attribute: "hanko-url" })
], ie.prototype, "hankoUrlAttr", 2);
de([
  Ue({ type: String, attribute: "base-path" })
], ie.prototype, "basePath", 2);
de([
  Ue({ type: String, attribute: "auth-path" })
], ie.prototype, "authPath", 2);
de([
  Ue({ type: Boolean, attribute: "osm-required" })
], ie.prototype, "osmRequired", 2);
de([
  Ue({ type: String, attribute: "osm-scopes" })
], ie.prototype, "osmScopes", 2);
de([
  Ue({ type: Boolean, attribute: "show-profile" })
], ie.prototype, "showProfile", 2);
de([
  Ue({ type: String, attribute: "redirect-after-login" })
], ie.prototype, "redirectAfterLogin", 2);
de([
  Ue({ type: Boolean, attribute: "auto-connect" })
], ie.prototype, "autoConnect", 2);
de([
  Ue({ type: Boolean, attribute: "verify-session" })
], ie.prototype, "verifySession", 2);
de([
  Ue({ type: String, attribute: "redirect-after-logout" })
], ie.prototype, "redirectAfterLogout", 2);
de([
  Ue({ type: String, attribute: "display-name" })
], ie.prototype, "displayNameAttr", 2);
de([
  Ue({ type: String, attribute: "mapping-check-url" })
], ie.prototype, "mappingCheckUrl", 2);
de([
  Ue({ type: String, attribute: "app-id" })
], ie.prototype, "appId", 2);
de([
  Ue({ type: String, attribute: "login-url" })
], ie.prototype, "loginUrl", 2);
de([
  Ue({ type: String, reflect: !0 })
], ie.prototype, "lang", 2);
de([
  Ue({ type: String, attribute: "button-variant" })
], ie.prototype, "buttonVariant", 2);
de([
  Ue({ type: String, attribute: "button-color" })
