...
export type FlowPath = "/login" | "/registration" | "/profile" | "/token_exchange";
export type FetchNextState = (href: string, body?: any) => Promise<State<any>>;
export type HandlerFunction<TStateName extends StateName> = (state: State<TStateName>) => any;
