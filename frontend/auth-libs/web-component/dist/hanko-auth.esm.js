...
\f\r"'\`<>=]|("|')|))|$)`, "g"), Eo = /'/g, Po = /"/g, si = /^(?:script|style|textarea|title)$/i, Gi = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), Me = Gi(1), ft = Symbol.for("lit-noChange"), De = Symbol.for("lit-nothing"), Io = /* @__PURE__ */ new WeakMap(), lt = dt.createTreeWalker(dt, 129);
function ri(n, e) {
...
let Xi = class {
  ...
  _$AI(e, t = this) {
    e = mt(this, e, t), Mt(e) ? e === De || e == null || e === "" ? (this._$AH !== De && this._$AR(), this._$AH = De) : e !== this._$AH && e !== ft && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Qi(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _$AI(e, t = this, o, i) {
    ...
    if (r === void 0) e = mt(this, e, t, 0), a = !Mt(e) || e !== this._$AH && e !== ft, a && (this._$AH = e);
      ...
      const c = e;
      let d, l;
      for (e = r[0], d = 0; d < r.length - 1; d++) l = mt(this, c[o + d], t, d), l === ft && (l = this._$AH[d]), a || (a = !Mt(l) || l !== this._$AH[d]), l === De ? e = De : e !== De && (e += (l ?? "") + r[d + 1]), this._$AH[d] = l;
    }
    a && !i && this.j(e);
  }
  j(e) {
...
var ls = { 7: function(n, e, t) {
  (function(o, i, r) {
    ...
    o.TranslateContext = f, o.TranslateProvider = function(S) {
      var O = function(N, U) {
        ...
        var ie = c(r.useState(N.lang), 2), ge = ie[0], se = ie[1], ye = c(r.useState(h), 2), M = ye[0], q = ye[1], me = c(r.useState(!1), 2), je = me[0], Ae = me[1], $e = function(re) {
  ...
  function M(m, g, b, j, T, I, W, X, G, ve) {
    var w, _e, J, H, P, be, K, z = j && j.__k || f, Ue = z.length;
    for (b.__k = [], w = 0; w < g.length; w++) if ((H = b.__k[w] = (H = g[w]) == null || typeof H == "boolean" || typeof H == "function" ? null : typeof H == "string" || typeof H == "number" || typeof H == "bigint" ? E(null, H, null, null, H) : Array.isArray(H) ? E(N, { children: H }, null, null, null) : H.__b > 0 ? E(H.type, H.props, H.key, H.ref ? H.ref : null, H.__v) : H) != null) {
      ...
      Oe(m, H, J = J || v, T, I, W, X, G, ve), P = H.__e, (_e = H.ref) && J.ref != _e && (K || (K = []), J.ref && K.push(J.ref, null, H), K.push(_e, H.__c || P, H)), P != null ? (be == null && (be = P), typeof H.type == "function" && H.__k === J.__k ? H.__d = G = q(H, G, m) : G = je(m, H, J, z, P, G), typeof b.type == "function" && (b.__d = G)) : G && J.__e == G && G.parentNode != m && (G = ie(J));
    }
    for (b.__e = be, w = Ue; w--; ) z[w] != null && (typeof b.type == "function" && z[w].__e != null && z[w].__e == b.__d && (b.__d = Ae(j).nextSibling), L(z[w], z[w]));
  ...
  function Oe(m, g, b, j, T, I, W, X, G) {
    ...
    try {
      e: if (typeof V == "function") {
        ...
        if (w.context = Ue, w.props = K, w.__P = m, pe = i.__r, zt = 0, "prototype" in V && V.prototype.render) {
      ...
      g.__v = null, (G || I != null) && (g.__e = X, g.__h = !!G, I[I.indexOf(X)] = null), i.__e(Je, g, b);
    }
  }
  function k(m, g) {
  ...
  function p(m, g, b, j, T, I, W, X) {
    ...
    if (H === null) _e === J || X && m.data === J || (m.data = J);
      ...
      if (function(be, K, z, Ue, nt) {
        var pe;
        for (pe in z) pe === "children" || pe === "key" || pe in K || re(be, pe, null, z[pe], Ue);
        for (pe in K) nt && typeof K[pe] != "function" || pe === "children" || pe === "key" || pe === "value" || pe === "checked" || z[pe] === K[pe] || re(be, pe, K[pe], z[pe], Ue);
      }(m, J, _e, T, X), w) g.__k = [];
  ...
  c.options.__b = function(k) {
    ...
    f && f(k);
    var p = k.__c;
    p && p.__H && (p.__H.__h.length && (l.push(p) !== 1 && a === c.options.requestAnimationFrame || ((a = c.options.requestAnimationFrame) || $e)(je)), p.__H.__.forEach(function(y) {
...
var oe = {};
Y.d(oe, { fK: () => kn, tJ: () => ki, Z7: () => Cn, Q9: () => Ci, Lv: () => xi, qQ: () => xn, I4: () => Pi, O8: () => we, ku: () => oo, ls: () => no, bO: () => io, yv: () => Sn, AT: () => ro, m_: () => Wt, KG: () => so, DH: () => wn, kf: () => fo, oY: () => Pe, xg: () => Ai, Wg: () => Ze, J: () => Oi, AC: () => ao, D_: () => Ge, jx: () => Si, nX: () => lo, Nx: () => to, Sd: () => pt, kz: () => ea, fX: () => co, qA: () => uo, tz: () => po, gN: () => ho });
var Kn = {};
...
const xe = an.A && an.A.locals ? an.A.locals : void 0, vr = () => {
  ...
  return s("span", Object.assign({ className: Q()(xe.lastUsed) }, { children: n("labels.lastUsed") }));
}, te = (n) => {
...
const yn = dn.A && dn.A.locals ? dn.A.locals : void 0, ce = ({ children: n }) => s("h1", Object.assign({ part: "headline1", className: Q()(yn.headline, yn.grade1) }, { children: n }));
var un = Y(995), At = {};
...
const Vt = un.A && un.A.locals ? un.A.locals : void 0, Zn = (n) => {
  ...
  }, [o]), x = (0, _.useCallback)(() => s(A.Fragment, { children: [l ? s(A.Fragment, { children: [s(Zn, Object.assign({ onClick: C }, { children: a("labels.yes") })), " / ", s(Zn, Object.assign({ onClick: f }, { children: a("labels.no") })), " "] }) : null, s("button", Object.assign({}, r, { onClick: t ? v : o, disabled: l || r.disabled || d, part: "link", className: Q()(Vt.link, t ? Vt.danger : null) }, { children: r.children }))] }), [l, t, o, C, r, a, d]);
  return s(A.Fragment, { children: s("span", Object.assign({ className: Q()(Vt.linkWrapper, e === "right" ? Vt.reverse : null), hidden: r.hidden, onMouseEnter: () => {
...
const br = (n) => {
  var e, t;
  const { t: o } = (0, _.useContext)(Z.TranslateContext), { flowState: i } = Le(n.state), { hanko: r, uiState: a, setUIState: c, setLoadingAction: d, setSucceededAction: l, stateHandler: u } = (0, _.useContext)(de), [h, v] = (0, _.useState)(), [f, S] = (0, _.useState)(i.payload.resend_after), [O, C] = (0, _.useState)([]), x = (0, _.useMemo)(() => {
    var $;
...
const wr = (n) => {
  var e, t, o, i;
  const { t: r } = (0, _.useContext)(Z.TranslateContext), { hanko: a, stateHandler: c, setLoadingAction: d } = (0, _.useContext)(de), { flowState: l } = Le(n.state), [u, h] = (0, _.useState)(), [v, f] = (0, _.useState)(), S = (E) => Pt(void 0, void 0, void 0, function* () {
...
const xr = (n) => {
  const { t: e } = (0, _.useContext)(Z.TranslateContext), { hanko: t, stateHandler: o, setLoadingAction: i } = (0, _.useContext)(de), { flowState: r } = Le(n.state), [a, c] = (0, _.useState)();
...
const Sr = (n) => {
  var e, t, o, i, r, a;
  const { t: c } = (0, _.useContext)(Z.TranslateContext), { hanko: d, setLoadingAction: l, stateHandler: u, lastLogin: h } = (0, _.useContext)(de), { flowState: v } = Le(n.state);
  return s(A.Fragment, { children: [s(Se, { children: [s(ce, { children: c("headlines.selectLoginMethod") }), s(Ce, { flowError: v == null ? void 0 : v.error }), s(F, { children: c("texts.howDoYouWantToLogin") }), s(ne, Object.assign({ hidden: !(!((t = (e = v.actions).continue_to_passcode_confirmation) === null || t === void 0) && t.call(e, null)), onSubmit: (f) => Jt(void 0, void 0, void 0, function* () {
    ...
    l(null), yield d.flow.run(S, u);
  }) }, { children: s(te, Object.assign({ secondary: !0, uiAction: "passkey-submit", icon: "passkey" }, { children: c("labels.passkey") })) }))] }), s(Te, { children: s(ee, Object.assign({ uiAction: "back", onClick: (f) => Jt(void 0, void 0, void 0, function* () {
...
const Cr = (n) => {
  ...
  }, []), s(A.Fragment, { children: [s(Se, { children: [s(ce, { children: d("headlines.signUp") }), s(Ce, { state: C, error: $ }), x ? s(A.Fragment, { children: [s(ne, Object.assign({ onSubmit: (M) => Qt(void 0, void 0, void 0, function* () {
  ...
  }))(q, M.value) }, { children: s(te, Object.assign({ isLoading: M.value == U, secondary: !0, icon: M.value.startsWith("custom_") ? "customProvider" : M.value }, { children: d("labels.signInWith", { provider: M.name }) })) }), M.value)) : null, ((c = (a = C.actions).remember_me) === null || c === void 0 ? void 0 : c.call(a, null)) && s(A.Fragment, { children: [s(On, {}), s(_o, { required: !1, type: "checkbox", label: d("labels.staySignedIn"), checked: ge, onChange: (M) => Qt(void 0, void 0, void 0, function* () {
    const q = yield C.actions.remember_me({ remember_me: !ge }).run();
    se((me) => !me), yield u.flow.run(q, f);
  }) })] })] }), s(Te, Object.assign({ hidden: O !== "auth" }, { children: [s("span", { hidden: !0 }), s(ee, Object.assign({ uiAction: "switch-flow", onClick: (M) => Qt(void 0, void 0, void 0, function* () {
...
const Ar = (n) => {
  ...
  return s(A.Fragment, { children: [s(Se, { children: [s(ce, { children: l("headlines.registerPassword") }), s(Ce, { state: f }), s(F, { children: l("texts.passwordFormatHint", { minLength: f.actions.register_password(null).inputs.new_password.min_length, maxLength: 72 }) }), s(ne, Object.assign({ onSubmit: (C) => Gt(void 0, void 0, void 0, function* () {
  ...
  }) }, { children: [s(ze, { type: "password", autocomplete: "new-password", flowInput: f.actions.register_password(null).inputs.new_password, placeholder: l("labels.newPassword"), onInput: (C) => Gt(void 0, void 0, void 0, function* () {
    C.target instanceof HTMLInputElement && O(C.target.value);
  }), autofocus: !0 }), s(te, Object.assign({ uiAction: "password-submit" }, { children: l("labels.continue") }))] }))] }), s(Te, Object.assign({ hidden: !(!((t = (e = f.actions).back) === null || t === void 0) && t.call(e, null)) && !(!((i = (o = f.actions).skip) === null || i === void 0) && i.call(o, null)) }, { children: [s(ee, Object.assign({ uiAction: "back", onClick: (C) => Gt(void 0, void 0, void 0, function* () {
    C.preventDefault(), v("back");
    const x = yield f.actions.back(null).run();
    v(null), yield u.flow.run(x, h);
  }), loadingSpinnerPosition: "right", hidden: !(!((a = (r = f.actions).back) === null || a === void 0) && a.call(r, null)) }, { children: l("labels.back") })), s(ee, Object.assign({ uiAction: "skip", onClick: (C) => Gt(void 0, void 0, void 0, function* () {
...
const Ve = pn.A && pn.A.locals ? pn.A.locals : void 0, En = function({ name: n, columnSelector: e, contentSelector: t, data: o, checkedItemID: i, setCheckedItemID: r, dropdown: a = !1 }) {
  ...
  return s("div", Object.assign({ className: Ve.accordion }, { children: o.map((u, h) => s("div", Object.assign({ className: Ve.accordionItem }, { children: [s("input", { type: "radio", className: Ve.accordionInput, id: `${n}-${h}`, name: n, onClick: l, value: h, checked: d(h) }), s("label", Object.assign({ className: Q()(Ve.label, a && Ve.dropdown), for: `${n}-${h}` }, { children: s("span", Object.assign({ className: Ve.labelText }, { children: e(u, h) })) })), s("div", Object.assign({ className: Q()(Ve.accordionContent, a && Ve.dropdownContent) }, { children: t(u, h) }))] }), h)) }));
}, He = ({ children: n }) => s("h2", Object.assign({ part: "headline2", className: Q()(yn.headline, yn.grade2) }, { children: n })), Or = ({ onEmailDelete: n, onEmailSetPrimary: e, onEmailVerify: t, checkedItemID: o, setCheckedItemID: i, emails: r = [], deletableEmailIDs: a = [] }) => {
  const { t: c } = (0, _.useContext)(Z.TranslateContext), d = (0, _.useMemo)(() => !1, []);
  return s(En, { name: "email-edit-dropdown", columnSelector: (l) => {
    const u = s("span", Object.assign({ className: Ve.description }, { children: l.is_verified ? l.is_primary ? s(A.Fragment, { children: [" -", " ", c("labels.primaryEmail")] }) : null : s(A.Fragment, { children: [" -", " ", c("labels.unverifiedEmail")] }) }));
    ...
    var u;
    return s(A.Fragment, { children: [l.is_primary ? s(A.Fragment, { children: s(F, { children: [s(He, { children: c("headlines.isPrimaryEmail") }), c("texts.isPrimaryEmail")] }) }) : s(A.Fragment, { children: s(F, { children: [s(He, { children: c("headlines.setPrimaryEmail") }), c("texts.setPrimaryEmail"), s("br", {}), s(ee, Object.assign({ uiAction: "email-set-primary", onClick: (h) => e(h, l.id), loadingSpinnerPosition: "right" }, { children: c("labels.setAsPrimaryEmail") }))] }) }), l.is_verified ? s(A.Fragment, { children: s(F, { children: [s(He, { children: c("headlines.emailVerified") }), c("texts.emailVerified")] }) }) : s(A.Fragment, { children: s(F, { children: [s(He, { children: c("headlines.emailUnverified") }), c("texts.emailUnverified"), s("br", {}), s(ee, Object.assign({ uiAction: "email-verify", onClick: (h) => t(h, l.id), loadingSpinnerPosition: "right" }, { children: c("labels.verify") }))] }) }), a.includes(l.id) ? s(A.Fragment, { children: s(F, { children: [s(He, { children: c("headlines.emailDelete") }), c("texts.emailDelete"), s("br", {}), s(ee, Object.assign({ uiAction: "email-delete", dangerous: !0, onClick: (h) => n(h, l.id), disabled: d, loadingSpinnerPosition: "right" }, { children: c("labels.delete") }))] }) }) : null, ((u = l.identities) === null || u === void 0 ? void 0 : u.length) > 0 ? s(A.Fragment, { children: s(F, { children: [s(He, { children: c("headlines.connectedAccounts") }), l.identities.map((h) => h.provider).join(", ")] }) }) : null] });
  ...
  return s(En, { name: "session-edit-dropdown", columnSelector: (c) => {
    const d = s("b", { children: c.user_agent ? c.user_agent : c.id }), l = c.current ? s("span", Object.assign({ className: Ve.description }, { children: s(A.Fragment, { children: [" -", " ", r("labels.currentSession")] }) })) : null;
    return s(A.Fragment, { children: [d, l] });
  }, data: n, contentSelector: (c) => s(A.Fragment, { children: [s(F, Object.assign({ hidden: !c.ip_address }, { children: [s(He, { children: r("headlines.ipAddress") }), c.ip_address] })), s(F, { children: [s(He, { children: r("headlines.lastUsed") }), a(c.last_used)] }), s(F, { children: [s(He, { children: r("headlines.createdAt") }), a(c.created_at)] }), i != null && i.includes(c.id) ? s(F, { children: [s(He, { children: r("headlines.revokeSession") }), s(ee, Object.assign({ uiAction: "session-delete", dangerous: !0, onClick: (d) => o(d, c.id), loadingSpinnerPosition: "right" }, { children: r("labels.revoke") }))] }) : null] }), checkedItemID: e, setCheckedItemID: t });
}, $r = ({ checkedItemID: n, setCheckedItemID: e, onDelete: t, onConnect: o, authAppSetUp: i, allowDeletion: r }) => {
  const { t: a } = (0, _.useContext)(Z.TranslateContext), c = s("span", Object.assign({ className: Ve.description }, { children: i ? s(A.Fragment, { children: [" -", " ", a("labels.configured")] }) : null })), d = s(A.Fragment, { children: [a("labels.authenticatorAppManage"), " ", c] });
  return s(qt, Object.assign({ name: "authenticator-app-manage-dropdown", title: d, checkedItemID: n, setCheckedItemID: e }, { children: [s(He, { children: a(i ? "headlines.authenticatorAppAlreadySetUp" : "headlines.authenticatorAppNotSetUp") }), s(F, { children: [a(i ? "texts.authenticatorAppAlreadySetUp" : "texts.authenticatorAppNotSetUp"), s("br", {}), s(ee, i ? Object.assign({ hidden: !r, uiAction: "auth-app-remove", onClick: (l) => t(l), loadingSpinnerPosition: "right", dangerous: !0 }, { children: a("labels.delete") }) : Object.assign({ uiAction: "auth-app-add", onClick: (l) => o(l), loadingSpinnerPosition: "right" }, { children: a("labels.authenticatorAppAdd") }))] })] }));
};
...
const ji = (n) => {
  var e, t, o, i, r, a, c, d, l, u, h, v, f, S, O, C, x, E, $, N, U, ie, ge, se, ye, M, q, me, je, Ae, $e, re, ae, ue, Oe, k, p, y, L, B, he, Re, We, qe, m, g, b, j, T, I, W, X;
  const { t: G } = (0, _.useContext)(Z.TranslateContext), { hanko: ve, setLoadingAction: w, stateHandler: _e, setUIState: J, setPage: H } = (0, _.useContext)(de), { flowState: P } = Le(n.state), [be, K] = (0, _.useState)(""), z = (R, V, Je) => Ee(void 0, void 0, void 0, function* () {
  ...
  }), onUsernameDelete: nt, checkedItemID: be, setCheckedItemID: K }) : null] })] }) : null, !((x = (C = P.payload) === null || C === void 0 ? void 0 : C.user) === null || x === void 0) && x.emails || !(($ = (E = P.actions).email_create) === null || $ === void 0) && $.call(E, null) ? s(A.Fragment, { children: [s(ce, { children: G("headlines.profileEmails") }), s(F, { children: [s(Or, { emails: P.payload.user.emails, onEmailDelete: (R, V) => Ee(void 0, void 0, void 0, function* () {
  ...
  }), checkedItemID: be, setCheckedItemID: K }) : null] })] }) : null, !((M = (ye = P.actions).password_create) === null || M === void 0) && M.call(ye, null) ? s(A.Fragment, { children: [s(ce, { children: G("headlines.profilePassword") }), s(F, { children: s(Zo, { inputs: P.actions.password_create(null).inputs, onPasswordSubmit: (R, V) => Ee(void 0, void 0, void 0, function* () {
    return z(R, "password-submit", P.actions.password_create({ password: V }).run);
  }), onPasswordDelete: Ue, checkedItemID: be, setCheckedItemID: K }) })] }) : null, !((me = (q = P.actions).password_update) === null || me === void 0) && me.call(q, null) ? s(A.Fragment, { children: [s(ce, { children: G("headlines.profilePassword") }), s(F, { children: s(Zo, { allowPasswordDelete: !!(!((Ae = (je = P.actions).password_delete) === null || Ae === void 0) && Ae.call(je, null)), inputs: P.actions.password_update(null).inputs, onPasswordSubmit: (R, V) => Ee(void 0, void 0, void 0, function* () {
    return z(R, "password-submit", P.actions.password_update({ password: V }).run);
  }), onPasswordDelete: Ue, checkedItemID: be, setCheckedItemID: K, passwordExists: !0 }) })] }) : null, n.enablePasskeys && (!((re = ($e = P.payload) === null || $e === void 0 ? void 0 : $e.user) === null || re === void 0) && re.passkeys || !((ue = (ae = P.actions).webauthn_credential_create) === null || ue === void 0) && ue.call(ae, null)) ? s(A.Fragment, { children: [s(ce, { children: G("headlines.profilePasskeys") }), s(F, { children: [s(Vo, { onBack: ot, onCredentialNameSubmit: pe, onCredentialDelete: (R, V) => Ee(void 0, void 0, void 0, function* () {
  ...
  }), setError: null, checkedItemID: be, setCheckedItemID: K }) : null] })] }) : null, !((L = P.payload.user.mfa_config) === null || L === void 0) && L.security_keys_enabled ? s(A.Fragment, { children: [s(ce, { children: G("headlines.securityKeys") }), s(F, { children: [s(Vo, { onBack: ot, onCredentialNameSubmit: pe, onCredentialDelete: (R, V) => Ee(void 0, void 0, void 0, function* () {
  ...
  }), setError: null, checkedItemID: be, setCheckedItemID: K }) : null] })] }) : null, !((qe = P.payload.user.mfa_config) === null || qe === void 0) && qe.totp_enabled ? s(A.Fragment, { children: [s(ce, { children: G("headlines.authenticatorApp") }), s(F, { children: s($r, { onConnect: (R) => Ee(void 0, void 0, void 0, function* () {
...
const Lr = (n) => {
  var e, t, o, i;
  const { t: r } = (0, _.useContext)(Z.TranslateContext), { hanko: a, stateHandler: c, setLoadingAction: d } = (0, _.useContext)(de), { flowState: l } = Le(n.state), [u, h] = (0, _.useState)();
...
const Ur = (n) => {
  var e, t, o, i;
  const { t: r } = (0, _.useContext)(Z.TranslateContext), { flowState: a } = Le(n.state), { hanko: c, setLoadingAction: d, stateHandler: l } = (0, _.useContext)(de), [u, h] = (0, _.useState)([]), v = (0, _.useCallback)((f) => qn(void 0, void 0, void 0, function* () {
    d("passcode-submit");
...
const Mr = (n) => {
  var e, t, o, i;
  const { t: r } = (0, _.useContext)(Z.TranslateContext), { hanko: a, setLoadingAction: c, stateHandler: d } = (0, _.useContext)(de), { flowState: l } = Le(n.state);
...
const Fr = (n) => {
  const { t: e } = (0, _.useContext)(Z.TranslateContext), { flowState: t } = Le(n.state), { hanko: o, uiState: i, setLoadingAction: r, stateHandler: a } = (0, _.useContext)(de), [c, d] = (0, _.useState)([]), l = (0, _.useCallback)((u) => Fn(void 0, void 0, void 0, function* () {
    r("passcode-submit");
  ...
  }, passcodeDigits: c, numberOfInputs: 6 }), s(te, Object.assign({ uiAction: "passcode-submit" }, { children: e("labels.continue") }))] }))] }), s(Te, { children: s(ee, Object.assign({ onClick: (u) => Fn(void 0, void 0, void 0, function* () {
...
const en = "flow-state", de = (0, A.createContext)(null), Kr = (n) => {
  ...
  const S = (0, _.useRef)(null), O = (0, _.useMemo)(() => `${r.storageKey}_last_login`, [r.storageKey]), [C, x] = (0, _.useState)(c.componentName), E = (0, _.useMemo)(() => t.split(" ").filter((p) => p.length).map((p) => p), [t]), $ = (0, _.useMemo)(() => s(mr, {}), []), [N, U] = (0, _.useState)($), [, ie] = (0, _.useState)(d), [ge, se] = (0, _.useState)(), [ye, M] = (0, _.useState)({ email: o, username: i }), q = (0, _.useCallback)((p) => {
    ...
    q(null), U(s(Go, { error: p instanceof we ? p : new Pe(p) }));
    ...
    d.relay.dispatchSessionCreatedEvent({ claims: L, expirationSeconds: B }), je();
  }, profile_init(p) {
    ...
    U(s(Br, { state: p }));
  } }), [r.enablePasskeys, d, je, q]), ue = (0, _.useCallback)((p) => Fe(void 0, void 0, void 0, function* () {
    q("switch-flow");
...
const Qe = {}, Ft = (n, e) => s(Kr, Object.assign({ componentName: n, globalOptions: Qe, createWebauthnAbortSignal: Xr }, e)), Zr = (n) => Ft("auth", n), Jr = (n) => Ft("login", n), Qr = (n) => Ft("registration", n), Gr = (n) => Ft("profile", n), Yr = (n) => Ft("events", n);
...
var aa = Ui;
Ti(aa);
var la = Object.defineProperty, ca = Object.getOwnPropertyDescriptor, Ne = (n, e, t, o) => {
...
let Ie = class extends Nt {
  constructor() {
    super(...arguments), this.hankoUrlAttr = "", this.basePath = "", this.authPath = "/api/auth/osm", this.osmRequired = !1, this.osmScopes = "read_prefs", this.showProfile = !1, this.redirectAfterLogin = "", this.redirectAfterLogout = "", this.autoConnect = !1, this.loginUrl = "", this.forceLogout = !1, this.user = null, this.osmConnected = !1, this.osmData = null, this.osmLoading = !1, this.loading = !0, this.error = null, this._trailingSlashCache = {}, this._debugMode = !1, this._sessionJWT = null, this._lastSessionId = null, this._hanko = null, this._handleVisibilityChange = () => {
      !document.hidden && !this.showProfile && (this.log("👁️ Page visible, re-checking session..."), this.checkSession());
    }, this._handleWindowFocus = () => {
      this.showProfile || (this.log("🎯 Window focused, re-checking session..."), this.checkSession());
  ...
  async init() {
    try {
      ...
      if (this._hanko = new n(this.hankoUrl), this._hanko.onSessionExpired(() => {
      ...
      }), this.forceLogout && this.showProfile) {
        this.log("🔄 force-logout attribute detected, clearing existing session...");
        try {
          await this._hanko.session.isValid() ? (this.log("  Found existing session, logging out silently..."), await this._hanko.user.logout(), document.cookie = "hanko=; path=/; max-age=0", this.log("  ✅ Session cleared, user will see login form")) : this.log("  No existing session found");
        } catch (e) {
          this.log("  ⚠️ Error during force logout:", e);
        }
      }
  ...
  async checkSession() {
    ...
    try {
      ...
      try {
        ...
        if (!n.ok)
          throw new Error(`No valid session: ${n.status}`);
        const e = await n.json();
        if (this.log("✅ Valid session found"), this.log("👤 Existing user session:", e), this.user = {
          id: e.user_id,
          email: e.email,
          username: e.username,
          emailVerified: !1
          ...
          console.log("🔄 Auto-connecting to OSM (from existing session)..."), this.handleOSMConnect();
          return;
        }
        (!this.osmRequired || this.osmConnected) && this.redirectAfterLogin && this.showProfile && (console.log("✅ Existing session found, redirecting to:", this.redirectAfterLogin), window.location.href = this.redirectAfterLogin);
      } catch {
        this.log("ℹ️ No valid Hanko session found - user needs to login"), this.user && (this.log("🧹 Clearing stale user state"), this.user = null, this.osmConnected = !1, this.osmData = null);
      }
    } catch (n) {
      this.log("⚠️ Session check error:", n), this.log("ℹ️ No existing session - user needs to login"), this.user && (this.log("🧹 Clearing stale user state"), this.user = null, this.osmConnected = !1, this.osmData = null);
    }
  }
  async syncJWTToCookie() {
    try {
      const n = this._sessionJWT;
      n ? (document.cookie = `hanko=${n}; path=/; max-age=86400; SameSite=Lax`, this.log("🔐 JWT synced to cookie for SSO (no domain, browser handles it)")) : this.log("⚠️ No JWT found in session event");
    } catch (n) {
  ...
  async handleHankoSuccess(n) {
    ...
    if (this._sessionJWT = ((r = n.detail) == null ? void 0 : r.jwt) || null, !t) {
    ...
    try {
      const a = await fetch(`${this.hankoUrl}/me`, {
        method: "GET",
        credentials: "include",
      ...
      if (!a.ok)
        throw new Error(`Failed to fetch user info: ${a.status}`);
      const c = await a.json();
      this.log("👤 User data from /me endpoint:", c), this.user = {
        id: c.user_id || t,
        email: c.email,
        username: c.username,
        emailVerified: !1
        // We don't track this in our custom backend yet
      };
    } catch (a) {
  ...
  async handleLogout() {
    ...
    try {
      const n = this.getBasePath(), e = this.authPath, t = window.location.origin, o = this.addTrailingSlash(`${n}${e}/disconnect`, n), i = `${t}${o}`;
      this.log("🔌 Calling OSM disconnect:", i);
      const r = await fetch(i, {
        method: "POST",
        credentials: "include"
      });
      this.log("📡 Disconnect response status:", r.status);
      const a = await r.json();
      this.log("📡 Disconnect response data:", a), this.log("✅ OSM disconnected");
    } catch (n) {
      console.error("❌ OSM disconnect failed:", n);
    }
    if (this._hanko)
      try {
        await this._hanko.user.logout(), this.log("✅ Hanko logout successful");
      } catch (n) {
        console.error("Hanko logout failed:", n);
      }
    document.cookie = "hanko=; path=/; max-age=0", document.cookie = "osm_connection=; path=/; max-age=0", this.log("🍪 Cookies cleared"), this.user = null, this.osmConnected = !1, this.osmData = null, this.dispatchEvent(new CustomEvent("logout", {
      bubbles: !0,
      composed: !0
    })), this.redirectAfterLogout ? (this.log("🔄 Redirecting after logout to:", this.redirectAfterLogout), window.location.href = this.redirectAfterLogout) : (this.log("🔄 Reloading page to clear all session data..."), window.location.reload());
  }
  handleSessionExpired() {
    this.log("🕒 Session expired - cleaning up state"), this.log("📊 State before cleanup:", {
      user: this.user,
      osmConnected: this.osmConnected
    }), this.user = null, this.osmConnected = !1, this.osmData = null, document.cookie = "hanko=; path=/; max-age=0", document.cookie = "osm_connection=; path=/; max-age=0", this.log("🍪 Cookies cleared after session expiration"), this.dispatchEvent(new CustomEvent("logout", {
      bubbles: !0,
      composed: !0
  ...
  handleDropdownSelect(n) {
    ...
    if (this.log("🎯 Dropdown item selected:", e), e === "profile")
      window.location.href = `${this.basePath}/profile`;
    else if (e === "connect-osm") {
      const t = window.location.href;
      window.location.href = `${this.basePath}?return_to=${encodeURIComponent(t)}&osm_required=true`;
  ...
  render() {
    ...
    if (this.user) {
      ...
      if (this.showProfile)
        ...
        `;
      {
        const o = window.location.href, r = new URLSearchParams(window.location.search).get("auto_connect") === "true" ? "&auto_connect=true" : "", a = this.redirectAfterLogin || o;
        this.log("🔗 Building login URL with returnUrl:", a);
        const c = this.loginUrl ? `${this.loginUrl}?return_to=${encodeURIComponent(a)}${this.osmRequired ? "&osm_required=true" : ""}${r}` : `${this.basePath}?return_to=${encodeURIComponent(a)}${this.osmRequired ? "&osm_required=true" : ""}${r}`;
        return this.log("🔗 Final login URL:", c), Me`
          <div class="container">
            <a href="${c}" class="btn-login">Log In</a>
          </div>
        `;
      }
    }
...
Ie.styles = Ri`
  ...
  `;
Ne([
  Ke({ type: String, attribute: "hanko-url" })
], Ie.prototype, "hankoUrlAttr", 2);
Ne([
  Ke({ type: String, attribute: "base-path" })
], Ie.prototype, "basePath", 2);
Ne([
  Ke({ type: String, attribute: "auth-path" })
], Ie.prototype, "authPath", 2);
Ne([
  Ke({ type: Boolean, attribute: "osm-required" })
], Ie.prototype, "osmRequired", 2);
Ne([
  Ke({ type: String, attribute: "osm-scopes" })
], Ie.prototype, "osmScopes", 2);
Ne([
  Ke({ type: Boolean, attribute: "show-profile" })
], Ie.prototype, "showProfile", 2);
Ne([
  Ke({ type: String, attribute: "redirect-after-login" })
], Ie.prototype, "redirectAfterLogin", 2);
Ne([
  Ke({ type: String, attribute: "redirect-after-logout" })
], Ie.prototype, "redirectAfterLogout", 2);
Ne([
  Ke({ type: Boolean, attribute: "auto-connect" })
], Ie.prototype, "autoConnect", 2);
Ne([
  Ke({ type: String, attribute: "login-url" })
], Ie.prototype, "loginUrl", 2);
Ne([
  Ke({ type: Boolean, attribute: "force-logout" })
], Ie.prototype, "forceLogout", 2);
Ne([
  gt()
], Ie.prototype, "user", 2);
Ne([
