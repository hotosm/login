...
export const translations: Record<string, Translations> = {
  ...
  fr: {
    welcomeTo: "Bienvenue sure",
    needToSetup: "Nous devons configurer votre compte.",
    didYouHaveAccount: "Aviez-vous un compte existent sure",
  ...
  pt: {
    ...
    deleteConfirm:
      "Tem certeza de que deseja excluir sua conta? Esta ação não pode set desfeita.",
